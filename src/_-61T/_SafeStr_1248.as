...
package _-61T
{
    ...
    import _-Ol._SafeStr_1562;
    import com.sulake.core.communication.messages.IMessageDataWrapper;

    [SecureSWF(rename="true")]
    public class _SafeStr_1248 implements IMessageParser 
    {
        ...
        public static function convertOldPetFigure(_arg_1:String):String
        {
            ...
            _local_9 = _local_9.substr((_local_9.length - 6), 6);
            var _local_3:int = 25;
            if (_local_8 <= 1)
            {
        ...
        public function getUser(_arg_1:int):_SafeStr_1562
        {
            if (((_arg_1 < 0) || (_arg_1 >= getUserCount())))
            {
                return (null);
            };
            var _local_2:_SafeStr_1562 = (_users[_arg_1] as _SafeStr_1562);
            if (_local_2 != null)
            {
