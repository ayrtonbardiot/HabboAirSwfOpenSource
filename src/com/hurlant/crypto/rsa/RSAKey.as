...
package com.hurlant.crypto.rsa
{
    ...
    public class RSAKey 
    {
        ...
        public var _SafeStr_6322:BigInteger;
        ...
        public static function generate(_arg_1:uint, _arg_2:String):RSAKey
        {
            ...
            while (true)
            {
                while (true)
                {
                    ...
                    if (((_local_10.p.subtract(BigInteger._SafeStr_3546).gcd(_local_3).compareTo(BigInteger._SafeStr_3546) == 0) && (_local_10.p.isProbablePrime(10)))) break;
                };
                while (true)
                {
                    _local_10.q = bigRandom(_local_7, _local_9);
                    if (((_local_10.q.subtract(BigInteger._SafeStr_3546).gcd(_local_3).compareTo(BigInteger._SafeStr_3546) == 0) && (_local_10.q.isProbablePrime(10)))) break;
                };
                ...
                _local_6 = _local_10.p.subtract(BigInteger._SafeStr_3546);
                _local_4 = _local_10.q.subtract(BigInteger._SafeStr_3546);
                _local_5 = _local_6.multiply(_local_4);
                if (_local_5.gcd(_local_3).compareTo(BigInteger._SafeStr_3546) == 0)
                {
                    ...
                    _local_10._SafeStr_6322 = _local_10.q.modInverse(_local_10.p);
                    break;
                };
            };
        ...
        public function dump():String
        {
            ...
            if (canDecrypt)
            {
                ...
                if (((!(p == null)) && (!(q == null))))
                {
                    ...
                    _local_1 = (_local_1 + (("IQMP=" + _SafeStr_6322.toString(16)) + "\n"));
                };
            };
            return (_local_1);
        }
        ...
        protected function doPrivate2(_arg_1:BigInteger):BigInteger
        {
            ...
            return (_local_3.subtract(_local_4).multiply(_SafeStr_6322).mod(p).multiply(q).add(_local_4));
        }
        ...
        protected function doPrivate(_arg_1:BigInteger):BigInteger
        {
            ...
            return (_local_2.subtract(_local_3).multiply(_SafeStr_6322).mod(p).multiply(q).add(_local_3));
        }
...
// _SafeStr_3546 = "_-Q10" (String#11220, DoABC#4)
// _SafeStr_6322 = "_-73" (String#12832, DoABC#4)
