...
package com.hurlant.math
{
    ...
    internal class BarrettReduction implements IReduction 
    {
        ...
        private var _SafeStr_7987:BigInteger;

        public function BarrettReduction(_arg_1:BigInteger)
        {
            r2 = new BigInteger();
            q3 = new BigInteger();
            BigInteger._SafeStr_3546.dlShiftTo((2 * _arg_1.t), r2);
            _SafeStr_7987 = r2.divide(_arg_1);
            this.m = _arg_1;
        }
        ...
        public function reduce(_arg_1:BigInteger):void
        {
            ...
            _SafeStr_7987.multiplyUpperTo(r2, (m.t + 1), q3);
...
// _SafeStr_7987 = "_-Mh" (String#8036, DoABC#3)
