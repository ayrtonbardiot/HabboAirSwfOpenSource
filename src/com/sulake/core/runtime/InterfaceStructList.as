...
package com.sulake.core.runtime
{
    ...
    internal final class InterfaceStructList implements _SafeStr_13 
    {
        ...
        {
            return (_SafeStr_4162.length);
        }

        public function get disposed():Boolean
        {
            return (_SafeStr_4162 == null);
        }
        ...
        public function dispose():void
        {
            var _local_1:* = null;
            var _local_3:uint;
            var _local_2:uint = _SafeStr_4162.length;
            _local_3 = 0;
            while (_local_3 < _local_2)
            {
                _local_1 = _SafeStr_4162.pop();
                _local_1.dispose();
                _local_3++;
            };
            _SafeStr_4162 = null;
        ...
        public function remove(_arg_1:uint):InterfaceStruct
        {
            ...
            if (_arg_1 < _SafeStr_4162.length)
            {
                _local_2 = _SafeStr_4162[_arg_1];
                _SafeStr_4162.splice(_arg_1, 1);
                return (_local_2);
            };
        ...
        public function find(_arg_1:IID):IUnknown
        {
            ...
            var _local_4:uint = _SafeStr_4162.length;
            _local_5 = 0;
            while (_local_5 < _local_4)
            {
                _local_2 = (_SafeStr_4162[_local_5] as InterfaceStruct);
        ...
        public function mapStructsByInterface(_arg_1:IID, _arg_2:Array):uint
        {
            ...
            var _local_5:uint;
            var _local_6:uint = _SafeStr_4162.length;
            _local_7 = 0;
            while (_local_7 < _local_6)
            {
                _local_3 = (_SafeStr_4162[_local_7] as InterfaceStruct);
        ...
        public function getStructByImplementor(_arg_1:IUnknown):InterfaceStruct
        {
            var _local_2:* = null;
            var _local_4:uint;
            var _local_3:uint = _SafeStr_4162.length;
            _local_4 = 0;
            while (_local_4 < _local_3)
            {
                _local_2 = (_SafeStr_4162[_local_4] as InterfaceStruct);
        ...
        public function mapStructsByImplementor(_arg_1:IUnknown, _arg_2:Array):uint
        {
            ...
            {
                _local_3 = (_SafeStr_4162[_local_6] as InterfaceStruct);
        ...
        {
            return ((_arg_1 < _SafeStr_4162.length) ? _SafeStr_4162[_arg_1] : null);
        }
        ...
        public function getTotalReferenceCount():uint
        {
            ...
            {
                _local_1 = (_SafeStr_4162[_local_4] as InterfaceStruct);
...
// _SafeStr_4162 = "_-CL" (String#7389, DoABC#3)
