...
//com.sulake.core.window.components.DropMenuController
...
package com.sulake.core.window.components
{
    ...
    public class DropMenuController extends DropBaseController implements _SafeStr_3269 
    {
        ...
        public function DropMenuController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:_SafeStr_3109, _arg_8:Function, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0)
        {
        ...
        override protected function populateExpandedMenu(_arg_1:Vector.<_SafeStr_3109>, _arg_2:DropBaseController, _arg_3:Function):void
        {
            var _local_5:* = null;
            var _local_12:* = null;
            if (!_arg_2)
        ...
        override protected function closeExpandedMenuView():void
        {
            ...
            if (close())
            {
                ...
                if (!disposed)
                {
                    ...
                    if (_local_1)
                    {
                        _local_1.text = (((_SafeStr_5840 < _stringArray.length) && (_SafeStr_5840 > -1)) ? _stringArray[_SafeStr_5840] : caption);
                    };
                };
            };
        }
