...
//com.sulake.core.window.components.TextFieldController
...
package com.sulake.core.window.components
{
    ...
    public class TextFieldController extends TextController implements ITextFieldWindow 
    {
        ...
        private var _SafeStr_4457:DropShadowFilter = new DropShadowFilter(1, 90, 0xFFFFFF, 1, 0, 0);
        protected var _SafeStr_4455:uint = 500;
        protected var _toolTipCaption:String = "";
        protected var _SafeStr_4459:Boolean = false;
        protected var _SafeStr_4458:Boolean = false;
        protected var _SafeStr_3853:Boolean = false;
        protected var _filters:Array = [];
        protected var _SafeStr_4456:Boolean;

        public function TextFieldController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:_SafeStr_3109, _arg_8:Function, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0)
        {
            _arg_4 = (_arg_4 & (~(0x10)));
            _arg_4 = (_arg_4 | 0x01);
            _SafeStr_4050 = _arg_6.x;
            _SafeStr_4051 = _arg_6.y;
            _SafeStr_4422 = _arg_6.width;
            _SafeStr_4423 = _arg_6.height;
        ...
        override public function getGraphicContext(_arg_1:Boolean):IGraphicContext
        {
            ...
            {
                _SafeStr_4436 = new GraphicContext((("GC {" + _name) + "}"), 2, rectangle);
            };
        ...
        protected function refreshAutoSize():void
        {
            var _local_2:* = null;
            var _local_1:* = null;
            if (((_SafeStr_3853) && (!(autoSize == "none"))))
            {
                if (((!(_SafeStr_4422 == _field.width)) || (!(_SafeStr_4423 == _field.height))))
                {
                    ...
                    setRectangle((_SafeStr_4050 + _local_1.x), (_SafeStr_4051 + _local_1.y), _field.width, _field.height);
                };
            };
        }
        ...
        private function updateFilters():void
        {
            ...
            {
                _SafeStr_4457.color = (_etchingColor & 0xFFFFFF);
                _SafeStr_4457.alpha = (((_etchingColor >> 24) & 0xFF) / 0xFF);
                _local_1 = _filters.slice();
                _local_1.push(_SafeStr_4457);
        ...
        override protected function refreshTextImage(_arg_1:Boolean=false):void
        {
            ...
            if (_SafeStr_4423 != _field.height)
            {
                if (autoSize != "none")
                {
            ...
            if ((((!(_local_2)) && (!(_arg_1))) && (_SafeStr_3983)))
            {
                _local_3 = _SafeStr_3116.allocate("WE_RESIZED", this, null);
                _SafeStr_3983.dispatchEvent(_local_3);
                _local_3.recycle();
            };
        }
        ...
        private function onChangeEvent(_arg_1:Event):void
        {
            ...
            {
                refreshAutoSize();
                _local_2 = _SafeStr_3116.allocate("WE_CHANGE", this, null);
        ...
        override public function set properties(_arg_1:Array):void
        {
            ...
            for each (var _local_2:PropertyStruct in _arg_1)
            {
                ...
                {
                    case "focus_capturer":
                        _SafeStr_4458 = (_local_2.value as Boolean);
                        if (_SafeStr_4458)
                        {
                    ...
                    case "display_as_password":
                        ...
                        break;
                    case "display_raw":
                        _SafeStr_4453 = (_local_2.value as Boolean);
                };
            };
        ...
        {
            return (_SafeStr_4453);
        }

        override public function set localization(_arg_1:String):void
        {
            super.localization = limitStringLength(((_SafeStr_4453) ? _caption : _arg_1));
        }
...
// _SafeStr_4456 = "_-Om" (String#10126, DoABC#4)
// _SafeStr_4457 = "_-K16" (String#13391, DoABC#4)
