...
//com.sulake.core.window.components.ButtonController
...
package com.sulake.core.window.components
{
    ...
    public class ButtonController extends InteractiveController implements _SafeStr_3122, ITouchAwareWindow 
    {

        protected static const TEXT_FIELD_NAME:String = "_BTN_TEXT";
        protected static const CAPTION_BLEND_CHANGE:Number = 0.5;

        public function ButtonController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:_SafeStr_3109, _arg_8:Function, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0)
        {
        ...
        override public function set caption(_arg_1:String):void
        {
            ...
            var _local_2:_SafeStr_3109 = getChildByName("_BTN_TEXT");
            if (_local_2 != null)
            {
        ...
        {
            super.blend = _arg_1;
            var _local_3:_SafeStr_3109 = getChildByName("_BTN_TEXT");
