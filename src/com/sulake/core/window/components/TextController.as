...
//com.sulake.core.window.components.TextController
...
package com.sulake.core.window.components
{
    ...
    public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable 
    {
        ...
        protected static const _SafeStr_4454:Dictionary = createPropertySetterTable();

        private var _overFlowReplace:String = "";
        protected var _field:TextField;
        protected var _SafeStr_4448:String = "none";
        protected var _localized:Boolean = false;
        protected var _SafeStr_4450:int = 0;
        protected var _SafeStr_4453:Boolean = false;
        protected var _etchingColor:uint;
        protected var _etchingPosition:String;
        protected var _SafeStr_8096:TextFormat;
        private var _textStyleName:String;
        protected var _settingRectangle:Boolean;

        private var _SafeStr_8097:_SafeStr_3350 = new _SafeStr_3350();
        protected var _SafeStr_4449:TextMargins = new TextMargins(0, 0, 0, 0, setTextMargins);
        protected var _drawing:Boolean = false;
        protected var _SafeStr_4451:Number = 0;
        protected var _SafeStr_4452:Number = 0;

        public function TextController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:_SafeStr_3109, _arg_8:Function, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0)
        {
            if (_field == null)
            {
            ...
            {
                _field.width = _SafeStr_4422;
                _field.height = _SafeStr_4423;
            };
        }
        ...
        private static function setAntiAliasType(_arg_1:TextController, _arg_2:String):void
        {
            ...
            _arg_1._SafeStr_8097.antiAliasType = _arg_2;
        ...
        {
            var _local_3:* = null;
            if (_arg_2 != _arg_1._SafeStr_4448)
            {
                _arg_1._SafeStr_4448 = _arg_2;
        ...
        private static function setBold(_arg_1:TextController, _arg_2:Boolean):void
        {
            ...
            _arg_1.setTextFormat(new TextFormat(_local_3.font, _local_3.size, _local_3.color, _local_3.bold, _local_3.italic, _local_3.underline, _local_3.url, _local_3.target, _local_3.align, _local_3.leftMargin, _local_3.rightMargin, _local_3.indent, _local_3.leading));
            _arg_1.defaultTextFormat = _local_3;
            _arg_1._SafeStr_8097.fontWeight = "bold";
        }
        ...
        private static function setFontFace(_arg_1:TextController, _arg_2:String):void
        {
            ...
            _arg_1.setTextFormat(new TextFormat(_local_3.font, _local_3.size, _local_3.color, _local_3.bold, _local_3.italic, _local_3.underline, _local_3.url, _local_3.target, _local_3.align, _local_3.leftMargin, _local_3.rightMargin, _local_3.indent, _local_3.leading));
            _arg_1._field.embedFonts = _SafeStr_278.isEmbeddedFont(_arg_2);
            _arg_1.defaultTextFormat = _local_3;
            _arg_1._SafeStr_8097.fontFamily = _arg_2;
        }
        ...
        private static function setFontSize(_arg_1:TextController, _arg_2:uint):void
        {
            ...
            _arg_1.setTextFormat(new TextFormat(_local_3.font, _local_3.size, _local_3.color, _local_3.bold, _local_3.italic, _local_3.underline, _local_3.url, _local_3.target, _local_3.align, _local_3.leftMargin, _local_3.rightMargin, _local_3.indent, _local_3.leading));
            _arg_1.defaultTextFormat = _local_3;
            _arg_1._SafeStr_8097.fontSize = _arg_2;
        }
        ...
        private static function setItalic(_arg_1:TextController, _arg_2:Boolean):void
        {
            ...
            _arg_1.setTextFormat(new TextFormat(_local_3.font, _local_3.size, _local_3.color, _local_3.bold, _local_3.italic, _local_3.underline, _local_3.url, _local_3.target, _local_3.align, _local_3.leftMargin, _local_3.rightMargin, _local_3.indent, _local_3.leading));
            _arg_1.defaultTextFormat = _local_3;
            _arg_1._SafeStr_8097.fontStyle = ((_arg_2) ? "italic" : "normal");
        }
        ...
        private static function setKerning(_arg_1:TextController, _arg_2:Boolean):void
        {
            ...
            _arg_1._SafeStr_8097.kerning = _arg_2;
        }

        private static function setTextMarginMap(_arg_1:TextController, _arg_2:_SafeStr_24):void
        {
            if (_arg_1._SafeStr_4449)
            {
                _arg_1._SafeStr_4449.assign(_arg_2["left"], _arg_2["top"], _arg_2["right"], _arg_2["bottom"], _arg_1.setTextMargins);
            }
            else
            {
                _arg_1._SafeStr_4449 = new TextMargins(_arg_2["left"], _arg_2["top"], _arg_2["right"], _arg_2["bottom"], _arg_1.setTextMargins);
            };
            _arg_1.refreshTextImage();
        }
        ...
        {
            if (((_arg_1._SafeStr_4449) && (!(_arg_1._SafeStr_4449.left == _arg_2))))
            {
        ...
        {
            if (((_arg_1._SafeStr_4449) && (!(_arg_1._SafeStr_4449.top == _arg_2))))
            {
        ...
        {
            if (((_arg_1._SafeStr_4449) && (!(_arg_1._SafeStr_4449.right == _arg_2))))
            {
        ...
        {
            if (((_arg_1._SafeStr_4449) && (!(_arg_1._SafeStr_4449.bottom == _arg_2))))
            {
        ...
        private static function setSharpness(_arg_1:TextController, _arg_2:Number):void
        {
            ...
            _arg_1.refreshTextImage();
            _arg_1._SafeStr_8097.sharpness = _arg_2;
        }
        ...
        private static function setLeading(_arg_1:TextController, _arg_2:Number):void
        {
            ...
            _arg_1.setTextFormat(_local_3);
            _arg_1.defaultTextFormat = _local_4;
            _arg_1._SafeStr_8097.leading = _arg_2;
        }
        ...
        private static function setTextColor(_arg_1:TextController, _arg_2:uint):void
        {
            ...
            _arg_1.refreshTextImage();
            _arg_1._SafeStr_8097.color = _arg_2;
        }

        private static function setTextStyle(_arg_1:TextController, _arg_2:_SafeStr_3350):void
        {
            if (((!(_arg_1)) || (!(_arg_2))))
            {
                return;
            };
            var _local_3:_SafeStr_3350 = _SafeStr_3371.getStyle(_arg_2.name);
            if (((_local_3) && (!(_local_3.equals(_arg_2)))))
            {
                _local_3 = _SafeStr_3371.findMatchingTextStyle(_arg_2.toString());
            };
            if (_local_3)
            {
        ...
        {
            var _local_4:* = null;
            var _local_3:_SafeStr_3350 = _SafeStr_3371.getStyle(_arg_2);
            if (!_local_3)
            {
                _local_3 = _SafeStr_3371.findMatchingTextStyle(_arg_2);
            };
            if (_local_3)
            {
                _arg_1._textStyleName = _local_3.name;
            ...
            {
                _local_3 = _SafeStr_3371.parseCSS(_arg_2)[0];
                if (_local_3)
                {
                    if (!_SafeStr_3371.getStyle(_local_3.name))
                    {
                        _SafeStr_3371.setStyle(_local_3.name, _local_3);
                    };
                    setTextStyle(_arg_1, _local_3);
                };
            };
            if (_arg_1._SafeStr_4448 == "center")
            {
        ...
        private static function setThickness(_arg_1:TextController, _arg_2:Number):void
        {
            ...
            _arg_1.refreshTextImage();
            _arg_1._SafeStr_8097.thickness = _arg_2;
        }
        ...
        private static function setUnderline(_arg_1:TextController, _arg_2:Boolean):void
        {
            ...
            _arg_1.setTextFormat(new TextFormat(_local_3.font, _local_3.size, _local_3.color, _local_3.bold, _local_3.italic, _local_3.underline, _local_3.url, _local_3.target, _local_3.align, _local_3.leftMargin, _local_3.rightMargin, _local_3.indent, _local_3.leading));
            _arg_1.defaultTextFormat = _local_3;
            _arg_1._SafeStr_8097.textDecoration = ((_arg_2) ? "underline" : "none");
        }
        ...
        protected static function setTextFormatting(_arg_1:TextController):void
        {
            ...
            var _local_2:_SafeStr_3350 = _arg_1._SafeStr_8097;
            var _local_5:_SafeStr_3350 = _SafeStr_3371.getStyle(_local_4);
            var _local_6:TextFormat = _local_3.defaultTextFormat;
            if (!_local_5)
            {
                _local_5 = _SafeStr_3371.getStyle("regular");
            };
            if (!_local_5.color)
            {
                _local_5.color = 0;
            ...
            {
                _local_3.sharpness = _local_5.sharpness;
            };
            if (!_local_2.thickness)
            {
                _local_3.thickness = _local_5.thickness;
            };
            if (_local_2.etchingColor == null)
            {
                _arg_1.etchingColor = _local_5.etchingColor;
            };
            if (_local_2.etchingPosition == null)
            {
                _arg_1.etchingPosition = _local_5.etchingPosition;
            };
            ...
            _local_3.embedFonts = _SafeStr_278.isEmbeddedFont(_local_6.font);
            _local_3.defaultTextFormat = _local_6;
            _arg_1._SafeStr_8096 = _local_6;
        }
        ...
        private static function setEtchingColor(_arg_1:TextController, _arg_2:uint):void
        {
            ...
            _arg_1.refreshTextImage();
            _arg_1._SafeStr_8097.etchingColor = _arg_1._etchingColor;
        }
        ...
        private static function setEtchingPosition(_arg_1:TextController, _arg_2:String):void
        {
            ...
            _arg_1.refreshTextImage();
            _arg_1._SafeStr_8097.etchingPosition = _arg_1._etchingPosition;
        }
        ...
        {
            return ((_field.defaultTextFormat.size == null) ? 12 : _field.defaultTextFormat.size);
        }
        ...
        {
            return (_field.defaultTextFormat.letterSpacing);
        }
        ...
        {
            return (_SafeStr_4450);
        }

        public function get leading():Number
        {
            return (_field.defaultTextFormat.leading);
        }
        ...
        {
            return (_SafeStr_4451);
        }

        public function get scrollV():Number
        {
            return (_SafeStr_4452);
        }
        ...
        {
            _SafeStr_4451 = _arg_1;
            _field.scrollH = (_SafeStr_4451 * _field.maxScrollH);
            refreshTextImage();
        }

        public function set scrollV(_arg_1:Number):void
        {
            if (_arg_1 > _SafeStr_4452)
            {
                _SafeStr_4452 = _arg_1;
        ...
        {
            return (new Rectangle((_SafeStr_4451 * maxScrollH), (_SafeStr_4452 * maxScrollV), width, height));
        }
        ...
        public function set text(_arg_1:String):void
        {
            ...
            _caption = _arg_1;
            if ((((!(_SafeStr_4453)) && (_caption.charAt(0) == "$")) && (_caption.charAt(1) == "{")))
            {
                _localized = true;
        ...
        override public function clone():_SafeStr_3109
        {
            ...
            _local_1._SafeStr_4451 = _SafeStr_4451;
            _local_1._SafeStr_4452 = _SafeStr_4452;
            _local_1._SafeStr_4449 = _SafeStr_4449.clone(_local_1.setTextMargins);
            _local_1._SafeStr_4448 = _SafeStr_4448;
        ...
        protected function refreshTextImage(_arg_1:Boolean=false):void
        {
            ...
            _drawing = true;
            _local_16 = (_SafeStr_4449.left + _SafeStr_4449.right);
            var _local_15:int = (_SafeStr_4449.top + _SafeStr_4449.bottom);
            var _local_3:int = (_SafeStr_4422 - _local_16);
            var _local_6:int = (_SafeStr_4423 - _local_15);
            var _local_2:int = (Math.floor(_field.width) + ((_field.border) ? 1 : 0));
            var _local_13:Boolean;
            if (((_SafeStr_4448 == "none") && (isOverflowReplaceOn)))
            {
            ...
            {
                if (_SafeStr_4448 == "left")
                {
                    setRectangle(_SafeStr_4050, _SafeStr_4051, (_local_2 + _local_16), (Math.floor(_field.height) + _local_15));
                    _local_13 = true;
                }
                else
                {
                    if (_SafeStr_4448 != "right")
                    {
                        if (_SafeStr_4448 != "center")
                        {
            ...
            if ((((!(_local_13)) && (!(_arg_1))) && (_SafeStr_3983)))
            {
                _local_14 = _SafeStr_3116.allocate("WE_RESIZED", this, null);
                _SafeStr_3983.dispatchEvent(_local_14);
                _local_14.recycle();
            };
        }
        ...
        public function setTextMargins(_arg_1:IMargins):void
        {
            ...
            if (_SafeStr_4448 == "left")
            {
                _field.width = ((_SafeStr_4422 - _SafeStr_4449.left) - _SafeStr_4449.right);
            };
            refreshTextImage();
        }
        ...
        protected function parseVariableSet(_arg_1:XML):void
        {
            ...
            if (_arg_1 != null)
            {
                ...
                _SafeStr_3288.parseVariableList(_arg_1.children(), _local_2);
                _drawing = true;
                for (_local_4 in _local_2)
                {
                    _local_3 = _SafeStr_4454[_local_4];
                    if (_local_3 != null)
                    {
        ...
        override public function set properties(_arg_1:Array):void
        {
            ...
            {
                _local_3 = _SafeStr_4454[_local_2.key];
                if (_local_3 != null)
                {
        ...
        override public function get properties():Array
        {
            ...
            _local_3.push(new PropertyStruct("antialias_type", _field.antiAliasType, "String", (!(_field.antiAliasType == _local_2.antiAliasType)), _SafeStr_3334.ANTIALIAS_TYPE_RANGE));
            _local_3.push(createProperty("auto_size", _SafeStr_4448));
            ...
            _local_3.push(new PropertyStruct("etching_position", _etchingPosition, "String", (!(_etchingPosition == _local_2.etchingPosition)), _SafeStr_3334.ETCHING_POSITION_RANGE));
        ...
        {
            _SafeStr_8097 = new _SafeStr_3350();
        }
...
// _SafeStr_4448 = "_-DR" (String#5062, DoABC#4)
// _SafeStr_4449 = "_-A14" (String#1257, DoABC#4)
// _SafeStr_4450 = "_-dX" (String#23891, DoABC#4)
// _SafeStr_4451 = "_-Lh" (String#7279, DoABC#4)
// _SafeStr_4452 = "_-91k" (String#2815, DoABC#4)
// _SafeStr_4453 = "_-i1e" (String#7012, DoABC#4)
// _SafeStr_4454 = "_-jD" (String#15698, DoABC#4)
// _SafeStr_8096 = "_-m1C" (String#28892, DoABC#4)
// _SafeStr_8097 = "_-u1a" (String#3754, DoABC#4)
