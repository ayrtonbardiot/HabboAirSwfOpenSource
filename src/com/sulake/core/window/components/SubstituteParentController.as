...
//com.sulake.core.window.components.SubstituteParentController
...
package com.sulake.core.window.components
{
    ...
    public class SubstituteParentController extends WindowController 
    {
        ...
        private function childParamUpdated(_arg_1:_SafeStr_3116):void
        {
        ...
        override public function addChild(_arg_1:_SafeStr_3109):_SafeStr_3109
        {
            _children.push(_arg_1);
            return (_arg_1);
        }

        override public function addChildAt(_arg_1:_SafeStr_3109, _arg_2:int):_SafeStr_3109
        {
        ...
        override public function getChildAt(_arg_1:int):_SafeStr_3109
        {
            return ((_children) ? ((_arg_1 < _children.length) ? _children[_arg_1] : null) : null);
        }

        override public function getChildByID(_arg_1:int):_SafeStr_3109
        {
            if (_children)
            {
        ...
        override public function getChildByName(_arg_1:String):_SafeStr_3109
        {
            if (_children)
            {
                for each (var _local_2:_SafeStr_3109 in _children)
        ...
        override public function findChildByName(_arg_1:String):_SafeStr_3109
        {
            var _local_2:* = null;
            if (_children)
            {
        ...
        override public function removeChild(_arg_1:_SafeStr_3109):_SafeStr_3109
        {
        ...
        override public function setChildIndex(_arg_1:_SafeStr_3109, _arg_2:int):void
        {
        ...
        override public function swapChildren(_arg_1:_SafeStr_3109, _arg_2:_SafeStr_3109):void
        {
            var _local_3:int;
            var _local_6:int;
            var _local_5:* = null;
