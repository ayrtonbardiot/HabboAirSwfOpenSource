...
//com.sulake.core.window.components.ItemGridController
...
package com.sulake.core.window.components
{
    ...
    public class ItemGridController extends ItemListController implements IItemGridWindow 
    {
        ...
        private var _SafeStr_6417:Boolean = false;
        private var _SafeStr_6413:Boolean = false;
        private var _SafeStr_6415:int;
        private var _SafeStr_6414:Boolean = true;
        private var _SafeStr_6416:Boolean = false;

        public function ItemGridController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:_SafeStr_3109, _arg_8:Function=null, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0)
        {
            super(_arg_1, _arg_2, _arg_3, _arg_4, _arg_5, _arg_6, _arg_7, _arg_8, _arg_9, _arg_10, _arg_11);
            _SafeStr_5555 = (!(_arg_2 == 54));
        ...
        override public function get scrollStepH():Number
        {
            ...
            return ((_SafeStr_5555) ? (0.1 * scrollableRegion.height) : (scrollableRegion.width / numColumns));
        }
        ...
        protected function listEventProc(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
        }

        protected function listItemEventHandler(_arg_1:_SafeStr_3116):void
        {
            var _local_2:* = null;
            if (_arg_1.type == "WE_DESTROYED")
            {
                _local_2 = (_arg_1.target as _SafeStr_3109);
        ...
        override public function populate(_arg_1:Array):void
        {
            ...
            var _local_3:Array = [];
            for each (var _local_4:_SafeStr_3109 in _arg_1)
            {
                if (_local_6 == 0)
                {
                ...
                else
                {
                    if (_local_10 > 0)
                    {
                        ...
                        if (_local_5)
                        {
                            ...
                            {
                                if ((_local_9.right + _local_4.width) <= _SafeStr_4422)
                                {
                                    addColumnForItem(_local_4);
                                    continue;
                                };
        ...
        protected function resolveColumnByItem(_arg_1:_SafeStr_3109):IItemListWindow
        {
            var _local_3:* = null;
        ...
        protected function resolveColumnForNextItem(_arg_1:_SafeStr_3109):IItemListWindow
        {
            var _local_3:* = null;
            var _local_6:* = null;
            if (numColumns == 0)
            ...
            if (_local_5 > 0)
            {
                ...
                if (_local_2)
                {
                    ...
                    {
                        if ((_local_6.right + _arg_1.width) <= _SafeStr_4422)
                        {
                            return (addColumnForItem(_arg_1));
                        };
                    };
        ...
        protected function addColumnForItem(_arg_1:_SafeStr_3109):IItemListWindow
        {
            ...
            _local_2.spacing = ((_SafeStr_6413) ? _SafeStr_6415 : _SafeStr_5549);
        ...
        protected function offsetGridItemsForwards(_arg_1:_SafeStr_3109, _arg_2:uint):void
        {
            var _local_6:* = null;
            var _local_3:* = null;
            var _local_9:uint;
        ...
        protected function offsetGridItemsBackwards(_arg_1:uint):_SafeStr_3109
        {
            var _local_2:* = null;
            var _local_8:uint;
            var _local_7:int;
            ...
            var _local_3:_SafeStr_3109 = _local_4.removeListItemAt(_local_8);
            var _local_5:uint = numGridItems;
            var _local_6:* = _arg_1;
            if (_local_3 == null)
            {
...
// _SafeStr_6413 = "_-yP" (String#14819, DoABC#4)
// _SafeStr_6414 = "_-gf" (String#14133, DoABC#4)
// _SafeStr_6415 = "_-W1E" (String#17227, DoABC#4)
// _SafeStr_6416 = "_-kc" (String#13694, DoABC#4)
// _SafeStr_6417 = "_-ft" (String#13998, DoABC#4)
