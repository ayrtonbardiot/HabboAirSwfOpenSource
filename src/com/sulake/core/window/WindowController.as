...
package com.sulake.core.window
{
    ...
    import com.sulake.core.window.utils._SafeStr_3161;
    ...
    import com.sulake.core.window.dynamicstyle._SafeStr_3357;
    import flash.display.BitmapData;
    import com.sulake.core.window.utils.PropertyStruct;
    import flash.events.MouseEvent;
    import flash.events.Event;

    public class WindowController extends WindowModel implements _SafeStr_3109, IGraphicContextHost, _SafeStr_3161 
    {

        private static const _SafeStr_4444:Rectangle = new Rectangle();
        ...
        private static var _SafeStr_4435:uint = 0;

        protected var _SafeStr_3983:WindowEventDispatcher;
        protected var _SafeStr_4436:IGraphicContext;
        protected var _SafeStr_4437:Function;
        protected var _SafeStr_4440:Boolean = true;
        protected var _parent:WindowController;
        protected var _children:Vector.<_SafeStr_3109>;
        protected var _SafeStr_4414:Boolean = false;
        protected var _SafeStr_4438:WindowRectLimits;
        protected var _SafeStr_4439:Boolean = false;
        private var _SafeStr_4445:DynamicStyle;
        private var _SafeStr_4446:Boolean = false;
        private var _SafeStr_4442:Rectangle;
        private var _SafeStr_4443:uint = _SafeStr_4435++;
        private var _SafeStr_4447:_SafeStr_3283;

        public function WindowController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:_SafeStr_3109, _arg_8:Function=null, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0, _arg_12:String="")
        {
            var _local_13:uint;
            ...
            _SafeStr_4447 = _arg_5.getWindowFactory().getThemeManager().getPropertyDefaults(_arg_3);
            super(_arg_11, _arg_1, _arg_2, _arg_3, _arg_4, _arg_5, _arg_6, _arg_10, _arg_12);
            if (!_SafeStr_4436)
            {
                _SafeStr_4436 = getGraphicContext((!(testParamFlag(16))));
            };
            _SafeStr_4442 = new Rectangle();
            if (_local_14 != null)
            {
                _SafeStr_4431 = new Rectangle(0, 0, _local_14.attribute("width"), _local_14.attribute("height"));
                _SafeStr_4432 = _SafeStr_4431.clone();
                _SafeStr_4050 = _SafeStr_4431.x;
                _SafeStr_4051 = _SafeStr_4431.y;
                _SafeStr_4422 = _SafeStr_4431.width;
                _SafeStr_4423 = _SafeStr_4431.height;
                _arg_5.getWindowParser().parseAndConstruct(_local_14, this, null);
                _local_13 = _SafeStr_4428;
                _SafeStr_4428 = (_SafeStr_4428 & (~(0xC00000)));
                setRectangle(_arg_6.x, _arg_6.y, _arg_6.width, _arg_6.height);
                _SafeStr_4428 = _local_13;
                _SafeStr_4432.x = _arg_6.x;
                _SafeStr_4432.y = _arg_6.y;
                _SafeStr_4432.width = _arg_6.width;
                _SafeStr_4432.height = _arg_6.height;
            };
            var _local_15:DefaultAttStruct = _arg_5.getWindowFactory().getDefaultsByTypeAndStyle(_arg_2, _arg_3);
            if (_local_15)
            {
                _SafeStr_4427 = _local_15.blend;
                _SafeStr_4424 = _local_15.threshold;
        ...
        public static function expandToAccommodateChild(_arg_1:WindowController, _arg_2:_SafeStr_3109):void
        {
            var _local_6:uint;
            var _local_9:uint;
            var _local_4:int;
            ...
            if (_local_8)
            {
                ...
                if (((!(_local_3 == 0)) || (!(_local_4 == 0))))
                {
                    ...
                    {
                        _SafeStr_3109(_arg_1.getChildAt(_local_9)).offset(-(_local_4), -(_local_3));
                        _local_9++;
                    };
                };
                if (_local_6)
        ...
        public static function resizeToAccommodateChildren(_arg_1:WindowController):void
        {
            ...
            var _local_3:int;
            var _local_2:int;
            var _local_5:* = -2147483648;
            var _local_10:* = -2147483648;
            var _local_8:Boolean;
        ...
        {
            return ((_SafeStr_4437 != null) ? _SafeStr_4437 : ((_parent != null) ? _parent.procedure : nullEventProc));
        }
        ...
        public function get parent():_SafeStr_3109
        {
            return (_parent);
        }
        ...
        {
            return ((_SafeStr_4438) ? _SafeStr_4438 : _SafeStr_4438 = new WindowRectLimits(this));
        }

        public function get immediateClickMode():Boolean
        {
            return (_SafeStr_4439);
        }

        public function set x(_arg_1:int):void
        {
            if (_arg_1 != _SafeStr_4050)
            {
                setRectangle(_arg_1, _SafeStr_4051, _SafeStr_4422, _SafeStr_4423);
            };
        }

        public function set y(_arg_1:int):void
        {
            if (_arg_1 != _SafeStr_4051)
            {
                setRectangle(_SafeStr_4050, _arg_1, _SafeStr_4422, _SafeStr_4423);
            };
        }
        ...
        {
            if (_arg_1 != _SafeStr_4422)
            {
                setRectangle(_SafeStr_4050, _SafeStr_4051, _arg_1, _SafeStr_4423);
            };
        }

        public function set height(_arg_1:int):void
        {
            if (_arg_1 != _SafeStr_4423)
            {
                setRectangle(_SafeStr_4050, _SafeStr_4051, _SafeStr_4422, _arg_1);
            };
        }

        public function set position(_arg_1:Point):void
        {
            setRectangle(_arg_1.x, _arg_1.y, _SafeStr_4422, _SafeStr_4423);
        }
        ...
        public function set background(_arg_1:Boolean):void
        {
            ...
            _SafeStr_4440 = ((_SafeStr_4440) || (_arg_1));
            _context.invalidate(this, null, 1);
        }
        ...
        public function set visible(_arg_1:Boolean):void
        {
            ...
            if (_arg_1 != _SafeStr_4426)
            {
                ...
                if (((_SafeStr_4436) && (!(_arg_1))))
                {
                    _SafeStr_4436.visible = false;
                };
                _context.invalidate(this, null, 1);
                _local_2 = _SafeStr_3116.allocate("WE_CHILD_VISIBILITY", this, this);
        ...
        {
            _SafeStr_4424 = ((_arg_1 > 0xFF) ? 0xFF : _arg_1);
        }

        public function set procedure(_arg_1:Function):void
        {
            _SafeStr_4437 = _arg_1;
        }
        ...
        public function set style(_arg_1:uint):void
        {
            ...
            if (_arg_1 != _style)
            {
                ...
                _context.invalidate(this, null, 1);
                _SafeStr_4447 = _context.getWindowFactory().getThemeManager().getPropertyDefaults(_style);
            };
        }

        public function set dynamicStyle(_arg_1:String):void
        {
            _SafeStr_4430 = _arg_1;
            _context.invalidate(this, null, 1);
        }

        public function set clipping(_arg_1:Boolean):void
        {
            if (_arg_1 != _SafeStr_4425)
            {
                _SafeStr_4425 = _arg_1;
                _context.invalidate(this, null, 1);
            };
        }

        public function get host():_SafeStr_3109
        {
            return ((_parent == desktop) ? this : _parent.host);
        }

        public function get desktop():_SafeStr_3216
        {
            return (_context.getDesktopWindow());
        }

        public function set parent(_arg_1:_SafeStr_3109):void
        {
            var _local_3:* = null;
            if (_arg_1 == this)
            {
            ...
            var _local_2:_SafeStr_3109 = _parent;
            if (_parent != _arg_1)
            {
                if (_parent != null)
                {
                ...
                if (_parent != null)
                {
                    _SafeStr_4442 = _parent.rectangle;
                    _SafeStr_4432.x = _SafeStr_4050;
                    _SafeStr_4432.y = _SafeStr_4051;
                    _SafeStr_4432.width = _SafeStr_4422;
                    _SafeStr_4432.height = _SafeStr_4423;
                    _local_3 = _SafeStr_3116.allocate("WE_PARENT_ADDED", this, _parent);
                ...
                else
                {
                    _SafeStr_4442.x = 0;
                    _SafeStr_4442.y = 0;
                    _SafeStr_4442.width = 0;
                    _SafeStr_4442.height = 0;
                    _local_3 = _SafeStr_3116.allocate("WE_PARENT_REMOVED", this, _local_2);
                    update(this, _local_3);
                };
                _local_3.recycle();
            };
        ...
        {
            return ((!(_SafeStr_4436 == null)) || (!(testParamFlag(16))));
        }
        ...
        public function getGraphicContext(_arg_1:Boolean):IGraphicContext
        {
            ...
            {
                _SafeStr_4436 = new GraphicContext((("GC {" + _name) + "}"), 1, new Rectangle(_SafeStr_4050, _SafeStr_4051, _SafeStr_4422, _SafeStr_4423));
        ...
        {
            var _local_1:int;
            _SafeStr_4436 = getGraphicContext(true);
            if (_parent)
            {
            ...
            {
                if (_SafeStr_4436.numChildContexts != numChildren)
                {
                    _local_1 = 0;
                    for each (var _local_2:WindowController in _children)
                    {
                        _SafeStr_4436.addChildContextAt(_local_2.getGraphicContext(true), _local_1++);
                    };
                };
            };
            _SafeStr_4446 = true;
        ...
        public function clone():_SafeStr_3109
        {
            var _local_2:Class = Object(this).constructor;
            var _local_1:WindowController = (new _local_2(_name, _SafeStr_4028, _style, _SafeStr_4428, _context, new Rectangle(_SafeStr_4050, _SafeStr_4051, _SafeStr_4422, _SafeStr_4423), null, _SafeStr_4437, properties, ((_SafeStr_4429) ? _SafeStr_4429.concat() : null), _SafeStr_3820) as WindowController);
            _local_1.dynamicStyle = _SafeStr_4430;
            _local_1._SafeStr_4424 = _SafeStr_4424;
            _local_1._SafeStr_4440 = _SafeStr_4440;
            _local_1._SafeStr_4414 = _SafeStr_4414;
            _local_1._SafeStr_4442 = _SafeStr_4442.clone();
            _local_1._SafeStr_4050 = _SafeStr_4050;
            _local_1._SafeStr_4051 = _SafeStr_4051;
            _local_1._SafeStr_4422 = _SafeStr_4422;
            _local_1._SafeStr_4423 = _SafeStr_4423;
            _local_1._SafeStr_4431 = _SafeStr_4431.clone();
            _local_1._SafeStr_4432 = _SafeStr_4432.clone();
            _local_1._SafeStr_4433 = ((_SafeStr_4433) ? _SafeStr_4433.clone() : null);
            _local_1._SafeStr_4434 = ((_SafeStr_4434) ? _SafeStr_4434.clone() : null);
            _local_1._SafeStr_4438 = ((_SafeStr_4438) ? _SafeStr_4438.clone(_local_1) : null);
            _local_1._context = _context;
            _local_1._fillColor = _fillColor;
            _local_1._alphaColor = _alphaColor;
            _local_1.clipping = _SafeStr_4425;
            _local_1._SafeStr_4426 = _SafeStr_4426;
            _local_1._SafeStr_4427 = _SafeStr_4427;
            _local_1._SafeStr_4428 = _SafeStr_4428;
            _local_1._SafeStr_3734 = _SafeStr_3734;
            _local_1._name = _name;
            _local_1._SafeStr_3820 = _SafeStr_3820;
        ...
        override public function dispose():void
        {
            ...
            if (!_disposed)
            {
                ...
                if (_children)
                {
                    ...
                    {
                        _SafeStr_13(_children.pop()).dispose();
                    };
                };
                _children = null;
                if (parent)
                ...
                if (_SafeStr_3983)
                {
                    ...
                    _local_1.recycle();
                    if ((_SafeStr_3983 is _SafeStr_13))
                    {
                        _SafeStr_13(_SafeStr_3983).dispose();
                        _SafeStr_3983 = null;
                    };
                };
                if (_SafeStr_4436 != null)
                {
                    _SafeStr_4436.dispose();
                    _SafeStr_4436 = null;
                };
                super.dispose();
            };
        ...
        {
            return (((((("[Window " + getQualifiedClassName(this)) + " ") + _name) + " ") + _SafeStr_4443) + "]");
        }
        ...
        public function center():void
        {
            if (_parent != null)
            {
                x = ((_parent.width / 2) - (_SafeStr_4422 / 2));
                y = ((_parent.height / 2) - (_SafeStr_4423 / 2));
            };
        }
        ...
        public function setRectangle(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int):void
        {
            ...
            if (_SafeStr_4438)
            {
                _arg_4 = Math.max(_SafeStr_4438.minHeight, _arg_4);
                _arg_4 = Math.min(_SafeStr_4438.maxHeight, _arg_4);
                _arg_3 = Math.max(_SafeStr_4438.minWidth, _arg_3);
                _arg_3 = Math.min(_SafeStr_4438.maxWidth, _arg_3);
            };
            var _local_5:Boolean = ((!(_arg_1 == _SafeStr_4050)) || (!(_arg_2 == _SafeStr_4051)));
            var _local_6:Boolean = ((!(_arg_3 == _SafeStr_4422)) || (!(_arg_4 == _SafeStr_4423)));
            if (((_local_6) && (!(_local_5))))
            {
                _local_7 = (_SafeStr_4428 & 0x0C0000);
                if (_local_7 == 0xC0000)
                {
                    _arg_1 = int((_arg_1 - ((_arg_3 - _SafeStr_4422) / 2)));
                    _local_5 = true;
                }
                else
                {
                    if (_local_7 == 0x40000)
                    {
                        _arg_1 = (_arg_1 - (_arg_3 - _SafeStr_4422));
                        _local_5 = true;
                    };
                };
                _local_7 = (_SafeStr_4428 & 0x300000);
                if (_local_7 == 0x300000)
                {
                    _arg_2 = int((_arg_2 - ((_arg_4 - _SafeStr_4423) / 2)));
                    _local_5 = true;
                }
                else
                {
                    ...
                    {
                        _arg_2 = (_arg_2 - (_arg_4 - _SafeStr_4423));
                        _local_5 = true;
                    };
                };
            };
            if (testParamFlag(32))
            {
                if (_parent != null)
                {
                    ...
                    if (_local_5)
                    {
                        ...
                        _local_5 = ((!(_arg_1 == _SafeStr_4050)) || (!(_arg_2 == _SafeStr_4051)));
                    }
                    else
                    {
                        ...
                        _local_6 = ((!(_arg_3 == _SafeStr_4422)) || (!(_arg_4 == _SafeStr_4423)));
                    };
                };
            };
            if (((_local_5) || (_local_6)))
            {
                if (_local_5)
                {
                    _local_8 = _SafeStr_3116.allocate("WE_RELOCATE", this, null, true);
                ...
                if (_local_6)
                {
                    _local_8 = _SafeStr_3116.allocate("WE_RESIZE", this, null, true);
                    update(this, _local_8);
                    if (_local_8.isWindowOperationPrevented())
                    {
                        _local_6 = false;
                ...
                if (_local_6)
                {
                    _SafeStr_4432.width = _SafeStr_4422;
                    _SafeStr_4432.height = _SafeStr_4423;
                    _SafeStr_4422 = _arg_3;
                    _SafeStr_4423 = _arg_4;
                };
                if (_local_5)
                {
                    _local_8 = _SafeStr_3116.allocate("WE_RELOCATED", this, null);
                    update(this, _local_8);
                    _local_8.recycle();
                };
                if (_local_6)
                {
                    _local_8 = _SafeStr_3116.allocate("WE_RESIZED", this, null);
                    update(this, _local_8);
                    _local_8.recycle();
                };
            };
        ...
        public function getRegionProperties(_arg_1:Rectangle=null, _arg_2:Rectangle=null, _arg_3:Rectangle=null, _arg_4:Rectangle=null):void
        {
            if (_arg_1 != null)
            {
                _arg_1.x = _SafeStr_4050;
                _arg_1.y = _SafeStr_4051;
                _arg_1.width = _SafeStr_4422;
                _arg_1.height = _SafeStr_4423;
            };
            if (_arg_2 != null)
            {
                _arg_2.x = _SafeStr_4432.x;
                _arg_2.y = _SafeStr_4432.y;
                _arg_2.width = _SafeStr_4432.width;
                _arg_2.height = _SafeStr_4432.height;
            };
            if (((!(_arg_3 == null)) && (!(_SafeStr_4433 == null))))
            {
                _arg_3.x = _SafeStr_4433.x;
                _arg_3.y = _SafeStr_4433.y;
                _arg_3.width = _SafeStr_4433.width;
                _arg_3.height = _SafeStr_4433.height;
            };
            if (((!(_arg_4 == null)) && (!(_SafeStr_4434 == null))))
            {
                _arg_4.x = _SafeStr_4434.x;
                _arg_4.y = _SafeStr_4434.y;
                _arg_4.width = _SafeStr_4434.width;
                _arg_4.height = _SafeStr_4434.height;
            };
        }
        ...
        public function setRegionProperties(_arg_1:Rectangle=null, _arg_2:Rectangle=null, _arg_3:Rectangle=null):void
        {
            if (_arg_3 != null)
            {
                ...
                if (_SafeStr_4434 == null)
                {
                    _SafeStr_4434 = new Rectangle();
                };
                _SafeStr_4434.x = _arg_3.x;
                _SafeStr_4434.y = _arg_3.y;
                _SafeStr_4434.width = _arg_3.width;
                _SafeStr_4434.height = _arg_3.height;
            };
            if (_arg_2 != null)
            {
                ...
                if (_SafeStr_4433 == null)
                {
                    _SafeStr_4433 = new Rectangle();
                };
                _SafeStr_4433.x = _arg_2.x;
                _SafeStr_4433.y = _arg_2.y;
                _SafeStr_4433.width = _arg_2.width;
                _SafeStr_4433.height = _arg_2.height;
            };
        ...
        public function buildFromXML(_arg_1:XML, _arg_2:_SafeStr_24=null):Boolean
        {
        ...
        public function getDrawRegion(_arg_1:Rectangle):void
        {
            ...
            else
            {
                if (_parent != null)
                {
                    ...
                    _arg_1.x = (_arg_1.x + _SafeStr_4050);
                    _arg_1.y = (_arg_1.y + _SafeStr_4051);
                    _arg_1.width = _SafeStr_4422;
                    _arg_1.height = _SafeStr_4423;
                }
                else
        ...
        public function update(_arg_1:WindowController, _arg_2:_SafeStr_3116):Boolean
        {
            var _local_5:* = null;
            var _local_6:* = null;
            var _local_4:* = null;
            ...
            if (!testParamFlag(9))
            {
                ...
                if (!_arg_2.isWindowOperationPrevented())
                {
                    ...
                    {
                        _SafeStr_3983.dispatchEvent(_arg_2);
                        if (_disposed)
                        {
                            return (true);
                        };
                    ...
                    case "WME_DOWN":
                        ...
                        if ((_SafeStr_4428 & 0x3000) > 0)
                        {
                            ...
                            while (_local_6 != null)
                            {
                                ...
                                {
                                    _context.getWindowServices().getMouseScalingService().begin(_local_6, (_SafeStr_4428 & 0x3000));
                                    break;
                                };
                                _local_6 = _local_6.parent;
                            };
                ...
                if ((_arg_2 is _SafeStr_3116))
                {
                    switch (_arg_2.type)
                    {
                        case "WE_RESIZED":
                            if (_arg_1 == this)
                            {
                                _SafeStr_4444.x = ((_SafeStr_4050 < _SafeStr_4432.x) ? _SafeStr_4050 : _SafeStr_4432.x);
                                _SafeStr_4444.y = ((_SafeStr_4051 < _SafeStr_4432.y) ? _SafeStr_4051 : _SafeStr_4432.y);
                                _SafeStr_4444.right = (((_SafeStr_4050 + _SafeStr_4422) > _SafeStr_4432.right) ? (_SafeStr_4050 + _SafeStr_4422) : _SafeStr_4432.right);
                                _SafeStr_4444.bottom = (((_SafeStr_4051 + _SafeStr_4423) > _SafeStr_4432.bottom) ? (_SafeStr_4051 + _SafeStr_4423) : _SafeStr_4432.bottom);
                                _SafeStr_4444.offset(-(_SafeStr_4050), -(_SafeStr_4051));
                                _context.invalidate(this, _SafeStr_4444, 2);
                                _local_4 = _SafeStr_3116.allocate("WE_PARENT_RESIZED", this, null);
                                ...
                                if (_parent != null)
                                {
                                    _local_3 = _SafeStr_4428;
                                    _SafeStr_4428 = (_SafeStr_4428 & 0xFFFFF33F);
                                    if (testParamFlag(0x400000))
                                    {
                                        _parent.width = (_parent.width + (_SafeStr_4422 - _SafeStr_4432.width));
                                    };
                                    if (testParamFlag(0x800000))
                                    {
                                        _parent.height = (_parent.height + (_SafeStr_4423 - _SafeStr_4432.height));
                                    };
                                    _SafeStr_4428 = _local_3;
                                    _local_4 = _SafeStr_3116.allocate("WE_CHILD_RESIZED", _parent, this);
                        ...
                        case "WE_RELOCATED":
                            if (_arg_1 == this)
                            {
                                ...
                                _SafeStr_4444.bottom = (((_SafeStr_4051 + _SafeStr_4423) > _SafeStr_4432.bottom) ? (_SafeStr_4051 + _SafeStr_4423) : _SafeStr_4432.bottom);
                                _SafeStr_4444.offset(-(_SafeStr_4050), -(_SafeStr_4051));
                                _context.invalidate(this, _SafeStr_4444, 4);
                                _local_4 = _SafeStr_3116.allocate("WE_PARENT_RELOCATED", this, null);
                                notifyChildren(_local_4);
                                _local_4.recycle();
                                if (_parent != null)
                                {
                                    _local_4 = _SafeStr_3116.allocate("WE_CHILD_RELOCATED", _parent, this);
                                    _parent.update(this, _local_4);
                                    _local_4.recycle();
                                };
                            };
                        ...
                        case "WE_ACTIVATED":
                            if (_arg_1 == this)
                            {
                                _local_4 = _SafeStr_3116.allocate("WE_PARENT_ACTIVATED", this, null);
                                notifyChildren(_local_4);
                                _local_4.recycle();
                                if (_parent != null)
                                {
                                    _local_4 = _SafeStr_3116.allocate("WE_CHILD_ACTIVATED", _parent, this);
                                    _parent.update(this, _local_4);
                                    _local_4.recycle();
                                };
                            };
                        ...
                        case "WE_PARENT_RESIZED":
                            _parent.getRegionProperties(null, _SafeStr_4442);
                            updateScaleRelativeToParent();
                            break;
                        case "WE_CHILD_ADDED":
                        ...
                        case "WE_CHILD_VISIBILITY":
                            if (_arg_1 == this)
                            {
                                if (_parent != null)
                                {
                                    _local_4 = _SafeStr_3116.allocate("WE_CHILD_VISIBILITY", _parent, this);
                                    _parent.update(this, _local_4);
                                    _local_4.recycle();
                                };
                            };
        ...
        private function renderDynamicStyle():void
        {
            ...
            if (((!(_SafeStr_4445)) || (!(_SafeStr_4445.name == _SafeStr_4430))))
            {
                _SafeStr_4445 = _SafeStr_3357.getStyle(_SafeStr_4430);
            };
            if (getStateFlag(32))
            {
                _local_1 = 32;
            ...
            applyDynamicStyleByState(this, _SafeStr_4445, _local_1);
            if (_children)
            {
        ...
        private function applyDynamicStyleByState(_arg_1:WindowController, _arg_2:DynamicStyle, _arg_3:uint):void
        {
            ...
            {
                _arg_1._SafeStr_4436.getDisplayObject().transform.colorTransform = _arg_2.getColorTransform(_arg_3);
            }
            else
            {
                _arg_1._SafeStr_4441 = _arg_2.getColorTransform(_arg_3);
                _arg_1.invalidate();
            };
        ...
        private function recursivelyUpdateChildrensDynamicStyles(_arg_1:Vector.<_SafeStr_3109>, _arg_2:uint):void
        {
            for each (var _local_3:WindowController in _arg_1)
            {
                if (_SafeStr_4445.getChildStyle(_local_3))
                {
                    applyDynamicStyleByState(_local_3, _SafeStr_4445.getChildStyle(_local_3), _arg_2);
                };
        ...
        protected function notifyEventListeners(_arg_1:_SafeStr_3116):void
        {
            ...
            if (!_arg_1.isWindowOperationPrevented())
            {
                ...
                {
                    _SafeStr_3983.dispatchEvent(_arg_1);
                };
            };
        }
        ...
        private function notifyChildren(_arg_1:_SafeStr_3116):void
        {
            if (_children)
            {
                for each (var _local_2:WindowController in _children)
        ...
        {
            return ((((_arg_1.x >= _SafeStr_4050) && (_arg_1.x < (_SafeStr_4050 + _SafeStr_4422))) && (_arg_1.y >= _SafeStr_4051)) && (_arg_1.y < (_SafeStr_4051 + _SafeStr_4423)));
        }
        ...
        {
            return (testLocalPointHitAgainstAlpha(_arg_1, _arg_2, _SafeStr_4424));
        }
        ...
        public function setGlobalPosition(_arg_1:Point):void
        {
            ...
            if (_parent != null)
            {
                ...
                _local_2.x = (_local_2.x + _SafeStr_4050);
                _local_2.y = (_local_2.y + _SafeStr_4051);
            }
            else
            {
                _local_2.x = _SafeStr_4050;
                _local_2.y = _SafeStr_4051;
            };
        ...
        public function validateGlobalPointIntersection(_arg_1:Point, _arg_2:BitmapData):Boolean
        {
            ...
            return (testLocalPointHitAgainstAlpha(_local_3, _arg_2, _SafeStr_4424));
        }
        ...
        public function getMouseRegion(_arg_1:Rectangle):void
        {
            ...
            if (testParamFlag(16))
            {
                ...
                _SafeStr_3109(_parent).getMouseRegion(_local_2);
        ...
        protected function testLocalPointHitAgainstAlpha(_arg_1:Point, _arg_2:BitmapData, _arg_3:uint):Boolean
        {
            ...
            if (((_SafeStr_4422 < 1) || (_SafeStr_4423 < 1)))
            {
                return (false);
            };
            if (((_SafeStr_4440) && (_SafeStr_4424 > 0)))
            {
                if (!testParamFlag(16))
                {
                    if (((_arg_1.x <= _SafeStr_4422) && (_arg_1.y <= _SafeStr_4423)))
                    {
            ...
            {
                if (((_arg_1.x >= 0) && (_arg_1.x < _SafeStr_4422)))
                {
                    if (((_arg_1.y >= 0) && (_arg_1.y < _SafeStr_4423)))
                    {
                        _local_5 = true;
                    };
                };
        ...
        {
            return (_SafeStr_4423 / _SafeStr_4431.height);
        }

        public function resolveHorizontalScale():Number
        {
            return (_SafeStr_4422 / _SafeStr_4431.width);
        }

        public function offset(_arg_1:Number, _arg_2:Number):void
        {
            setRectangle((_SafeStr_4050 + _arg_1), (_SafeStr_4051 + _arg_2), _SafeStr_4422, _SafeStr_4423);
        }

        public function scale(_arg_1:Number, _arg_2:Number):void
        {
            setRectangle(_SafeStr_4050, _SafeStr_4051, (_SafeStr_4422 + _arg_1), (_SafeStr_4423 + _arg_2));
        }
        ...
        public function scaleToAccommodateChildren():void
        {
            ...
            if (_local_5)
            {
                ...
                setRectangle((_SafeStr_4050 + _local_2), (_SafeStr_4051 + _local_1), _local_7, _local_3);
                for each (_local_9 in _children)
                {
        ...
        {
            return (!((_SafeStr_3734 & _arg_1) == 0));
        }

        public function setStateFlag(_arg_1:uint, _arg_2:Boolean=true):void
        {
            var _local_4:*;
            var _local_3:uint = _SafeStr_3734;
            _SafeStr_3734 = ((_arg_2) ? ((_local_4 = (_SafeStr_3734 | _arg_1)), (_SafeStr_3734 = _local_4), _local_4) : ((_local_4 = (_SafeStr_3734 & (~(_arg_1)))), (_SafeStr_3734 = _local_4), _local_4));
            if (_SafeStr_3734 != _local_3)
            {
                renderDynamicStyle();
                _context.invalidate(this, null, 8);
            };
        ...
        {
            return (!((_SafeStr_4428 & _arg_1) == 0));
        }

        public function setParamFlag(_arg_1:uint, _arg_2:Boolean=true):void
        {
            var _local_4:*;
            var _local_3:uint = _SafeStr_4428;
            _SafeStr_4428 = ((_arg_2) ? ((_local_4 = (_SafeStr_4428 | _arg_1)), (_SafeStr_4428 = _local_4), _local_4) : ((_local_4 = (_SafeStr_4428 & (~(_arg_1)))), (_SafeStr_4428 = _local_4), _local_4));
            if (_SafeStr_4428 != _local_3)
            {
                if (!(_SafeStr_4428 & 0x10))
                {
                    if (!_SafeStr_4436)
                    {
        ...
        protected function updateScaleRelativeToParent():void
        {
            ...
            var _local_1:* = (!(testParamFlag(0, 192)));
            var _local_8:* = (!(testParamFlag(0, 0x0C00)));
            var _local_4:int = _SafeStr_4050;
            var _local_7:int = _SafeStr_4051;
            var _local_3:int = _SafeStr_4422;
            var _local_5:int = _SafeStr_4423;
            if (((_local_1) || (_local_8)))
            {
                if (_local_1)
                {
                    _local_6 = (_parent.width - _SafeStr_4442.width);
                    _local_9 = (_SafeStr_4428 & 0xC0);
                    if (_local_9 == 128)
                    {
                ...
                if (_local_8)
                {
                    _local_6 = (_parent.height - _SafeStr_4442.height);
                    _local_9 = (_SafeStr_4428 & 0x0C00);
                    if (_local_9 == 0x0800)
                    {
                ...
                _local_2 = _SafeStr_4428;
                _SafeStr_4428 = (_SafeStr_4428 & 0xFF3FF33F);
                setRectangle(_local_4, _local_7, _local_3, _local_5);
                _SafeStr_4428 = _local_2;
            }
            else
            {
                if (testParamFlag(32))
                {
                    if (_parent != null)
                    {
                        ...
                        if (((((!(_local_4 == _SafeStr_4050)) || (!(_local_7 == _SafeStr_4051))) || (!(_local_3 == _SafeStr_4422))) || (!(_local_5 == _SafeStr_4423))))
                        {
                            _local_2 = _SafeStr_4428;
                            _SafeStr_4428 = (_SafeStr_4428 & 0xFF3FF33F);
                            setRectangle(_local_4, _local_7, _local_3, _local_5);
        ...
        {
            if (_SafeStr_3734 == 0x40000000)
            {
                return (true);
            };
            _SafeStr_3734 = 0x40000000;
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_DESTROY", this, null);
            ...
            _local_1.recycle();
            _local_1 = _SafeStr_3116.allocate("WE_DESTROYED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            dispose();
            return (true);
        ...
        {
            if ((_SafeStr_3734 & 0x40))
            {
                return (false);
            };
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_MINIMIZE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1 = _SafeStr_3116.allocate("WE_MINIMIZED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function maximize():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_MAXIMIZE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1.recycle();
            setStateFlag(64, true);
            _local_1 = _SafeStr_3116.allocate("WE_MAXIMIZED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        {
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_RESTORE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1 = _SafeStr_3116.allocate("WE_RESTORED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        {
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_ACTIVATE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1.recycle();
            setStateFlag(1, true);
            _local_1 = _SafeStr_3116.allocate("WE_ACTIVATED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function deactivate():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_DEACTIVATE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1 = _SafeStr_3116.allocate("WE_DEACTIVATED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function lock():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_LOCK", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1.recycle();
            setStateFlag(64, true);
            _local_1 = _SafeStr_3116.allocate("WE_LOCKED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function unlock():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_UNLOCK", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1.recycle();
            setStateFlag(64, false);
            _local_1 = _SafeStr_3116.allocate("WE_UNLOCKED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function enable():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_ENABLE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1 = _SafeStr_3116.allocate("WE_ENABLED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function disable():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_DISABLE", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1 = _SafeStr_3116.allocate("WE_DISABLED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function focus():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_FOCUS", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1.recycle();
            setStateFlag(2, true);
            _local_1 = _SafeStr_3116.allocate("WE_FOCUSED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }
        ...
        public function unfocus():Boolean
        {
            ...
            var _local_1:_SafeStr_3116 = _SafeStr_3116.allocate("WE_UNFOCUS", this, null);
            update(this, _local_1);
            if (_local_1.isDefaultPrevented())
            {
                _local_1.recycle();
            ...
            _local_1 = _SafeStr_3116.allocate("WE_UNFOCUSED", this, null);
            update(this, _local_1);
            _local_1.recycle();
            return (true);
        }

        public function getChildUnderPoint(_arg_1:Point):_SafeStr_3109
        {
            var _local_3:* = null;
            var _local_5:* = null;
            var _local_4:Boolean;
        ...
        public function groupChildrenUnderPoint(_arg_1:Point, _arg_2:Array):void
        {
            ...
            if (_SafeStr_4426)
            {
                if (((((_arg_1.x >= _SafeStr_4050) && (_arg_1.x < (_SafeStr_4050 + _SafeStr_4422))) && (_arg_1.y >= _SafeStr_4051)) && (_arg_1.y < (_SafeStr_4051 + _SafeStr_4423))))
                {
                    _arg_2.push(this);
                    if (_children)
                    {
                        _arg_1.offset(-(_SafeStr_4050), -(_SafeStr_4051));
        ...
        public function groupParameterFilteredChildrenUnderPoint(_arg_1:Point, _arg_2:Array, _arg_3:uint=0):void
        {
            ...
            if (_SafeStr_4426)
            {
                if (((((_arg_1.x >= _SafeStr_4050) && (_arg_1.x < (_SafeStr_4050 + _SafeStr_4422))) && (_arg_1.y >= _SafeStr_4051)) && (_arg_1.y < (_SafeStr_4051 + _SafeStr_4423))))
                {
                    if ((_SafeStr_4428 & _arg_3) == _arg_3)
                    {
                        _arg_2.push(this);
                    };
                    if (_children)
        ...
        public function addEventListener(_arg_1:String, _arg_2:Function, _arg_3:int=0):void
        {
            if (!_disposed)
            {
                if (!_SafeStr_3983)
                {
                    _SafeStr_3983 = new WindowEventDispatcher(this);
                };
                _SafeStr_3983.addEventListener(_arg_1, _arg_2, _arg_3);
            };
        }

        public function hasEventListener(_arg_1:String):Boolean
        {
            return (((_disposed) || (!(_SafeStr_3983))) ? false : _SafeStr_3983.hasEventListener(_arg_1));
        }

        public function removeEventListener(_arg_1:String, _arg_2:Function):void
        {
            if (((!(_disposed)) && (_SafeStr_3983)))
            {
                _SafeStr_3983.removeEventListener(_arg_1, _arg_2);
            };
        }

        public function get children():Vector.<_SafeStr_3109>
        {
            return (_children);
        }
        ...
        public function populate(_arg_1:Array):void
        {
            ...
            if (!_children)
            {
                _children = new Vector.<_SafeStr_3109>();
            };
            for each (var _local_3:WindowController in _arg_1)
            {
            ...
            if (((_SafeStr_4446) || (_local_2)))
            {
                setupGraphicsContext();
            };
        }

        public function addChild(_arg_1:_SafeStr_3109):_SafeStr_3109
        {
            ...
            if (((_SafeStr_4446) || (_local_2.hasGraphicsContext())))
            {
                setupGraphicsContext();
                if (_local_2.getGraphicContext(true).parent != _SafeStr_4436)
                {
                    _SafeStr_4436.addChildContext(_local_2.getGraphicContext(true));
                };
            };
            var _local_3:_SafeStr_3116 = _SafeStr_3116.allocate("WE_CHILD_ADDED", this, _arg_1);
            update(this, _local_3);
            _local_3.recycle();
            return (_arg_1);
        }

        public function addChildAt(_arg_1:_SafeStr_3109, _arg_2:int):_SafeStr_3109
        {
            ...
            _local_3.parent = this;
            if (((_SafeStr_4446) || (_local_3.hasGraphicsContext())))
            {
                setupGraphicsContext();
                if (_local_3.getGraphicContext(true).parent != _SafeStr_4436)
                {
                    _SafeStr_4436.addChildContextAt(_local_3.getGraphicContext(true), _arg_2);
                };
            };
            var _local_4:_SafeStr_3116 = _SafeStr_3116.allocate("WE_CHILD_ADDED", this, _arg_1);
            update(this, _local_4);
            _local_4.recycle();
            return (_arg_1);
        }

        public function getChildAt(_arg_1:int):_SafeStr_3109
        {
            return ((_children) ? (((_arg_1 < _children.length) && (_arg_1 > -1)) ? _children[_arg_1] : null) : null);
        }

        public function getChildByID(_arg_1:int):_SafeStr_3109
        {
            if (_children)
            {
        ...
        public function getChildByName(_arg_1:String):_SafeStr_3109
        {
            if (_children)
            {
                for each (var _local_2:_SafeStr_3109 in _children)
        ...
        public function findChildByName(_arg_1:String):_SafeStr_3109
        {
            var _local_2:* = null;
            if (_children)
            {
                ...
                for each (_local_2 in _children)
                {
                    ...
                    if (_local_2)
                    {
                        return (_local_2 as _SafeStr_3109);
                    };
                };
            };
            return (null);
        ...
        public function getChildByTag(_arg_1:String):_SafeStr_3109
        {
            if (_children)
            {
                for each (var _local_2:_SafeStr_3109 in _children)
        ...
        public function findChildByTag(_arg_1:String):_SafeStr_3109
        {
            if (((_SafeStr_4429) && (_SafeStr_4429.indexOf(_arg_1) > -1)))
            {
                return (this);
            };
        ...
        public function getChildIndex(_arg_1:_SafeStr_3109):int
        {
            return ((_children) ? _children.indexOf(_arg_1) : -1);
        }

        public function removeChild(_arg_1:_SafeStr_3109):_SafeStr_3109
        {
            if (!_children)
            {
                return (null);
            ...
            {
                _SafeStr_4436.removeChildContext(_local_2.getGraphicContext(true));
            };
            var _local_4:_SafeStr_3116 = _SafeStr_3116.allocate("WE_CHILD_REMOVED", this, _arg_1);
            update(this, _local_4);
            _local_4.recycle();
            return (_arg_1);
        }

        public function removeChildAt(_arg_1:int):_SafeStr_3109
        {
            return (removeChild(getChildAt(_arg_1)));
        }

        public function setChildIndex(_arg_1:_SafeStr_3109, _arg_2:int):void
        {
            var _local_4:* = null;
            if (!_children)
            {
            ...
            if (((_local_3 > -1) && (!(_arg_2 == _local_3))))
            {
                ...
                {
                    _SafeStr_4436.setChildContextIndex(_local_4.getGraphicContext(true), getChildIndex(_local_4));
                };
            };
        }

        public function swapChildren(_arg_1:_SafeStr_3109, _arg_2:_SafeStr_3109):void
        {
            var _local_3:int;
            var _local_6:int;
            var _local_5:* = null;
            ...
            if ((((!(_arg_1 == null)) && (!(_arg_2 == null))) && (!(_arg_1 == _arg_2))))
            {
                ...
                {
                    _SafeStr_4436.swapChildContexts(WindowController(_arg_1).getGraphicContext(true), WindowController(_arg_2).getGraphicContext(true));
                };
            };
        }
        ...
        public function swapChildrenAt(_arg_1:int, _arg_2:int):void
        {
            ...
            _SafeStr_4436.swapChildContextsAt(_arg_1, _arg_2);
        }
        ...
        public function findParentByName(_arg_1:String):_SafeStr_3109
        {
            if (_name == _arg_1)
            {
                return (this);
        ...
        {
            return (_SafeStr_4447.get(_arg_1).withValue(_arg_2));
        }

        public function getDefaultProperty(_arg_1:String):PropertyStruct
        {
            return (_SafeStr_4447.get(_arg_1));
        }
        ...
        {
            var _local_2:* = null;
            if (_arg_1 != _SafeStr_4439)
            {
                _SafeStr_4439 = _arg_1;
        ...
        protected function immediateClickHandler(_arg_1:Event):void
        {
            ...
            var _local_4:_SafeStr_3116 = WindowMouseEvent.allocate("WME_CLICK", this, null, _local_6.x, _local_6.y, _local_2.stageX, _local_2.stageY, _local_2.altKey, _local_2.ctrlKey, _local_2.shiftKey, _local_2.buttonDown, _local_2.delta);
            if (_SafeStr_3983)
            {
...
// _SafeStr_3161 = "_-E1X" (String#9067, DoABC#4)
...
// _SafeStr_4414 = "_-SP" (String#7779, DoABC#4)
...
// _SafeStr_4435 = "_-P1h" (String#21104, DoABC#4)
// _SafeStr_4436 = "_-Db" (String#1744, DoABC#4)
// _SafeStr_4437 = "_-mM" (String#6108, DoABC#4)
// _SafeStr_4438 = "_-X1e" (String#5564, DoABC#4)
// _SafeStr_4439 = "_-iT" (String#9064, DoABC#4)
// _SafeStr_4440 = "_-I1r" (String#4101, DoABC#4)
// _SafeStr_4441 = "_-WM" (String#14144, DoABC#4)
// _SafeStr_4442 = "_-oa" (String#5538, DoABC#4)
// _SafeStr_4443 = "_-QG" (String#18756, DoABC#4)
// _SafeStr_4444 = "_-iZ" (String#5163, DoABC#4)
// _SafeStr_4445 = "_-wL" (String#9437, DoABC#4)
// _SafeStr_4446 = "_-h1Z" (String#8761, DoABC#4)
