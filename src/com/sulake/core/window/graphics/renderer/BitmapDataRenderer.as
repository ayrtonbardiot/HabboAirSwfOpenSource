...
//com.sulake.core.window.graphics.renderer.BitmapDataRenderer
...
package com.sulake.core.window.graphics.renderer
{
    ...
    public class BitmapDataRenderer extends SkinRenderer 
    {
        ...
        protected static const _SafeStr_5573:ColorTransform = new ColorTransform();
        protected static const _SafeStr_5572:ColorTransform = new ColorTransform(0, 0, 0, 1, 1, 1, 1, 0);
        protected static const _GREYSCALE_FILTER:ColorMatrixFilter = new ColorMatrixFilter();
        protected static const _SafeStr_8231:Number = 0.212671;
        ...
        override public function draw(_arg_1:_SafeStr_3109, _arg_2:BitmapData, _arg_3:Rectangle, _arg_4:uint, _arg_5:Boolean):void
        {
            ...
            var _local_13:int;
            var _local_12:int;
            var _local_6:_SafeStr_3250 = (_arg_1 as _SafeStr_3250);
            ...
            if (((!(_arg_2 == null)) && (!(_local_10 == null))))
            {
                ...
                _SafeStr_5572.alphaMultiplier = (((_local_6.etchingColor >> 24) & 0xFF) / 0xFF);
                _SafeStr_5572.redOffset = ((_local_6.etchingColor >> 16) & 0xFF);
                _SafeStr_5572.greenOffset = ((_local_6.etchingColor >> 8) & 0xFF);
                _SafeStr_5572.blueOffset = (_local_6.etchingColor & 0xFF);
                _arg_2.lock();
                ...
                while (_local_13 < _local_18)
                {
                    ...
                    while (_local_12 < _local_16)
                    {
                        if (_local_6.greyscale)
                        {
                            ...
                            if (_SafeStr_5572.alphaMultiplier >= 0.001)
                            {
                                _MATRIX.tx = (_MATRIX.tx + _local_6.etchingPoint.x);
                                _MATRIX.ty = (_MATRIX.ty + _local_6.etchingPoint.y);
                                _arg_2.draw(_local_10, _MATRIX, _SafeStr_5572, null, null, false);
                                _MATRIX.tx = (_MATRIX.tx - _local_6.etchingPoint.x);
                                _MATRIX.ty = (_MATRIX.ty - _local_6.etchingPoint.y);
                            };
                        ...
                        {
                            _SafeStr_5573.redMultiplier = _local_9;
                            _SafeStr_5573.greenMultiplier = _local_8;
                            _SafeStr_5573.blueMultiplier = _local_7;
                            _SafeStr_5573.alphaMultiplier = 1;
                            _SafeStr_5573.redOffset = 0;
                            _SafeStr_5573.greenOffset = 0;
                            _SafeStr_5573.blueOffset = 0;
                            _SafeStr_5573.alphaOffset = 0;
                            if (_arg_1.dynamicStyleColor)
                            {
                                _SafeStr_5573.concat(_arg_1.dynamicStyleColor);
                            };
                            if (_SafeStr_5572.alphaMultiplier >= 0.001)
                            {
                                _MATRIX.tx = (_MATRIX.tx + _local_6.etchingPoint.x);
                            ...
                            _arg_2.draw(_local_10, _MATRIX, _SafeStr_5573, null, null, false);
                        };
...
// _SafeStr_5572 = "_-Oz" (String#6584, DoABC#4)
// _SafeStr_5573 = "_-NV" (String#5724, DoABC#4)
