...
//com.sulake.core.window.graphics.renderer.SkinRenderer
...
package com.sulake.core.window.graphics.renderer
{
    ...
    public class SkinRenderer implements ISkinRenderer 
    {
        ...
        protected var _SafeStr_5571:Dictionary;
        protected var _layoutsByName:Dictionary;
        protected var _SafeStr_5570:Dictionary;
        ...
        public function SkinRenderer(_arg_1:String)
        {
            ...
            _SafeStr_5571 = new Dictionary();
            _layoutsByName = new Dictionary();
            _SafeStr_5570 = new Dictionary();
        }
        ...
        public function draw(_arg_1:_SafeStr_3109, _arg_2:BitmapData, _arg_3:Rectangle, _arg_4:uint, _arg_5:Boolean):void
        {
        }
        ...
        public function registerTemplateForRenderState(_arg_1:uint, _arg_2:String):void
        {
            ...
            _SafeStr_5571[_arg_1] = _local_3;
        }

        public function removeTemplateFromRenderState(_arg_1:uint):void
        {
            delete _SafeStr_5571[_arg_1]; //not popped
        }
        ...
        public function removeLayout(_arg_1:ISkinLayout):ISkinLayout
        {
            ...
            if (_arg_1 != null)
            {
                for (_local_3 in _SafeStr_5570)
                {
                    _local_2 = (_local_3 as uint);
                    if (_SafeStr_5570[_local_2] == _arg_1)
                    {
        ...
        public function removeTemplate(_arg_1:ISkinTemplate):ISkinTemplate
        {
            ...
            if (_arg_1 != null)
            {
                for (_local_3 in _SafeStr_5571)
                {
                    _local_2 = (_local_3 as uint);
                    if (_SafeStr_5571[_local_2] == _arg_1)
                    {
