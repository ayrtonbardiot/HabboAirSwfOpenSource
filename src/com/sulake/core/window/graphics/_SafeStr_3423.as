...
//com.sulake.core.window.graphics._SafeStr_3423
...
package com.sulake.core.window.graphics
{
    ...
    public class _SafeStr_3423 
    {

        public static const WINDOW_STATE_DEFAULT:String = "default";
        public static const WINDOW_STATE_ACTIVE:String = "active";
        public static const _SafeStr_8161:String = "focused";
        public static const WINDOW_STATE_HOVERING:String = "hovering";
        public static const _SafeStr_8162:String = "selected";
        public static const _SafeStr_8163:String = "pressed";
        public static const _SafeStr_8164:String = "disabled";
        ...
        public static function parseSkinDescription(_arg_1:XML, _arg_2:XMLList, _arg_3:ISkinRenderer, _arg_4:String, _arg_5:_SafeStr_21):void
        {
            ...
            if (_local_12.length() > 0)
            {
                ...
                if (_local_10.length())
                {
                    _SafeStr_3288.parseVariableList(_local_10, _local_6);
                };
            };
        ...
        protected static function parseLayout(_arg_1:ISkinRenderer, _arg_2:XML, _arg_3:Dictionary, _arg_4:_SafeStr_24):void
        {
            var _local_7:* = null;
            var _local_8:* = null;
            var _local_9:* = null;
            _local_7 = _arg_2.attribute("name");
            var _local_10:* = (_arg_2.attribute("transparent") == "true");
        ...
        protected static function parseLayoutList(_arg_1:ISkinRenderer, _arg_2:XML, _arg_3:Dictionary, _arg_4:_SafeStr_24):void
        {
            var _local_6:uint;
            var _local_8:* = null;
        ...
        protected static function parseLayoutEntity(_arg_1:XML, _arg_2:_SafeStr_24):SkinLayoutEntity
        {
            var _local_4:* = null;
            var _local_6:* = null;
            var _local_5:uint;
            ...
            _local_5 = ((_local_3 == null) ? 0 : _local_3);
            ...
            _local_6.color = ((_local_3 == null) ? 0 : _local_3);
            _local_3 = null;
            ...
            _local_6.blend = ((_local_3 == null) ? 0xFFFFFFFF : _local_3);
            ...
            if (_local_8.length() > 0)
            {
                ...
                _local_6.region.x = ((_local_3.charAt(0) == "$") ? _arg_2[_local_3.slice(1, _local_3.length)] : _local_3);
                _local_3 = _local_7.attribute("y");
                _local_6.region.y = ((_local_3.charAt(0) == "$") ? _arg_2[_local_3.slice(1, _local_3.length)] : _local_3);
                _local_3 = _local_7.attribute("width");
                _local_6.region.width = ((_local_3.charAt(0) == "$") ? _arg_2[_local_3.slice(1, _local_3.length)] : _local_3);
                _local_3 = _local_7.attribute("height");
                _local_6.region.height = ((_local_3.charAt(0) == "$") ? _arg_2[_local_3.slice(1, _local_3.length)] : _local_3);
            };
            return (_local_6);
        }

        protected static function parseLayoutEntityList(_arg_1:ISkinRenderer, _arg_2:SkinLayout, _arg_3:XMLList, _arg_4:_SafeStr_24):void
        {
            var _local_7:* = null;
            var _local_6:uint;
        ...
        protected static function parseTemplateEntityList(_arg_1:ISkinRenderer, _arg_2:BitmapSkinTemplate, _arg_3:XMLList, _arg_4:_SafeStr_24):void
        {
            var _local_10:* = null;
            var _local_15:* = null;
            var _local_16:* = null;
            ...
            while (_local_8 < _local_5)
            {
                ...
                _local_13 = ((_local_6.charAt(0) == "$") ? _arg_4[_local_6.slice(1, _local_6.length)] : _local_6);
                ...
                if (_local_15.length() > 0)
                {
                    ...
                    _local_14.x = ((_local_6.charAt(0) == "$") ? _arg_4[_local_6.slice(1, _local_6.length)] : _local_6);
                    _local_6 = _local_16.attribute("y");
                    _local_14.y = ((_local_6.charAt(0) == "$") ? _arg_4[_local_6.slice(1, _local_6.length)] : _local_6);
                    _local_6 = _local_16.attribute("width");
                    _local_14.width = ((_local_6.charAt(0) == "$") ? _arg_4[_local_6.slice(1, _local_6.length)] : _local_6);
                    _local_6 = _local_16.attribute("height");
                    _local_14.height = ((_local_6.charAt(0) == "$") ? _arg_4[_local_6.slice(1, _local_6.length)] : _local_6);
                };
        ...
        protected static function parseState(_arg_1:ISkinRenderer, _arg_2:XML, _arg_3:Dictionary, _arg_4:_SafeStr_24):void
        {
            var _local_6:* = null;
            var _local_7:* = null;
            var _local_10:* = null;
            ...
            if (_local_9.length() > 0)
            {
                ...
                if (_local_7.length())
                {
                    _local_10 = new _SafeStr_24();
                    _SafeStr_3288.parseVariableList(_local_7, _local_10);
        ...
        protected static function parseRenderStateList(_arg_1:ISkinRenderer, _arg_2:XML, _arg_3:Dictionary, _arg_4:_SafeStr_24):void
        {
            var _local_7:uint;
...
// _SafeStr_8161 = "_-c1s" (String#29482, DoABC#4)
// _SafeStr_8162 = "_-31h" (String#30566, DoABC#4)
// _SafeStr_8163 = "_-8Y" (String#30779, DoABC#4)
// _SafeStr_8164 = "_-GR" (String#30227, DoABC#4)
// _SafeStr_8165 = "_-I8" (String#30553, DoABC#4)
