...
//com.sulake.core.window.graphics.WindowRenderer
...
package com.sulake.core.window.graphics
{
    ...
    public class WindowRenderer implements _SafeStr_3119 
    {
        ...
        protected var _SafeStr_4415:Dictionary;
        protected var _SafeStr_4416:Vector.<_SafeStr_3109>;
        protected var _SafeStr_4417:Vector.<Array>;
        ...
        public function WindowRenderer(_arg_1:ISkinContainer)
        {
            ...
            _SafeStr_4415 = new Dictionary(false);
            _SafeStr_4416 = new Vector.<_SafeStr_3109>();
            _SafeStr_4417 = new Vector.<Array>();
        ...
        private static function getDrawLocationAndClipRegion(_arg_1:_SafeStr_3109, _arg_2:Rectangle, _arg_3:Point, _arg_4:Rectangle):Boolean
        {
            var _local_6:int;
        ...
        private static function childRectToClippedDrawRegion(_arg_1:_SafeStr_3109, _arg_2:Point, _arg_3:Rectangle):Boolean
        {
            var _local_4:int;
            var _local_5:int;
            var _local_6:int;
        ...
        public function dispose():void
        {
            ...
            {
                _disposed = true;
                for (var _local_2:Object in _SafeStr_4415)
                {
                    _local_1 = (_SafeStr_4415[_local_2] as WindowRendererItem);
                    _local_1.dispose();
                    delete _SafeStr_4415[_local_2];
                };
                _SafeStr_4415 = null;
                _SafeStr_4416 = null;
                _SafeStr_4417 = null;
        ...
        public function purge(_arg_1:_SafeStr_3109=null, _arg_2:Boolean=true):void
        {
            var _local_3:* = null;
            var _local_5:* = null;
            var _local_4:*;
            if (_arg_1)
            {
                ...
                {
                    _local_3 = _SafeStr_4415[_arg_1];
                    if (_local_3)
                    {
                        _local_3.dispose();
                        delete _SafeStr_4415[_arg_1];
                    };
                    _arg_2 = false;
                };
                _local_5 = (_arg_1 as _SafeStr_3161);
                if (_local_5)
                {
            ...
            {
                _local_4 = new Vector.<_SafeStr_3109>();
                for (var _local_6:Object in _SafeStr_4415)
                {
                    _arg_1 = (_local_6 as _SafeStr_3109);
                    if ((((!(_arg_1.visible)) || (!(_arg_2))) || ((_arg_1.parent == null) && (!(_arg_1 is _SafeStr_3216)))))
                    {
        ...
        public function addToRenderQueue(_arg_1:_SafeStr_3109, _arg_2:Rectangle, _arg_3:uint):void
        {
            var _local_8:int;
            var _local_12:int;
            var _local_4:* = null;
            ...
            if (getWindowRendererItem(_arg_1).invalidate(_arg_1, _arg_3))
            {
                ...
                {
                    var _local_7:_SafeStr_3216 = _arg_1.context.getDesktopWindow();
                    while (true)
                    {
                ...
                _local_10 = _SafeStr_4416.indexOf(_arg_1);
                if (_local_10 > -1)
                {
                    _local_5 = _SafeStr_4417[_local_10];
                ...
                {
                    _SafeStr_4416.push(_arg_1);
                    _SafeStr_4417.push([_dirtyRegion.clone()]);
                };
            };
        }
        ...
        {
            if (((_SafeStr_4416.length) || (_SafeStr_4417.length)))
            {
                _SafeStr_4416.splice(0, _SafeStr_4416.length);
                _SafeStr_4417.splice(0, _SafeStr_4417.length);
            };
        }

        public function invalidate(_arg_1:_SafeStr_3160, _arg_2:Rectangle):void
        {
            var _local_5:* = null;
            var _local_4:* = null;
        ...
        protected function getWindowRendererItem(_arg_1:_SafeStr_3109):WindowRendererItem
        {
            var _local_2:WindowRendererItem = (_SafeStr_4415[_arg_1] as WindowRendererItem);
            if (_local_2 == null)
            {
                registerRenderable(_arg_1);
                _local_2 = _SafeStr_4415[_arg_1];
            };
            return (_local_2);
        }

        public function registerRenderable(_arg_1:_SafeStr_3109):void
        {
            var _local_2:WindowRendererItem = (_SafeStr_4415[_arg_1] as WindowRendererItem);
            if (_local_2 == null)
            {
                _local_2 = new WindowRendererItem(_SafeStr_3722);
                _SafeStr_4415[_arg_1] = _local_2;
                _arg_1.addEventListener("WINDOW_DISPOSE_EVENT", windowDisposedCallback);
            };
        }

        public function removeRenderable(_arg_1:_SafeStr_3109):void
        {
        ...
        public function getDrawBufferForRenderable(_arg_1:_SafeStr_3109):BitmapData
        {
            var _local_2:* = null;
            var _local_4:* = null;
            var _local_3:WindowRendererItem = (_SafeStr_4415[_arg_1] as WindowRendererItem);
            if (!_local_3)
            {
        ...
        public function render():void
        {
            ...
            var _local_4:* = null;
            var _local_5:* = null;
            var _local_3:uint = _SafeStr_4416.length;
            while (_local_3-- > 0)
            {
                _local_5 = _SafeStr_4416.pop();
                _local_2 = _SafeStr_4417.pop();
        ...
        private function renderWindowBranch(_arg_1:_SafeStr_3109, _arg_2:Rectangle, _arg_3:Rectangle, _arg_4:BitmapData):void
        {
            var _local_8:* = null;
            var _local_6:* = null;
            var _local_5:*;
            ...
            if (_arg_1.visible)
            {
                ...
                if (getDrawLocationAndClipRegion(_arg_1, _arg_2, _drawLocation, _clipRegion))
                {
                    ...
                    if (!(_arg_1 is _SafeStr_3161))
                    {
                        return;
                    };
                    _local_5 = _SafeStr_3161(_arg_1).children;
                    if (!_local_5)
                    {
                        return;
                    };
...
// _SafeStr_4415 = "_-PV" (String#4059, DoABC#4)
// _SafeStr_4416 = "_-Ze" (String#6345, DoABC#4)
// _SafeStr_4417 = "_-I1J" (String#6787, DoABC#4)
