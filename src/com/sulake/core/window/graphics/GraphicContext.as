...
//com.sulake.core.window.graphics.GraphicContext
...
package com.sulake.core.window.graphics
{
    ...
    public class GraphicContext extends Sprite implements IGraphicContext 
    {
        ...
        public static const _SafeStr_8232:uint = 0;
        public static const GC_TYPE_BITMAP:uint = 1;
        public static const _SafeStr_8233:uint = 2;
        ...
        public static const _SafeStr_8234:uint = 64;
        public static const _SafeStr_8235:uint = 128;
        public static const _SafeStr_8236:uint = 0x0100;

        protected static var _SafeStr_4002:uint = 0;
        protected static var _SafeStr_5808:uint = 0;

        protected var _SafeStr_5810:DisplayObjectContainer;
        protected var _useAlpha:Boolean;
        protected var _SafeStr_5809:Boolean;
        ...
        {
            return (_SafeStr_4002);
        }

        public static function get allocatedByteCount():uint
        {
            return (_SafeStr_5808);
        }
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (_SafeStr_5810 != null)
                {
                    while (_SafeStr_5810.numChildren > 0)
                    {
                        _SafeStr_5810.removeChildAt(0);
                    };
                };
                _SafeStr_5810 = null;
                while (numChildren > 0)
                ...
                if (_local_3)
                {
                    ...
                    if (_local_4 != null)
                    {
                        if (((!(_local_4.width == _arg_1)) || (!(_local_4.height == _arg_2))))
                        {
                            ...
                            _SafeStr_5808 = (_SafeStr_5808 - ((_local_4.width * _local_4.height) * 4));
                            _local_4.dispose();
                            _local_4 = null;
                        };
                    };
            ...
            if (_SafeStr_5809)
            {
                ...
                if (_local_1)
                {
                    ...
                    if (_local_2 != null)
                    {
                        ...
                        _SafeStr_5808 = (_SafeStr_5808 - ((_local_2.width * _local_2.height) * 4));
                        _local_2.dispose();
                    };
                };
            };
        ...
        protected function setupChildContainer():DisplayObjectContainer
        {
            if (_SafeStr_5810 == null)
            {
                _SafeStr_5810 = new Sprite();
                _SafeStr_5810.name = (this.name + " - Child Container");
                _SafeStr_5810.mouseEnabled = false;
                addChild(_SafeStr_5810);
            };
            return (_SafeStr_5810);
        }
        ...
        {
            return ((_SafeStr_5810 != null) ? _SafeStr_5810.numChildren : 0);
        }
...
// _SafeStr_5808 = "_-B1I" (String#6569, DoABC#4)
// _SafeStr_5809 = "_-G1T" (String#7376, DoABC#4)
// _SafeStr_5810 = "_-R1Q" (String#4076, DoABC#4)
// _SafeStr_8232 = "_-io" (String#32400, DoABC#4)
// _SafeStr_8233 = "_-Y13" (String#35360, DoABC#4)
// _SafeStr_8234 = "_-81E" (String#33395, DoABC#4)
// _SafeStr_8235 = "_-a1t" (String#37307, DoABC#4)
// _SafeStr_8236 = "_-M0" (String#39863, DoABC#4)
