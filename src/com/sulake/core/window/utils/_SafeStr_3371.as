...
//com.sulake.core.window.utils._SafeStr_3371
...
package com.sulake.core.window.utils
{
    ...
    public class _SafeStr_3371 
    {
        ...
        private static var _SafeStr_6346:_SafeStr_24;
        private static var _SafeStr_6347:Array;
        private static var _SafeStr_6345:IEventDispatcher;
        ...
        {
            return (_SafeStr_6345);
        }

        private static function init():void
        {
            var _local_1:* = null;
            _SafeStr_6346 = new _SafeStr_24();
            _SafeStr_6347 = [];
            _SafeStr_6345 = new EventDispatcherWrapper();
            _local_1 = new _SafeStr_3350();
            ...
            _SafeStr_6346[_local_1.name] = _local_1;
            _SafeStr_6347.push(_local_1.name);
            _local_1 = new _SafeStr_3350();
        ...
        public static function getStyle(_arg_1:String):_SafeStr_3350
        {
            return (_SafeStr_6346[_arg_1]);
        }

        public static function getStyleWithIndex(_arg_1:int):_SafeStr_3350
        {
            return (_SafeStr_6346.getWithIndex(_arg_1));
        }

        public static function setStyle(_arg_1:String, _arg_2:_SafeStr_3350):void
        {
            var _local_3:* = (!(_SafeStr_6346.hasKey(_arg_1)));
            _arg_2.name = _arg_1;
            _SafeStr_6346[_arg_1] = _arg_2;
            if (_local_3)
            {
                _SafeStr_6347.push(_arg_1);
                _SafeStr_6345.dispatchEvent(new Event("added"));
            }
            else
            {
                _SafeStr_6345.dispatchEvent(new Event("change"));
            };
        }
        ...
        public static function setStyles(_arg_1:Array, _arg_2:Boolean=false):void
        {
            ...
            if (_arg_2)
            {
                _local_3 = [_SafeStr_6346["regular"], _SafeStr_6346["italic"], _SafeStr_6346["bold"]];
                _SafeStr_6346.reset();
                _SafeStr_6346["regular"] = _local_3[0];
                _SafeStr_6346["italic"] = _local_3[1];
                _SafeStr_6346["bold"] = _local_3[2];
            };
            var _local_4:int = _SafeStr_6346.length;
            for each (var _local_5:_SafeStr_3350 in _arg_1)
            {
                _SafeStr_6346[_local_5.name] = _local_5;
                if (_SafeStr_6347.indexOf(_local_5.name) == -1)
                {
                    _SafeStr_6347.push(_local_5.name);
                };
            };
            _SafeStr_6345.dispatchEvent(new Event("change"));
            if (_SafeStr_6346.length != _local_4)
            {
                _SafeStr_6345.dispatchEvent(new Event("added"));
            };
        }

        public static function findMatchingTextStyle(_arg_1:String):_SafeStr_3350
        {
            var _local_2:* = null;
            var _local_3:_SafeStr_3350 = (parseCSS(_arg_1)[0] as _SafeStr_3350);
            if (_local_3)
            {
                _local_2 = _SafeStr_6346[_local_3.name];
        ...
        public static function enumerateStyles():Array
        {
            var _local_3:int;
            var _local_1:Array = [];
            var _local_2:int = _SafeStr_6346.length;
            _local_3 = 0;
            while (_local_3 < _local_2)
            {
                _local_1.push(_SafeStr_6346.getWithIndex(_local_3));
                _local_3++;
            };
            return (_local_1);
        }
        ...
        public static function toString():String
        {
            ...
            var _local_1:String = "";
            for each (var _local_3:_SafeStr_3350 in _local_2)
            {
...
// _SafeStr_6346 = "_-F1q" (String#3286, DoABC#4)
// _SafeStr_6347 = "_-go" (String#7209, DoABC#4)
