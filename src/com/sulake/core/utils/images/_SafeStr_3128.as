...
//com.sulake.core.utils.images._SafeStr_3128
...
package com.sulake.core.utils.images
{
    ...
    public class _SafeStr_3128 
    {

        private static var _SafeStr_4125:Array;
        private static var _SafeStr_4124:Boolean = false;
        ...
        private static function writeChunk(_arg_1:ByteArray, _arg_2:uint, _arg_3:ByteArray):void
        {
            ...
            if (!_SafeStr_4124)
            {
                ...
                while (_local_10 < 0x0100)
                {
                    ...
                    _SafeStr_4125[_local_10] = _local_5;
                    _local_10++;
                };
            };
            var _local_6:uint;
            ...
            {
                _local_5 = (_SafeStr_4125[((_local_5 ^ _arg_1.readUnsignedByte()) & 0xFF)] ^ (_local_5 >>> 8));
                _local_8++;
            };
...
// _SafeStr_4124 = "_-X1P" (String#17314, DoABC#4)
// _SafeStr_4125 = "_-rp" (String#15380, DoABC#4)
