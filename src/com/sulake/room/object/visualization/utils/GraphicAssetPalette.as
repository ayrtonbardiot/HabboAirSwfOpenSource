...
package com.sulake.room.object.visualization.utils
{
    ...
    public class GraphicAssetPalette 
    {
        ...
        private var _SafeStr_5681:Array = [];
        ...
        public function GraphicAssetPalette(_arg_1:ByteArray, _arg_2:int, _arg_3:int)
        {
            ...
            while (_arg_1.bytesAvailable >= 3)
            {
                ...
                _SafeStr_5681.push(_local_7);
            };
            while (_SafeStr_5681.length < 0x0100)
            {
                _SafeStr_5681.push(0);
            };
        ...
        public function colorizeBitmap(_arg_1:BitmapData):void
        {
            ...
            _arg_1.paletteMap(_arg_1, _arg_1.rect, new Point(0, 0), BLANK, _SafeStr_5681, BLANK, BLANK);
...
// _SafeStr_5681 = "_-u13" (String#8364, DoABC#4)
