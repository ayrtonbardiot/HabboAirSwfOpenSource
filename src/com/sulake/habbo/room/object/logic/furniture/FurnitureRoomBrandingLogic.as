...
package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureRoomBrandingLogic extends _SafeStr_3108 
    {
        ...
        protected var _SafeStr_4704:Boolean;
            ...
            if ((_arg_1 is RoomObjectRoomAdUpdateMessage))
            {
                ...
                switch (_local_2.type)
                {
                    ...
                    case "RORUM_ROOM_BILLBOARD_IMAGE_LOADING_FAILED":
                        ...
                        _SafeStr_14.log(("failed to load billboard image from url " + object.getModelController().getString("furniture_branding_image_url")));
                        return;
                    default:
                        return;
                };
