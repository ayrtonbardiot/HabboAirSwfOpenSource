...
//com.sulake.habbo.room.object.logic.furniture._SafeStr_3108
...
package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class _SafeStr_3108 extends MovingObjectLogic 
    {
        ...
        private var _SafeStr_3988:Number = 0;
        private var _SafeStr_3989:Number = 0;
        private var _SafeStr_3990:Number = 0;
        private var _SafeStr_3991:Number = 0;
        private var _SafeStr_3992:Number = 0;
        private var _SafeStr_3993:Number = 0;
        private var _SafeStr_3994:Boolean = false;
        private var _SafeStr_3995:int = 0;
        ...
        override public function initialize(_arg_1:XML):void
        {
            ...
            {
                _SafeStr_3988 = _local_2;
            };
            _local_2 = _local_10.@y;
            if (_local_2.length() == 1)
            {
                _SafeStr_3989 = _local_2;
            };
            _local_2 = _local_10.@z;
            if (_local_2.length() == 1)
            {
                _SafeStr_3990 = _local_2;
            };
            _SafeStr_3991 = (_SafeStr_3988 / 2);
            _SafeStr_3992 = (_SafeStr_3989 / 2);
            _local_2 = _local_10.@centerZ;
            if (_local_2.length() == 1)
            {
                _SafeStr_3993 = _local_2;
            }
            else
            {
                _SafeStr_3993 = (_SafeStr_3990 / 2);
            };
            ...
            while (_local_6 < _local_4.length())
            {
                ...
                if (_SafeStr_1675.checkRequiredAttributes(_local_11, _local_5))
                {
            ...
            object.getModelController().setNumber("furniture_size_x", _SafeStr_3988, true);
            object.getModelController().setNumber("furniture_size_y", _SafeStr_3989, true);
            if (!object.getModelController().hasNumber("furniture_size_z"))
            {
                object.getModelController().setNumber("furniture_size_z", _SafeStr_3990);
            };
            object.getModelController().setNumber("furniture_center_x", _SafeStr_3991, true);
            object.getModelController().setNumber("furniture_center_y", _SafeStr_3992, true);
            object.getModelController().setNumber("furniture_center_z", _SafeStr_3993, true);
        ...
        private function handleDataUpdateMessage(_arg_1:RoomObjectDataUpdateMessage):void
        {
            ...
            if (_local_2 != null)
            {
                ...
                {
                    _local_2.setString("furniture_extras", _arg_1.extra);
                };
        ...
        override public function processUpdateMessage(_arg_1:RoomObjectUpdateMessage):void
        {
            ...
            if (((!(_arg_1.dir == null)) && (!(_arg_1.loc == null))))
            {
                if (!(_arg_1 is RoomObjectMoveUpdateMessage))
                {
                    ...
                    if ((((((((!(_local_5 == null)) && (!(_local_5.x == _arg_1.dir.x))) && (_SafeStr_3994)) && (!(_local_2 == null))) && (_local_2.x == _arg_1.loc.x)) && (_local_2.y == _arg_1.loc.y)) && (_local_2.z == _arg_1.loc.z)))
                    {
                        _SafeStr_3995 = 1;
        ...
        override protected function getLocationOffset():IVector3d
        {
            if (_SafeStr_3995 > 0)
            {
                _locationOffset.x = 0;
                _locationOffset.y = 0;
                if (_SafeStr_3995 <= (8 / 2))
                {
                    _locationOffset.z = (0.0625 * _SafeStr_3995);
                }
                else
                {
                    if (_SafeStr_3995 <= 8)
                    {
                        ...
                        _locationOffset.z = (0.0625 * (8 - _SafeStr_3995));
                    };
                };
...
// _SafeStr_3993 = "_-OH" (String#13224, DoABC#4)
// _SafeStr_3994 = "_-ou" (String#12687, DoABC#4)
// _SafeStr_3995 = "_-p1h" (String#5036, DoABC#4)
