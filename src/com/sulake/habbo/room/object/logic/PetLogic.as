...
package com.sulake.habbo.room.object.logic
{
    ...
    public class PetLogic extends MovingObjectLogic 
    {
        ...
        private var _SafeStr_5088:int = 0;
        private var _selected:Boolean = false;
        private var _SafeStr_4922:Vector3d = null;
        private var _SafeStr_5084:Boolean = false;
        private var _SafeStr_5086:int = 0;
        private var _SafeStr_5087:int = 0;
        private var _headDirectionDelta:int = 0;
        private var _SafeStr_5085:int = 0;
        ...
        override public function initialize(_arg_1:XML):void
        {
            ...
            while (_local_4 < _local_2.length())
            {
                ...
                if (_SafeStr_1675.checkRequiredAttributes(_local_6, _local_3))
                {
        ...
        override public function processUpdateMessage(_arg_1:RoomObjectUpdateMessage):void
        {
            ...
            if (!_SafeStr_5084)
            {
                ...
                if ((_arg_1 is RoomObjectAvatarChatUpdateMessage))
                {
                    ...
                    _SafeStr_4923 = (getTimer() + (_local_10.numberOfWords * 1000));
                    return;
                };
                ...
                if ((_arg_1 is RoomObjectAvatarSleepUpdateMessage))
                {
                    ...
                    _local_7.setNumber("figure_sleep", _local_6.isSleeping);
                    return;
                };
            };
        ...
        private function debugMouseEvent(_arg_1:RoomSpriteMouseEvent):void
        {
            ...
            else
            {
                ...
                {
                    _SafeStr_5086++;
                    _local_2.setNumber("figure_posture", _SafeStr_5086);
                ...
                else
                {
                    ...
                    {
                        _SafeStr_5087++;
                        _local_2.setNumber("figure_gesture", _SafeStr_5087);
                    }
                    else
                    {
        ...
        private function updateActions(_arg_1:int, _arg_2:IRoomObjectModelController):void
        {
            ...
            if (((_SafeStr_5088 > 0) && (_arg_1 > _SafeStr_5088)))
            {
...
// _SafeStr_5084 = "_-y1s" (String#19809, DoABC#4)
// _SafeStr_5085 = "_-d1P" (String#10176, DoABC#4)
// _SafeStr_5086 = "_-ww" (String#15012, DoABC#4)
// _SafeStr_5087 = "_-61S" (String#14352, DoABC#4)
// _SafeStr_5088 = "_-3i" (String#14978, DoABC#4)
