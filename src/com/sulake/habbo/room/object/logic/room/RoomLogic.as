...
package com.sulake.habbo.room.object.logic.room
{
    ...
    public class RoomLogic extends ObjectLogicBase 
    {
        ...
        override public function initialize(_arg_1:XML):void
        {
            ...
            if (!_SafeStr_4111.initializeFromXML(_arg_1))
            {
                return;
            };
        ...
        private function updateBackgroundColor(_arg_1:int):void
        {
            ...
            if (_colorChangedTime)
            {
                ...
                else
                {
                    ...
                    _local_9 = (_SafeStr_5251 + ((_SafeStr_5250 - _SafeStr_5251) * _local_13));
                    _color = _local_5;
                    _SafeStr_5116 = _local_9;
                };
        ...
        private function updatePlaneMasks(_arg_1:RoomObjectRoomMaskUpdateMessage, _arg_2:IRoomObjectModelController):void
        {
            ...
            switch (_arg_1.type)
            {
                case "RORMUM_ADD_MASK":
                    ...
                    _SafeStr_4966.addMask(_arg_1.maskId, _arg_1.maskType, _arg_1.maskLocation, _local_7);
                    _local_3 = true;
                    break;
                case "RORMUM_ADD_MASK":
                    _local_3 = _SafeStr_4966.removeMask(_arg_1.maskId);
            };
            if (_local_3)
            {
                _local_6 = _SafeStr_4966.getXML();
        ...
        private function updateFloorHoles(_arg_1:RoomObjectRoomFloorHoleUpdateMessage, _arg_2:IRoomObjectModelController):void
        {
            ...
            {
                case "RORPFHUM_ADD":
                    _SafeStr_4111.addFloorHole(_arg_1.id, _arg_1.x, _arg_1.y, _arg_1.width, _arg_1.height);
                    _SafeStr_5249 = true;
                    return;
                case "RORPFHUM_REMOVE":
                    _SafeStr_4111.removeFloorHole(_arg_1.id);
                    _SafeStr_5249 = true;
                    return;
            };
        }
        ...
        private function updateColors(_arg_1:RoomObjectRoomColorUpdateMessage, _arg_2:IRoomObjectModelController):void
        {
            ...
            _arg_2.setNumber("room_colorize_bg_only", _arg_1.bgOnly);
            _originalColor = _color;
            _SafeStr_5251 = _SafeStr_5116;
            _targetColor = _local_3;
            _SafeStr_5250 = _local_4;
        ...
        override public function mouseEvent(_arg_1:RoomSpriteMouseEvent, _arg_2:IRoomGeometry):void
        {
            ...
            if (((_local_10 < 1) || (_local_10 > _SafeStr_4111.planeCount)))
            {
            ...
            var _local_15:Point;
            var _local_4:IVector3d = _SafeStr_4111.getPlaneLocation(_local_10);
            var _local_8:IVector3d = _SafeStr_4111.getPlaneLeftSide(_local_10);
            var _local_19:IVector3d = _SafeStr_4111.getPlaneRightSide(_local_10);
            var _local_25:IVector3d = _SafeStr_4111.getPlaneNormalDirection(_local_10);
            var _local_21:int = _SafeStr_4111.getPlaneType(_local_10);
...
// _SafeStr_5249 = "_-7I" (String#8780, DoABC#4)
// _SafeStr_5250 = "_-x1O" (String#14922, DoABC#4)
// _SafeStr_5251 = "_-KD" (String#14445, DoABC#4)
