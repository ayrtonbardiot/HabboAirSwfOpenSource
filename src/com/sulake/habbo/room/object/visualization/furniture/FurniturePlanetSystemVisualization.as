...
package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization 
    {
        ...
        private var _SafeStr_4860:Array;
        private var _SafeStr_4861:Array;
        ...
        {
            var _local_1:* = null;
            if (_SafeStr_4860 != null)
            {
                while (_SafeStr_4860.length > 0)
                {
                    _local_1 = _SafeStr_4860.shift();
                    _local_1.dispose();
                };
            };
            _SafeStr_4860 = null;
        ...
        override protected function updateAnimation(_arg_1:Number):int
        {
            var _local_2:* = null;
            var _local_3:int;
            if (((_SafeStr_4860 == null) && (spriteCount > 0)))
            {
                if (!readDefinition())
                {
                    return (0);
            ...
            {
                _local_3 = 0;
                while (_local_3 < _SafeStr_4860.length)
                {
                    _local_2 = _SafeStr_4860[_local_3];
        ...
        private function addPlanet(_arg_1:String, _arg_2:int, _arg_3:String, _arg_4:Number, _arg_5:Number, _arg_6:Number, _arg_7:Number):void
        {
            ...
            {
                _SafeStr_4860.push(_local_9);
                _SafeStr_4861.push(_arg_1);
            };
        }
...
// _SafeStr_4860 = "_-u1L" (String#4825, DoABC#4)
// _SafeStr_4861 = "_-T13" (String#12032, DoABC#4)
