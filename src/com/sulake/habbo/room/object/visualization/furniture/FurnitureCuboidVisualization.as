    ...
    public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization 
    {
        ...
        override public function dispose():void
        {
            ...
            if (_SafeStr_4565 != null)
            {
                ...
                {
                    _local_1 = (_SafeStr_4565[_local_2] as FurniturePlane);
                    if (_local_1 != null)
                    {
                        _local_1.dispose();
                    };
        ...
        override public function update(_arg_1:IRoomGeometry, _arg_2:int, _arg_3:Boolean, _arg_4:Boolean):void
        {
            ...
            if (_SafeStr_3745 == null)
            {
                _SafeStr_3745 = new AssetLibrary(("furniture cuboid visualization - " + _local_5.getInstanceId()));
            };
            if (_arg_1 == null)
            {
                return;
        ...
        protected function updatePlanes(_arg_1:IRoomGeometry, _arg_2:int):void
        {
            ...
            if (((_arg_1 == null) || (_SafeStr_3745 == null)))
            {
                return;
            };
            _SafeStr_4567++;
            var _local_4:* = _arg_2;
            _local_6 = 0;
            while (_local_6 < _SafeStr_4565.length)
            {
                _local_7 = false;
                _local_13 = ((("plane " + _local_6) + " ") + _arg_1.scale);
                _local_14 = (_SafeStr_3745.getAssetByName(_local_13) as BitmapDataAsset);
                if (_local_14 == null)
                {
                    _local_14 = new BitmapDataAsset(_SafeStr_3745.getAssetTypeDeclarationByClass(BitmapDataAsset));
                    _SafeStr_3745.setAsset(_local_13, _local_14);
                };
                _local_3 = (_SafeStr_4565[_local_6] as FurniturePlane);
                if (_local_3 != null)
                {
                ...
                if (_local_12 != null)
                {
                    ...
                    if (_local_7)
                    {
                        _local_12.assetName = ((((_local_13 + "_") + _local_10.getInstanceId()) + "_") + _SafeStr_4567);
                    };
