...
package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureBuilderPlaceholderVisualization extends FurnitureVisualization 
    {
        ...
        private var _SafeStr_3988:int = -1;
        private var _SafeStr_3989:int = -1;
        ...
        override protected function updateModel(_arg_1:Number):Boolean
        {
            ...
            if (((!(_local_2 == _SafeStr_3988)) || (!(_local_5 == _SafeStr_3989))))
            {
                _SafeStr_3988 = _local_2;
                _SafeStr_3989 = _local_5;
        ...
        private function instantiateSprites(_arg_1:Number):void
        {
            ...
            createSprites(((data.getLayerCount(_arg_1) * _SafeStr_3988) * _SafeStr_3989));
        ...
        override protected function updateLayerCount(_arg_1:int):void
        {
            ...
            if ((_SafeStr_3988 * _SafeStr_3989) > 1)
            {
                _SafeStr_4169 = (_SafeStr_4169 * (_SafeStr_3988 * _SafeStr_3989));
            };
        }
        ...
        override protected function getSpriteXOffset(_arg_1:int, _arg_2:int, _arg_3:int):int
        {
            ...
            var _local_6:int = (_local_4 % _SafeStr_3989);
            var _local_7:int = int((_local_4 / _SafeStr_3989));
