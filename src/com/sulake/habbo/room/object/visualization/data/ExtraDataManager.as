...
//com.sulake.habbo.room.object.visualization.data.ExtraDataManager
    ...
    public class ExtraDataManager 
    {
        ...
        private function onExtraDataLoaded(_arg_1:Event):void
        {
            ...
            if (((_local_4) && (_local_4.length > 0)))
            {
                ...
                {
                    _SafeStr_14.log("Failed to read JSON from ExtraData service");
                };
            };
        }
        ...
        {
            _SafeStr_14.log(("Failed to load ExtraData batch " + _arg_1.toString()));
        }
