...
package com.sulake.habbo.room.object.visualization.data
{
    public class DirectionData 
    {
        ...
        private function getLayer(_arg_1:int):_SafeStr_3378
        {
        ...
        {
            var _local_2:_SafeStr_3378 = getLayer(_arg_1);
            if (_local_2 != null)
            {
                return (_local_2.tag);
            };
        ...
        {
            var _local_3:_SafeStr_3378 = getLayer(_arg_1);
            if (_local_3 != null)
            {
                _local_3.tag = _arg_2;
            };
        ...
        public function copyValues(_arg_1:DirectionData):void
        {
            ...
            var _local_4:_SafeStr_3378;
            var _local_2:_SafeStr_3378;
            _local_3 = 0;
