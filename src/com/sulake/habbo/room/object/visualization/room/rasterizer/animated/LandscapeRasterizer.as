...
package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
    ...
    public class LandscapeRasterizer extends PlaneRasterizer 
    {
        ...
        private var _SafeStr_8763:int = 0;
        ...
        private function parseLandscapes(_arg_1:XML):void
        {
            ...
            while (_local_23 < _local_15.length())
            {
                ...
                if (_SafeStr_1675.checkRequiredAttributes(_local_29, ["id"]))
                {
                    _local_14 = _local_29.@id;
                    _local_11 = _local_29.animatedVisualization;
                    _local_38 = new _SafeStr_3455();
                    _local_24 = 0;
                    while (_local_24 < _local_11.length())
                    {
                        _local_26 = _local_11[_local_24];
                        if (_SafeStr_1675.checkRequiredAttributes(_local_26, ["size"]))
                        {
                            ...
                            if (_local_22 != null)
                            {
                                ...
                                while (_local_25 < _local_26.children().length())
                                {
                                    ...
                                    if (_local_39.name() == "visualizationLayer")
                                    {
                                        ...
                                        _local_33 = null;
                                        _local_7 = 1;
                                        if (_SafeStr_1675.checkRequiredAttributes(_local_8, ["materialId"]))
                                        {
                                    ...
                                    else
                                    {
                                        if (_local_39.name() == "animationLayer")
                                        {
                                            ...
                                            while (_local_28 < _local_37.length())
                                            {
                                                ...
                                                if (_local_16 != null)
                                                {
                                                    if (_SafeStr_1675.checkRequiredAttributes(_local_16, _local_5))
                                                    {
        ...
        {
            var _local_15:_SafeStr_3455 = (getPlane(_arg_2) as _SafeStr_3455);
            if (_local_15 == null)
            {
                _local_15 = (getPlane("default") as _SafeStr_3455);
            };
            if (_local_15 == null)
            {
                return (null);
...
// _SafeStr_3455 = "_-Ov" (String#7245, DoABC#4)
// _SafeStr_8763 = "_-D2" (String#23623, DoABC#4)
