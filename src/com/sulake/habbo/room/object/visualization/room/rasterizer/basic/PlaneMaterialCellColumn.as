...
package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class PlaneMaterialCellColumn 
    {
        ...
        private var _SafeStr_6727:int;
        private var _SafeStr_6728:int;
        ...
        public function render(_arg_1:int, _arg_2:IVector3d, _arg_3:int, _arg_4:int):BitmapData
        {
            ...
            if (isStatic)
            {
                if (_SafeStr_6597 != null)
                {
                    if (((((_SafeStr_6597.height == _arg_1) && (Vector3d.isEqual(_cachedBitmapNormal, _arg_2))) && (_SafeStr_6727 == _arg_3)) && (_SafeStr_6728 == _arg_4)))
                    {
            ...
            else
            {
                if (_SafeStr_6597 != null)
                {
                    if (_SafeStr_6597.height == _arg_1)
                    {
            ...
            if (_SafeStr_6597 == null)
            {
                try
                {
                    _SafeStr_6597 = new BitmapData(_width, _arg_1, true, 0xFFFFFF);
                }
                catch(e:Error)
                {
                    return (null);
            ...
            _SafeStr_6727 = _arg_3;
            _SafeStr_6728 = _arg_4;
            if (_cells.length == 0)
            {
                return (_SafeStr_6597);
            };
        ...
        {
            var _local_8:int;
            if ((((_arg_1 == null) || (_arg_1.length == 0)) || (_SafeStr_6597 == null)))
            {
                return (_arg_2);
            };
            ...
            while (_local_8 < _arg_1.length)
            {
                ...
                if (_local_9 != null)
                {
                    ...
                    if (_local_7 != null)
                    {
                        ...
                        _SafeStr_6597.copyPixels(_local_7, _local_7.rect, new Point(0, _arg_2), _local_7, null, true);
                        if (_arg_3)
                        {
                            _arg_2 = (_arg_2 + _local_7.height);
                        };
                        if ((((_arg_3) && (_arg_2 >= _SafeStr_6597.height)) || ((!(_arg_3)) && (_arg_2 <= 0))))
                        {
                            return (_arg_2);
                        };
                    };
        ...
        {
            if (((_cells.length == 0) || (_SafeStr_6597 == null)))
            {
                return;
            };
        ...
        private function renderRepeatAll(_arg_1:IVector3d, _arg_2:int, _arg_3:int):void
        {
            ...
            var _local_4:int;
            if (_local_5 > _SafeStr_6597.height)
            {
            };
            while (_local_4 < _SafeStr_6597.height)
            {
        ...
        private function renderRepeatBorders(_arg_1:IVector3d):void
        {
            ...
            var _local_4:* = ((_SafeStr_6597.height - _local_2) >> 1);
            ...
            {
                _local_3 = [_local_8];
                while (_local_7 < _SafeStr_6597.height)
                {
        ...
        private function renderRepeatCenter(_arg_1:IVector3d):void
        {
            ...
            var _local_13:int;
            var _local_2:int;
            var _local_15:int = _SafeStr_6597.height;
            if ((_local_10 + _local_12) > _SafeStr_6597.height)
            {
                _local_13 = ((_local_10 + _local_12) - _SafeStr_6597.height);
            ...
            if (_local_13 == 0)
            {
                ...
                if (_local_5 != null)
                {
                    ...
                    if (_local_16 > 0)
                    {
                        _local_7 = (_SafeStr_6597.height - (_local_10 + _local_12));
        ...
        private function renderRepeatFirst(_arg_1:IVector3d):void
        {
            ...
            var _local_3:int = _SafeStr_6597.height;
        ...
        private function renderRepeatLast(_arg_1:IVector3d):void
        {
            ...
            {
                _local_2 = [_local_4];
                while (_local_3 < _SafeStr_6597.height)
                {
...
// _SafeStr_6727 = "_-X1c" (String#17040, DoABC#4)
// _SafeStr_6728 = "_-fX" (String#19143, DoABC#4)
