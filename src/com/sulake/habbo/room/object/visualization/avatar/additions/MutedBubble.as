...
package com.sulake.habbo.room.object.visualization.avatar.additions
{
    ...
    public class MutedBubble implements IAvatarAddition 
    {
        ...
        public function update(_arg_1:IRoomObjectSprite, _arg_2:Number):void
        {
            ...
            if (_arg_2 < 48)
            {
                _asset = (_SafeStr_5586.getAvatarRendererAsset("user_muted_small_png") as BitmapDataAsset);
                _local_3 = -12;
                _local_4 = -66;
                _local_5 = 32;
            }
            ...
            {
                _asset = (_SafeStr_5586.getAvatarRendererAsset("user_muted_png") as BitmapDataAsset);
                _local_3 = -15;
                _local_4 = -110;
            };
