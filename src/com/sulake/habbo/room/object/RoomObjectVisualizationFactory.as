...
package com.sulake.habbo.room.object
{
    ...
    public class RoomObjectVisualizationFactory extends _SafeStr_20 implements IRoomObjectVisualizationFactory 
    {
        ...
        public function RoomObjectVisualizationFactory(_arg_1:_SafeStr_31, _arg_2:uint=0, _arg_3:_SafeStr_21=null)
        {
            ...
            _SafeStr_3837 = new _SafeStr_24();
        }

        override protected function get dependencies():Vector.<ComponentDependency>
        {
            return (super.dependencies.concat(new <ComponentDependency>[new ComponentDependency(new IIDAvatarRenderManager(), function (_arg_1:_SafeStr_1701):void
            {
                _habboAvatar = _arg_1;
            }, false)]));
        }
        ...
        override public function dispose():void
        {
            ...
            if (_SafeStr_3837 != null)
            {
                _local_1 = null;
                _local_2 = 0;
                while (_local_2 < _SafeStr_3837.length)
                {
                    _local_1 = (_SafeStr_3837.getWithIndex(_local_2) as IRoomObjectVisualizationData);
                    if (_local_1 != null)
                    {
                        _local_1.dispose();
                    };
        ...
        public function getRoomObjectVisualizationData(_arg_1:String, _arg_2:String, _arg_3:XML):IRoomObjectVisualizationData
        {
            ...
            _local_4 = (_SafeStr_3837.getValue(_arg_1) as IRoomObjectVisualizationData);
            if (_local_4 != null)
            {
                return (_local_4);
            };
            ...
            if (_local_4 != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if ((_local_7 is _SafeStr_3231))
                            {
                                _SafeStr_3231(_local_7).assets = assets;
                            };
                        };
                    };
                };
                if (_SafeStr_3838)
                {
                    _SafeStr_3837.add(_arg_1, _local_7);
                };
                return (_local_7);
            };
            return (null);
...
// _SafeStr_3837 = "_-31" (String#6674, DoABC#4)
// _SafeStr_3838 = "_-w8" (String#18447, DoABC#4)
