...
package com.sulake.habbo.room
{
    ...
    public class _SafeStr_3180 implements IRoomRenderingCanvasMouseListener 
    {

        private var _roomEngine:_SafeStr_1689 = null;
        private var _SafeStr_4639:_SafeStr_24 = null;
        private var _SafeStr_4643:int = -1;
        private var _SafeStr_4640:int = -1;
        private var _SafeStr_4641:int = -2;
        private var _SafeStr_4642:Boolean = true;
        private var _SafeStr_4644:String;

        public function _SafeStr_3180(_arg_1:_SafeStr_1689)
        {
            _SafeStr_4639 = new _SafeStr_24();
            _roomEngine = _arg_1;
        }

        protected function get roomEngine():_SafeStr_1689
        {
            return (_roomEngine);
        }
        ...
        {
            if (_SafeStr_4639 != null)
            {
                _SafeStr_4639.dispose();
                _SafeStr_4639 = null;
            };
            _roomEngine = null;
        }
        ...
        private function getSelectedObjectData(_arg_1:int):_SafeStr_3172
        {
            if (_roomEngine == null)
            {
                return (null);
            ...
            return (_local_2 as _SafeStr_3172);
        }
        ...
        private function setSelectedObjectData(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:IVector3d, _arg_5:IVector3d, _arg_6:String, _arg_7:int=0, _arg_8:String=null, _arg_9:IStuffData=null, _arg_10:int=-1, _arg_11:int=-1, _arg_12:String=null):void
        {
            ...
            var _local_13:_SafeStr_3172 = new _SafeStr_3172(_arg_2, _arg_3, _arg_6, _arg_4, _arg_5, _arg_7, _arg_8, _arg_9, _arg_10, _arg_11, _arg_12);
        ...
        private function resetSelectedObjectData(_arg_1:int):void
        {
            ...
            var _local_2:_SafeStr_3172 = getSelectedObjectData(_arg_1);
            if (_local_2 != null)
            {
                    ...
                    else
                    {
                        ...
                        if (_arg_2 != _SafeStr_4640)
                        {
                            ...
                            if (((!(_local_5 == null)) && (!(_local_5.getEventHandler() == null))))
                            {
                                ...
                                _SafeStr_4640 = _arg_2;
                                _SafeStr_4641 = _arg_3;
                            };
                        };
                    };
        ...
        private function deselectObject(_arg_1:int):void
        {
            ...
            if (_SafeStr_4640 != -1)
            {
                _local_2 = (_roomEngine.getRoomObject(_arg_1, _SafeStr_4640, _SafeStr_4641) as IRoomObjectController);
        ...
        public function handleRoomObjectEvent(_arg_1:RoomObjectEvent, _arg_2:int):void
        {
            ...
            switch (_arg_1.type)
            {
                ...
                case "RODRE_URL_PREFIX":
                    ...
                    return;
                default:
                    _SafeStr_14.log("*** Unhandled room object event in RoomObjectEventHandler::handleRoomObjectEvent !!! ***");
                    return;
            };
        }
        ...
        {
            var _local_4:_SafeStr_24 = (_SafeStr_4639.getValue(String(_arg_1)) as _SafeStr_24);
            if (_local_4 == null)
            {
                _local_4 = new _SafeStr_24();
                _SafeStr_4639.add(_arg_1, _local_4);
            };
        ...
        private function handleRoomObjectMouseClick(_arg_1:RoomObjectMouseEvent, _arg_2:int):void
        {
            ...
            var _local_8:_SafeStr_3172 = getSelectedObjectData(_arg_2);
            if (_local_8 != null)
            {
        ...
        private function handleRoomObjectMouseMove(_arg_1:RoomObjectMouseEvent, _arg_2:int):void
        {
            ...
            var _local_4:_SafeStr_3172 = getSelectedObjectData(_arg_2);
            if (_local_4 != null)
            {
        ...
        private function handleObjectPlace(_arg_1:RoomObjectMouseEvent, _arg_2:int):void
        {
            ...
            var _local_6:_SafeStr_3172 = getSelectedObjectData(_arg_2);
            if (_local_6 == null)
            {
                return;
            };
            ...
            if (_local_8 == null)
            {
                ...
                {
                    _roomEngine.addObjectFurniture(_arg_2, _local_6.id, _local_6.typeId, _local_6.loc, _local_6.dir, 0, _local_6.stuffData, _local_6.instanceData, -1, 0, 0, "", false);
                }
                else
                {
        ...
        private function getActiveSurfaceLocation(_arg_1:IRoomObject, _arg_2:RoomObjectMouseEvent):Vector3d
        {
            ...
            var _local_18:_SafeStr_3130 = _roomEngine.sessionDataManager.getFloorItemDataByName(_arg_1.getType());
            if (_local_18 == null)
            {
                return (null);
            };
            ...
            if (_local_8 != null)
            {
                switch (_arg_1.type)
                {
                    ...
                    case "ROWRE_GUILD_FURNI_CONTEXT_MENU":
                        ...
                        _roomEngine.connection.send(new _SafeStr_906(_arg_1.objectId, _local_6));
                        return;
                    case "ROWRE_MONSTERPLANT_SEED_PLANT_CONFIRMATION_DIALOG":
                    ...
                    case "ROWRE_MYSTERYTROPHY_OPEN_DIALOG":
                        ...
                        return;
                    case "ROWRE_ACHIEVEMENT_RESOLUTION_OPEN":
                        _roomEngine.connection.send(new _SafeStr_645(_arg_1.objectId, 0));
                        return;
                    case "ROWRE_ACHIEVEMENT_RESOLUTION_ENGRAVING":
        ...
        private function handleFurnitureMove(_arg_1:IRoomObjectController, _arg_2:_SafeStr_3172, _arg_3:int, _arg_4:int, _arg_5:_SafeStr_3178):Boolean
        {
            if (((_arg_1 == null) || (_arg_2 == null)))
            {
                return (false);
        ...
        private function handleWallItemMove(_arg_1:IRoomObjectController, _arg_2:_SafeStr_3172, _arg_3:IVector3d, _arg_4:IVector3d, _arg_5:IVector3d, _arg_6:Number, _arg_7:Number, _arg_8:Number):Boolean
        {
            if (((_arg_1 == null) || (_arg_2 == null)))
            {
                return (false);
        ...
        private function handleUserPlace(_arg_1:IRoomObjectController, _arg_2:int, _arg_3:int, _arg_4:_SafeStr_3137):Boolean
        {
        ...
        private function validateFurnitureDirection(_arg_1:IRoomObject, _arg_2:IVector3d, _arg_3:_SafeStr_3178):Boolean
        {
        ...
        private function validateFurnitureLocation(_arg_1:IRoomObject, _arg_2:IVector3d, _arg_3:IVector3d, _arg_4:IVector3d, _arg_5:_SafeStr_3178):Vector3d
        {
            var _local_16:* = null;
        ...
        private function validateWallItemLocation(_arg_1:IRoomObject, _arg_2:IVector3d, _arg_3:IVector3d, _arg_4:IVector3d, _arg_5:Number, _arg_6:Number, _arg_7:_SafeStr_3172):Vector3d
        {
        ...
        public function setSelectedAvatar(_arg_1:int, _arg_2:int, _arg_3:Boolean):void
        {
            ...
            var _local_7:IRoomObjectController = (_roomEngine.getRoomObject(_arg_1, _SafeStr_4643, _local_6) as IRoomObjectController);
            if (((!(_local_7 == null)) && (!(_local_7.getEventHandler() == null))))
            {
            ...
            if (_arg_3)
            {
                ...
                if (((!(_local_7 == null)) && (!(_local_7.getEventHandler() == null))))
                {
                    ...
                    _local_4 = true;
                    _SafeStr_4643 = _arg_2;
                    try
                    {
                        _roomEngine.connection.send(new _SafeStr_620(_local_7.getLocation().x, _local_7.getLocation().y));
                    }
                    catch(e:Error)
                    {
                    };
        ...
        public function modifyRoomObjectData(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:String, _arg_5:_SafeStr_24):Boolean
        {
            if (_roomEngine == null)
            {
                return (false);
            ...
            switch (_arg_4)
            {
                case "OBJECT_SAVE_STUFF_DATA":
                    ...
                    {
                        _roomEngine.connection.send(new _SafeStr_624(_arg_2, _arg_5));
                    };
                    break;
                default:
                    _SafeStr_14.log(("could not modify room object data, unknown operation " + _arg_4));
            };
            return (true);
        }
        ...
        public function modifyRoomObject(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:String):Boolean
        {
            ...
            switch (_arg_4)
            {
                        ...
                        if (validateFurnitureDirection(_local_13, new Vector3d(_local_14), _roomEngine.getFurniStackingHeightMap(_arg_1)))
                        {
                            ...
                            if (_local_13.getType() == "monsterplant")
                            {
                                ...
                                if (_local_15 != null)
                                {
                                    ...
                                    if (_local_5 != null)
                                    {
                                        _roomEngine.connection.send(new _SafeStr_430(_local_5.webID, _local_8, _local_10, _local_14));
                                    };
                                };
                            }
                            else
                            {
                                _roomEngine.connection.send(new _SafeStr_583(_arg_2, _local_8, _local_10, _local_14));
                            };
                        };
                    };
                    break;
                ...
                case "OBJECT_PICKUP":
                    if (_roomEngine.connection)
                    {
                        _roomEngine.connection.send(new _SafeStr_211(_arg_2, _arg_3));
                    };
                    break;
                ...
                case "OBJECT_PICKUP_BOT":
                    if (_roomEngine.connection)
                    {
                        ...
                        if (_local_15 != null)
                        {
                            ...
                            if (_local_5 != null)
                            {
                                _roomEngine.connection.send(new _SafeStr_282(_local_5.webID));
                            };
                        };
                    };
                    break;
                                ...
                                if (_arg_3 == 20)
                                {
                                    ...
                                    if (((_roomEngine.connection) && (_local_12)))
                                    {
                                        ...
                                        if (_local_9 != null)
                                        {
                                            ...
                                            _roomEngine.connection.send(new _SafeStr_741(_arg_2, 20, _local_9));
                                        };
                                    };
                                };
                            };
        ...
        {
            var _local_4:_SafeStr_3172 = getSelectedObjectData(_arg_1);
            if (_local_4 == null)
            {
                return;
            };
        ...
        private function placeObject(_arg_1:int, _arg_2:Boolean, _arg_3:Boolean):void
        {
            ...
            var _local_16:* = null;
            var _local_9:Boolean;
            var _local_5:_SafeStr_3172 = getSelectedObjectData(_arg_1);
            if (_local_5 == null)
            {
                return;
            };
            ...
            if (((!(_roomEngine == null)) && (!(_roomEngine.connection == null))))
            {
                ...
                if (_local_6 != null)
                {
                    ...
                    if ((((_roomEngine.catalog == null) || (_roomEngine.catalog.catalogType == "NORMAL")) || (!(_SafeStr_4644 == "catalog"))))
                    {
                        if (((_local_15 == 100) && (_local_5.typeId == 2)))
                        {
                            _roomEngine.connection.send(new _SafeStr_712(_local_14, _local_10, _local_12));
                        }
                        else
                        {
                            if (((_local_15 == 100) && (_local_5.typeId == 4)))
                            {
                                _roomEngine.connection.send(new _SafeStr_1031(_local_14, _local_10, _local_12));
                            }
                            else
                            {
                                if (_local_6.getModelController().getString("furniture_is_stickie") != null)
                                {
                                    _roomEngine.connection.send(new _SafeStr_690(_local_14, _local_11));
                                }
                                else
                                {
                                    _roomEngine.connection.send(new _SafeStr_626(_local_14, _local_15, _local_11, _local_10, _local_12, _local_7));
                                };
                            };
                        };
                    };
            ...
            var _local_8:_SafeStr_3172 = new _SafeStr_3172(_local_5.id, _local_5.category, null, null, null);
        ...
        private function changeRoomObjectState(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:Boolean):Boolean
        {
            ...
            if (((!(_roomEngine == null)) && (!(_roomEngine.connection == null))))
            {
                if (_arg_3 == 10)
                {
                    if (!_arg_5)
                    {
                        _roomEngine.connection.send(new _SafeStr_558(_arg_2, _arg_4));
                    }
                    else
                    {
                        _roomEngine.connection.send(new _SafeStr_664(_arg_2, _arg_4));
                    };
                }
                else
                {
                    if (_arg_3 == 20)
                    {
                        _roomEngine.connection.send(new _SafeStr_793(_arg_2, _arg_4));
                    };
                };
            ...
            if (((!(_roomEngine == null)) && (!(_roomEngine.connection == null))))
            {
                switch (_arg_4)
                {
                    ...
                    case "ROFCAE_USE_HABBOWHEEL":
                        ...
                        return;
                    case "ROFCAE_STICKIE":
                        _roomEngine.connection.send(new _SafeStr_225(_arg_2));
                        return;
                    case "ROFCAE_ENTER_ONEWAYDOOR":
                        _roomEngine.connection.send(new _SafeStr_199(_arg_2));
                        return;
                };
            };
        }
        ...
        public function modifyWallItemData(_arg_1:int, _arg_2:int, _arg_3:String, _arg_4:String):Boolean
        {
            ...
            _roomEngine.connection.send(new _SafeStr_164(_arg_2, _arg_3, _arg_4));
            return (true);
        }
        ...
        public function deleteWallItem(_arg_1:int, _arg_2:int):Boolean
        {
            ...
            _roomEngine.connection.send(new _SafeStr_958(_arg_2));
            return (true);
        }
        ...
        private function walkTo(_arg_1:int, _arg_2:int):void
        {
            if (_roomEngine.connection)
            {
                _roomEngine.connection.send(new _SafeStr_213(_arg_1, _arg_2));
            };
        }
...
// _SafeStr_1002 = "_-TK" (String#29437, DoABC#4)
// _SafeStr_1031 = "_-v1y" (String#20428, DoABC#4)
// _SafeStr_14 = "_-ED" (String#155, DoABC#4)
// _SafeStr_164 = "_-xh" (String#30704, DoABC#4)
// _SafeStr_1689 = "_-018" (String#7789, DoABC#4)
// _SafeStr_199 = "_-x1R" (String#29997, DoABC#4)
// _SafeStr_20 = "_-W1o" (String#542, DoABC#4)
// _SafeStr_211 = "_-n1n" (String#29306, DoABC#4)
// _SafeStr_213 = "_-n1Z" (String#28946, DoABC#4)
// _SafeStr_225 = "_-1e" (String#29725, DoABC#4)
...
// _SafeStr_384 = "_-l1K" (String#29449, DoABC#4)
// _SafeStr_402 = "_-Ix" (String#30370, DoABC#4)
// _SafeStr_430 = "_-I3" (String#22539, DoABC#4)
// _SafeStr_4639 = "_-s19" (String#7775, DoABC#4)
// _SafeStr_4640 = "_-HQ" (String#9060, DoABC#4)
// _SafeStr_4641 = "_-ee" (String#13630, DoABC#4)
// _SafeStr_4642 = "_-4v" (String#22193, DoABC#4)
// _SafeStr_4643 = "_-U1a" (String#10426, DoABC#4)
// _SafeStr_4644 = "_-fz" (String#18122, DoABC#4)
// _SafeStr_558 = "_-z11" (String#4154, DoABC#4)
// _SafeStr_583 = "_-fA" (String#19071, DoABC#4)
// _SafeStr_620 = "_-L1y" (String#29601, DoABC#4)
// _SafeStr_624 = "_-I1v" (String#13654, DoABC#4)
// _SafeStr_626 = "_-xZ" (String#18522, DoABC#4)
// _SafeStr_645 = "_-D16" (String#7521, DoABC#4)
// _SafeStr_664 = "_-s1r" (String#30348, DoABC#4)
// _SafeStr_690 = "_-4y" (String#28415, DoABC#4)
// _SafeStr_712 = "_-lr" (String#18191, DoABC#4)
// _SafeStr_741 = "_-s1o" (String#30432, DoABC#4)
// _SafeStr_793 = "_-H1H" (String#30438, DoABC#4)
// _SafeStr_906 = "_-51u" (String#28635, DoABC#4)
// _SafeStr_958 = "_-nc" (String#29438, DoABC#4)
