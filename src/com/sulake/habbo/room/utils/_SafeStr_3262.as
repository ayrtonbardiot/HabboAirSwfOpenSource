...
//com.sulake.habbo.room.utils._SafeStr_3262
...
package com.sulake.habbo.room.utils
{
    ...
    public class _SafeStr_3262 
    {

        private var _SafeStr_3997:Vector.<Vector.<IRoomObject>>;
        private var _width:int = 0;
        private var _SafeStr_4234:int = 0;

        public function _SafeStr_3262(_arg_1:int, _arg_2:int)
        {
            var _local_3:int;
            super();
            _SafeStr_3997 = new Vector.<Vector.<IRoomObject>>(_arg_2, true);
            _local_3 = 0;
            while (_local_3 < _arg_2)
            {
                _SafeStr_3997[_local_3] = new Vector.<IRoomObject>(_arg_1, true);
                _local_3++;
            };
            _width = _arg_1;
        ...
        {
            var _local_2:int;
            for each (var _local_1:Vector.<IRoomObject> in _SafeStr_3997)
            {
                _local_2 = 0;
        ...
        public function getObjectIntTile(_arg_1:int, _arg_2:int):IRoomObject
        {
            ...
            {
                return (_SafeStr_3997[_arg_2][_arg_1]);
            };
            return (null);
        }
        ...
        public function setObjectInTile(_arg_1:int, _arg_2:int, _arg_3:IRoomObject):void
        {
            ...
            {
                _SafeStr_14.log("Assigning non initialized object to tile object map!");
                return;
            };
            if (((((_arg_1 >= 0) && (_arg_1 < _width)) && (_arg_2 >= 0)) && (_arg_2 < _SafeStr_4234)))
            {
                _SafeStr_3997[_arg_2][_arg_1] = _arg_3;
            };
        }
        ...
        public function toString():String
        {
            ...
            while (_local_3 < _SafeStr_4234)
            {
                ...
                while (_local_2 < _width)
                {
                    _local_4 = _SafeStr_3997[_local_3][_local_2];
