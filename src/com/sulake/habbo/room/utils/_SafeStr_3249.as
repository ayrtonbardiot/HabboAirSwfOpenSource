...
//com.sulake.habbo.room.utils._SafeStr_3249
...
package com.sulake.habbo.room.utils
{
    ...
    public class _SafeStr_3249 
    {
        ...
        private var _SafeStr_5229:Number;
        private var spriteCount:int = 0;
        private var externalImageCount:int = 0;


        private static function addMannequinSprites(_arg_1:Vector.<RoomObjectSpriteData>, _arg_2:_SafeStr_1691):Vector.<RoomObjectSpriteData>
        {
            var _local_7:* = null;
            var _local_6:* = null;
        ...
        public function getFurniData(_arg_1:Rectangle, _arg_2:IRoomRenderingCanvas, _arg_3:_SafeStr_1691, _arg_4:int):String
        {
            var _local_12:* = null;
            var _local_7:Number;
            var _local_16:int;
        ...
        public function getRoomRenderingModifiers(_arg_1:_SafeStr_1691):String
        {
            var _local_2:Object = {};
            return (JSON.stringify(_local_2));
        }

        private function getSpriteDataObject(_arg_1:RoomObjectSpriteData, _arg_2:Rectangle, _arg_3:IRoomRenderingCanvas, _arg_4:_SafeStr_1691):Object
        {
            var _local_10:* = null;
            var _local_13:* = null;
            var _local_6:* = null;
        ...
        private function makeBackgroundPlane(_arg_1:Rectangle, _arg_2:uint, _arg_3:Array):_SafeStr_1318
        {
            var _local_4:Number;
            ...
            if (_arg_3.length > 0)
            {
                ...
                if (_SafeStr_5229)
                {
                    _local_4 = Math.max(_SafeStr_5229, _local_4);
                };
            }
            else
            {
                _local_4 = ((_SafeStr_5229) ? _SafeStr_5229 : 0);
            };
            _local_4 = (_local_4 + ((spriteCount * 1.776104) + (_arg_3.length * 2.31743)));
            var _local_5:_SafeStr_1318 = new PlaneDrawingData(null, _arg_2);
            _local_5.cornerPoints = _local_9;
            _local_5.z = _local_4;
            return (_local_5);
        }

        private function sortRoomPlanes(_arg_1:Vector.<IRoomPlane>, _arg_2:IRoomRenderingCanvas, _arg_3:_SafeStr_1691):Array
        {
            var _local_6:* = null;
            var _local_7:* = null;
            var _local_9:_SafeStr_24 = new _SafeStr_24();
            var _local_10:* = 1;
            if (_SafeStr_5229)
            {
                _local_10 = (_local_10 + _SafeStr_5229);
            };
        ...
        public function getRoomPlanes(_arg_1:Rectangle, _arg_2:IRoomRenderingCanvas, _arg_3:_SafeStr_1691, _arg_4:uint):Array
        {
            var _local_20:* = null;
            var _local_12:* = null;
            var _local_17:* = null;
            ...
            if (_local_7)
            {
                ...
                _local_17 = _SafeStr_79.instance.displayObjectContainer.stage;
                for each (var _local_16:Object in _local_12)
                {
                    ...
                    if (!((Math.abs(_local_22) == 4) || (Math.abs(_local_23) == 4)))
                    {
                        ...
                        for each (var _local_21:_SafeStr_1318 in _local_5.getDrawingDatas(_local_20))
                        {
...
// _SafeStr_5229 = "_-gp" (String#7208, DoABC#4)
