...
//com.sulake.habbo.friendbar.view.tabs.NewFriendEntityTab
...
package com.sulake.habbo.friendbar.view.tabs
{
    ...
    public class NewFriendEntityTab extends Tab 
    {
        ...
        private static const _SafeStr_8566:String = "new_friend_entity_xml";
        ...
        private static const _SafeStr_4027:Vector.<NewFriendEntityTab> = new Vector.<NewFriendEntityTab>();
        ...
        public static function allocate(_arg_1:_SafeStr_3377):NewFriendEntityTab
        {
            var _local_2:NewFriendEntityTab = ((_SafeStr_4027.length > 0) ? _SafeStr_4027.pop() : new (NewFriendEntityTab)());
        ...
        override public function select(_arg_1:Boolean):void
        {
            ...
            if (!selected)
            {
                ...
                if (friend.online)
                {
                    _local_6 = (WINDOWING.buildFromXML((ASSETS.getAssetByName("new_controls_piece_xml").content as XML)) as _SafeStr_3133);
        ...
        {
            var _local_1:_SafeStr_3133 = ((_SafeStr_5723.length > 0) ? _SafeStr_5723.pop() : (WINDOWING.buildFromXML((ASSETS.getAssetByName("new_friend_entity_xml").content as XML)) as _SafeStr_3133));
