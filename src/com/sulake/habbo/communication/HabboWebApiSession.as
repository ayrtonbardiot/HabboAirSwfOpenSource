...
//com.sulake.habbo.communication.HabboWebApiSession
...
package com.sulake.habbo.communication
{
    ...
    public class HabboWebApiSession implements IHabboWebApiSession, _SafeStr_45, _SafeStr_15 
    {

        private var SHARED_SECRET:String = "CnurvLf7UP";
        private var _SafeStr_4369:Dictionary;
        private var _SafeStr_8509:XMLList;
        private var _server:String;
        private var _captchaToken:String;
        private var _listeners:Vector.<_SafeStr_33>;
        private var _SafeStr_8510:Boolean = false;
        private var _SafeStr_4036:Boolean;
        private var _SafeStr_8511:String;
        private var _deviceToken:String;
        private var _SafeStr_8512:WebApiRequest;
        private var _SafeStr_8513:URLVariables;
        private var _SafeStr_8514:Array;
        private var _SafeStr_8515:String;
        ...
        public function HabboWebApiSession(_arg_1:String)
        {
            ...
            _SafeStr_8511 = generateDeviceId(_local_4);
            _server = _arg_1;
            _listeners = new Vector.<_SafeStr_33>(0);
            _SafeStr_8509 = describeType(this)..method;
            var _local_9:XML = describeType(IHabboWebApiSession);
            _SafeStr_14.log("[HabboWebApiSession] Start searching for Metadata");
            _SafeStr_4369 = new Dictionary();
            var _local_2:String = "";
            var _local_5:int;
            for each (var _local_8:XML in _local_9.factory.method)
            {
                ...
                for each (var _local_3:XML in _local_8.metadata)
                {
                    if (_local_3.@name == "HabboWebApiRoute")
                    {
                        ...
                        {
                            _SafeStr_4369[_local_7] = new WebApiRequest(_local_10, _local_6, (_local_10.indexOf("/public/") == -1));
                            _local_5++;
                        }
                        else
                        {
            ...
            if (_local_5 == 0)
            {
                _SafeStr_14.log("[HabboWebApiSession] Could not fetch META information correctly, make sure the build-params keep the information!");
            };
        }
        ...
        private function generateDeviceId(_arg_1:String):String
        {
            ...
            var _local_4:ByteArray = _SafeStr_23.toArray(_SafeStr_23.fromString((SHARED_SECRET + _arg_1)));
            var _local_5:ByteArray = _local_2.hash(_local_4);
            var _local_3:String = _SafeStr_23.fromArray(_local_5);
            return ((_arg_1 + ":") + _local_3);
        }

        private function getFunctionName(_arg_1:Function):String
        {
            for each (var _local_2:XML in _SafeStr_8509)
            {
        ...
        private function executeRequest(_arg_1:String, _arg_2:URLVariables=null, _arg_3:Array=null):void
        {
            ...
            if (_arg_1 != null)
            {
                _local_5 = _SafeStr_4369[_arg_1];
                _SafeStr_8512 = _local_5;
                _SafeStr_8513 = _arg_2;
                _SafeStr_8514 = _arg_3;
                if (_local_5 != null)
                {
                    _SafeStr_14.log(("Found request for method: " + _arg_1), _local_5.uri, _local_5.requestMethod);
            ...
            {
                _SafeStr_14.log("Could not execute request for null method...");
            };
        }
        ...
        public function setCaptchaToken(_arg_1:String):Boolean
        {
            ...
            if ((((_SafeStr_8512) && (_SafeStr_8515)) && (_SafeStr_8515 == _SafeStr_8512.uri)))
            {
                _local_2 = getMethodForRequest(_SafeStr_8512);
                if (_local_2 != null)
                {
                    executeRequest(_local_2, _SafeStr_8513, _SafeStr_8514);
                    return (true);
                };
            };
            return (false);
        ...
        {
            var _local_2:* = null;
            for (var _local_3:String in _SafeStr_4369)
            {
                _local_2 = _SafeStr_4369[_local_3];
        ...
        {
            _arg_1.requestHeaders.push(new URLRequestHeader("X-Habbo-Device-ID", _SafeStr_8511));
            _arg_1.requestHeaders.push(new URLRequestHeader("x-habbo-api-deviceid", _SafeStr_8511));
            _arg_1.requestHeaders.push(new URLRequestHeader("X-Habbo-Device-Type", _SafeStr_472.platformString()));
        }

        public function apiResponse(_arg_1:String, _arg_2:Object):void
        {
            _SafeStr_14.log(("[HabboWebApiSession] Got response for Web Api: " + _arg_1));
            if (_listeners != null)
            {
                for each (var _local_3:_SafeStr_33 in _listeners)
                {
        ...
        {
            _SafeStr_14.log(("[HabboWebApiSession] Got response for Web Api Raw: " + _arg_1));
            if (_listeners != null)
            {
                for each (var _local_3:_SafeStr_33 in _listeners)
                {
        ...
        public function apiError(_arg_1:String, _arg_2:int, _arg_3:String, _arg_4:Object, _arg_5:Boolean=false):void
        {
            var _local_8:* = null;
            var _local_7:* = null;
            _SafeStr_14.log(("[HabboWebApiSession] Got error for Web Api: " + _arg_1), _arg_2, _arg_3, _arg_4);
            _SafeStr_8515 = null;
            ...
            _SafeStr_14.log(("[HabboWebApiSession] Error code: " + _local_7));
            switch (_local_7)
            {
                ...
                case "registration.invalid_captcha":
                    ...
                    {
                        _SafeStr_8515 = _arg_1;
                    };
            };
            if (_listeners != null)
            {
                for each (var _local_6:_SafeStr_33 in _listeners)
                {
        ...
        public function dispose():void
        {
            ...
            _server = "";
            _SafeStr_4036 = true;
            for (var _local_2:String in _SafeStr_4369)
            {
                _local_1 = _SafeStr_4369[_local_2];
                _local_1.dispose();
            };
            _SafeStr_4369 = new Dictionary();
        }
        ...
        public function addListener(_arg_1:_SafeStr_33):Boolean
        {
        ...
        public function removeListener(_arg_1:_SafeStr_33):void
        {
            var _local_2:int;
            if (_listeners)
            {
...
// _SafeStr_4369 = "_-cz" (String#9165, DoABC#3)
// _SafeStr_45 = "_-N1C" (String#8055, DoABC#3)
// _SafeStr_472 = "_-dx" (String#9259, DoABC#3)
// _SafeStr_8509 = "_-cM" (String#9140, DoABC#3)
// _SafeStr_8510 = "_-s1T" (String#10187, DoABC#3)
// _SafeStr_8511 = "_-b1b" (String#9055, DoABC#3)
// _SafeStr_8512 = "_-pk" (String#10019, DoABC#3)
// _SafeStr_8513 = "_-GU" (String#7633, DoABC#3)
// _SafeStr_8514 = "_-Q1C" (String#8288, DoABC#3)
// _SafeStr_8515 = "_-Y1a" (String#8843, DoABC#3)
