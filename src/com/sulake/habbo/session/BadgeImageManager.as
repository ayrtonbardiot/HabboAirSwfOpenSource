...
package com.sulake.habbo.session
{
    ...
    public class BadgeImageManager 
    {
        ...
        public static const _SafeStr_8924:String = "group_badge";
        ...
        private function getBadgeImageInternal(_arg_1:String, _arg_2:String="normal_badge", _arg_3:Boolean=false):BitmapData
        {
            ...
            _SafeStr_14.log(("Request badge: " + _arg_1));
            switch (_arg_2)
            {
                case "normal_badge":
                    ...
                    break;
                case "group_badge":
                    if (((!(_configuration == null)) && (!(_SafeStr_5106[_local_6]))))
                    {
        ...
        private function onBadgeImageReady(_arg_1:AssetLoaderEvent):void
        {
            ...
            if (_local_5 != null)
            {
                if (((!(_local_5.assetLoader == null)) && (!(_local_5.assetLoader.content == null))))
                {
                    ...
                    _SafeStr_3983.dispatchEvent(new BadgeImageReadyEvent(_local_3, _local_2.bitmapData.clone()));
                };
            };
        }
...
// _SafeStr_5106 = "_-fE" (String#14518, DoABC#4)
// _SafeStr_8924 = "_-Vl" (String#31889, DoABC#4)
