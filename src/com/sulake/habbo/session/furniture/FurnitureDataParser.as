...
package com.sulake.habbo.session.furniture
{
    ...
    public class FurnitureDataParser extends EventDispatcherWrapper 
    {
        ...
        private var _SafeStr_4902:_SafeStr_24;
        private var _localization:_SafeStr_17;
        private var _SafeStr_4901:AssetLibrary;

        public function FurnitureDataParser(_arg_1:_SafeStr_24, _arg_2:_SafeStr_24, _arg_3:_SafeStr_24, _arg_4:_SafeStr_17)
        {
            _floorItems = _arg_1;
            _wallItems = _arg_2;
            _SafeStr_4902 = _arg_3;
            _localization = _arg_4;
            _SafeStr_4901 = new AssetLibrary("FurniDataParserAssetLib");
        }
        ...
        public function loadData(_arg_1:String, _arg_2:String=null, _arg_3:String=null):void
        {
            ...
            if (((_arg_2) && (_arg_3)))
            {
                _local_4 = _SafeStr_4901.loadAssetFromFile("furnidata", new URLRequest(_arg_1), "text/plain", ("furnidata_" + _arg_3.toLowerCase()), _arg_2);
            }
            else
            {
                _local_4 = _SafeStr_4901.loadAssetFromFile("furnidata", new URLRequest(_arg_1), "text/plain");
            };
        ...
        private function parseXmlFormat(_arg_1:String):void
        {
            ...
            {
                _SafeStr_79.error(("XML furni data was malformed: " + _arg_1), true, 12);
            };
            if (_local_5 == null)
            {
                return;
        ...
        private function parseFloorItem(_arg_1:XML):FurnitureData
        {
            ...
            var _local_10:* = (_local_9.length > 1);
        ...
        private function parseLingoFormat(_arg_1:String):void
        {
            ...
            for each (var _local_18:String in _local_28)
            {
                ...
                for each (var _local_27:String in _local_5)
                {
                    ...
                    {
                        _SafeStr_79.error(("Lingo furni data was malformed: " + _arg_1), true, 12);
                        return;
                    };
        ...
        private function storeItem(_arg_1:FurnitureData):void
        {
            ...
            var _local_2:Array = _SafeStr_4902[_arg_1.className];
            if (_local_2 == null)
            {
                _local_2 = [];
                _SafeStr_4902.add(_arg_1.className, _local_2);
            };
        ...
        private function furnitureDataError(_arg_1:AssetLoaderEvent):void
        {
            ...
            _SafeStr_79.error("Could not download furnidata definition", true, 12);
        }
...
// _SafeStr_4902 = "_-u1o" (String#10756, DoABC#4)
