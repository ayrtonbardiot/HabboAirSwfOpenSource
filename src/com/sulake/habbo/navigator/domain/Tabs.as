...
//com.sulake.habbo.navigator.domain.Tabs
...
package com.sulake.habbo.navigator.domain
{
    ...
    public class Tabs 
    {
        ...
        public static const _SafeStr_8657:int = 7;
        ...
        public static const _SafeStr_8658:int = 12;
        ...
        public static const _SafeStr_8659:int = 16;
        public static const _SafeStr_8660:int = 17;
        public static const _SafeStr_8661:int = 18;
        ...
        public static const _SafeStr_8662:int = 23;
        ...
        public function Tabs(_arg_1:HabboNavigator)
        {
            _navigator = _arg_1;
            _SafeStr_3742 = [];
            _SafeStr_3742.push(new Tab(_navigator, 1, 16, new EventsTabPageDecorator(_navigator), 1));
            _SafeStr_3742.push(new Tab(_navigator, 6, 21, new CategoriesTabPageDecorator(_navigator), 5));
            _SafeStr_3742.push(new Tab(_navigator, 2, 1, new RoomsTabPageDecorator(_navigator), 1));
            _SafeStr_3742.push(new Tab(_navigator, 4, 11, new OfficialTabPageDecorator(_navigator), 4));
            _SafeStr_3742.push(new Tab(_navigator, 3, 5, new MyRoomsTabPageDecorator(_navigator), 1));
            _SafeStr_3742.push(new Tab(_navigator, 5, 8, new SearchTabPageDecorator(_navigator), 2));
            setSelectedTab(1);
        }
        ...
        {
            for each (var _local_1:Tab in _SafeStr_3742)
            {
        ...
        {
            for each (var _local_2:Tab in _SafeStr_3742)
            {
...
// _SafeStr_8657 = "_-8K" (String#38801, DoABC#4)
// _SafeStr_8658 = "_-fq" (String#31774, DoABC#4)
// _SafeStr_8659 = "_-K" (String#40033, DoABC#4)
// _SafeStr_8660 = "_-s1v" (String#34296, DoABC#4)
// _SafeStr_8661 = "_-c19" (String#37497, DoABC#4)
// _SafeStr_8662 = "_-pc" (String#32253, DoABC#4)
