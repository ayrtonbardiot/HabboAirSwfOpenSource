...
//com.sulake.habbo.navigator.Util
...
package com.sulake.habbo.navigator
{
    ...
    public class Util 
    {
        ...
        private static var CUT_TO_HEIGHT:_SafeStr_3461 = new _SafeStr_3461();
        ...
        public static function getLocationRelativeTo(_arg_1:_SafeStr_3109, _arg_2:int, _arg_3:int):Rectangle
        {
            if (_arg_1 == null)
            {
        ...
        public static function hasVisibleChildren(_arg_1:_SafeStr_3133):Boolean
        {
            var _local_2:int;
            var _local_3:* = null;
            _local_2 = 0;
        ...
        public static function moveChildrenToRow(_arg_1:_SafeStr_3133, _arg_2:Array, _arg_3:int, _arg_4:int, _arg_5:int):void
        {
            var _local_7:* = null;
        ...
        public static function layoutChildrenInArea(_arg_1:_SafeStr_3133, _arg_2:int, _arg_3:int, _arg_4:int=0, _arg_5:int=0):void
        {
            var _local_8:int;
            var _local_9:* = null;
            var _local_6:* = _arg_5;
        ...
        public static function setProc(_arg_1:_SafeStr_3133, _arg_2:String, _arg_3:Function):void
        {
        ...
        public static function binarySearch(_arg_1:_SafeStr_3435, _arg_2:int):void
        {
            var _local_5:int;
        ...
        public static function containsMouse(_arg_1:_SafeStr_3109):Boolean
        {
