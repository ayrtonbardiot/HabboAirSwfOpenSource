...
//com.sulake.habbo.campaign.calendar.CalendarSpinnerUtil
...
package com.sulake.habbo.campaign.calendar
{
    ...
    public class CalendarSpinnerUtil 
    {
        ...
        {
            var _local_6:_SafeStr_3264 = (_arg_1.window.findChildByName("gradient1") as _SafeStr_3264);
            ...
            _local_6 = (_arg_1.window.findChildByName("gradient2") as _SafeStr_3264);
