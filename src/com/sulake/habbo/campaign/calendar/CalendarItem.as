...
//com.sulake.habbo.campaign.calendar.CalendarItem
...
package com.sulake.habbo.campaign.calendar
{
    ...
    public class CalendarItem 
    {
        ...
        public static function populateItem(_arg_1:_SafeStr_3133, _arg_2:_SafeStr_1535, _arg_3:int):_SafeStr_3133
        {
            var _local_6:_SafeStr_3133 = (_arg_1.clone() as _SafeStr_3133);
        ...
        public static function updateState(_arg_1:_SafeStr_3133, _arg_2:_SafeStr_1535, _arg_3:int, _arg_4:int):void
        {
        ...
        public static function updateThumbnail(_arg_1:_SafeStr_3133, _arg_2:Object):void
        {
            var _local_5:IStaticBitmapWrapperWindow = (_arg_1.findChildByName("bitmap_bg") as IStaticBitmapWrapperWindow);
            ...
            var _local_4:_SafeStr_3264 = (_arg_1.findChildByName("bitmap_icon2") as _SafeStr_3264);
        ...
        public static function showWiggleEffect(_arg_1:_SafeStr_3109):void
        {
            new CalendarItemWiggle(_arg_1); //not popped
        }

        public static function resolveDayState(_arg_1:_SafeStr_1535, _arg_2:int):int
        {
