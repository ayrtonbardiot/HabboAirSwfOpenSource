...
//com.sulake.habbo.quest.seasonalcalendar._SafeStr_3479
...
package com.sulake.habbo.quest.seasonalcalendar
{
    ...
    public class _SafeStr_3479 implements _SafeStr_13 
    {

        private var _SafeStr_5380:Vector.<BitmapData>;
        ...
        public function getSlice(_arg_1:int, _arg_2:int):BitmapData
        {
            ...
            var _local_6:* = null;
            var _local_4:int;
            if ((((_disposed) || (_SafeStr_5380 == null)) || (_SafeStr_5380.length == 0)))
            {
                return (new BitmapData(1, 1));
            };
            var _local_8:BitmapData = new BitmapData(_arg_2, _SafeStr_5380[0].height, false, 0);
            var _local_3:int;
            while (_local_3 < _arg_2)
            {
                ...
                {
                    _local_6 = _SafeStr_5380[_local_7];
        ...
        public function getImageIndexForOffset(_arg_1:int):int
        {
            ...
            var _local_2:int;
            _local_3 = 0;
            while (_local_3 < _SafeStr_5380.length)
            {
                if (((_local_2 <= _arg_1) && (_arg_1 < (_local_2 + _SafeStr_5380[_local_3].width))))
                {
                    return (_local_3);
                };
                _local_2 = (_local_2 + _SafeStr_5380[_local_3].width);
                _local_3++;
            };
            return (-1);
        }
