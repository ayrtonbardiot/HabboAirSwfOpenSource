...
package com.sulake.habbo.quest
{
    ...
    public class QuestsList implements _SafeStr_13 
    {
        ...
        private var _SafeStr_6479:Boolean;
        ...
        public function onToolbarClick():void
        {
            ...
            {
                _SafeStr_4080 = new WindowToggle(_window, _window.desktop, _questEngine.requestQuests, close);
            };
        ...
        private function refresh(_arg_1:Boolean):void
        {
            ...
            while (true)
            {
                if (_local_3 < _SafeStr_6003.length)
                {
                    refreshEntry(true, _local_3, _SafeStr_6003[_local_3], _arg_1);
                }
                else
                {
        ...
        private function prepareWindow():void
        {
            ...
            _window = _SafeStr_3263(_questEngine.getXmlWindow("Quests"));
            _window.findChildByTag("close").procedure = onWindowClose;
            _SafeStr_4162 = IItemListWindow(_window.findChildByName("quest_list"));
            _SafeStr_4452 = IScrollbarWindow(_window.findChildByName("scroller"));
            _window.center();
            _SafeStr_4162.spacing = 10;
        }

        private function refreshEntry(_arg_1:Boolean, _arg_2:int, _arg_3:_SafeStr_1607, _arg_4:Boolean):Boolean
        {
            var _local_5:_SafeStr_3133 = _SafeStr_3133(_SafeStr_4162.getListItemAt(_arg_2));
        ...
        public function createListEntry(_arg_1:Function, _arg_2:Function):_SafeStr_3133
        {
            var _local_3:_SafeStr_3133 = _SafeStr_3133(_questEngine.getXmlWindow("QuestEntry"));
            var _local_6:_SafeStr_3133 = _SafeStr_3133(_questEngine.getXmlWindow("Campaign"));
            var _local_9:_SafeStr_3133 = _SafeStr_3133(_questEngine.getXmlWindow("Quest"));
            var _local_5:_SafeStr_3133 = _SafeStr_3133(_questEngine.getXmlWindow("EntryArrows"));
            var _local_8:_SafeStr_3133 = _SafeStr_3133(_questEngine.getXmlWindow("CampaignCompleted"));
            ...
            var _local_7:_SafeStr_3109 = _local_3.findChildByName("cancel_region");
            var _local_4:_SafeStr_3109 = _local_3.findChildByName("cancel_txt");
        ...
        public function setEntryHeight(_arg_1:_SafeStr_3133):void
        {
            var _local_5:_SafeStr_3133 = _SafeStr_3133(_arg_1.findChildByName("campaign_container"));
            var _local_6:_SafeStr_3133 = _SafeStr_3133(_arg_1.findChildByName("quest_container"));
            var _local_4:_SafeStr_3133 = _SafeStr_3133(_arg_1.findChildByName("entry_arrows_cont"));
            ...
            var _local_2:int = 2;
            var _local_3:_SafeStr_3109 = _local_5.findChildByName("bg_bottom");
            _local_3.height = Math.floor(((_local_5.height - (2 * _local_2)) / 2));
            _local_3.y = (_local_2 + _local_3.height);
        }

        public function refreshEntryDetails(_arg_1:_SafeStr_3133, _arg_2:_SafeStr_1607):void
        {
            ...
            {
                this.refreshEntryQuestDetails(_SafeStr_3133(_arg_1.findChildByName("quest_container")), _arg_2);
                refreshDelay(_arg_1, _arg_2);
            };
        }

        private function refreshEntryQuestDetails(_arg_1:_SafeStr_3133, _arg_2:_SafeStr_1607):void
        {
        ...
        public function refreshDelay(_arg_1:_SafeStr_3133, _arg_2:_SafeStr_1607):Boolean
        {
            var _local_3:int;
            var _local_4:* = null;
        ...
        private function onWindowClose(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                ...
                if ((((_local_3) && (_showToolbarNotification)) && (!(_SafeStr_6479))))
                {
                    _showToolbarNotification = false;
        ...
        private function onAcceptQuest(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            _SafeStr_14.log(("Accept quest: " + _local_3));
            _questEngine.send(new _SafeStr_448(_local_3));
            _window.visible = false;
        }
        ...
        private function onCancelQuest(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            _SafeStr_14.log("Reject quest");
            _questEngine.send(new _SafeStr_917());
        }

        private function setColor(_arg_1:_SafeStr_3133, _arg_2:String, _arg_3:Boolean, _arg_4:uint, _arg_5:uint):void
        {
...
// _SafeStr_6479 = "_-Jl" (String#13628, DoABC#4)
