...
//com.sulake.habbo.window.HintManager
...
package com.sulake.habbo.window
{
    ...
    public class HintManager implements _SafeStr_13, _SafeStr_41 
    {

        private static const _SafeStr_7002:int = 10;
        private static const _SafeStr_7003:int = 400;
        private static const _SafeStr_7004:int = 15;
        ...
        private var _SafeStr_7005:Rectangle;
        private var _SafeStr_5207:Rectangle;
        ...
        public function registerWindow(_arg_1:String, _arg_2:_SafeStr_3109, _arg_3:int):void
        {
        ...
        public function showHint(_arg_1:String, _arg_2:Rectangle=null):void
        {
            ...
            if ((((!(_local_3 == null)) && (!(_local_3.window == null))) && (!(_arg_1 == activeKey))))
            {
                ...
                _SafeStr_7005 = _arg_2;
                _SafeStr_5207 = getTargetRect(_activeHint.window);
                if (_arg_2 != null)
                {
                    animateHint(_arg_2);
                }
        ...
        protected function animateHint(_arg_1:Rectangle):void
        {
            ...
            _hint.y = _arg_1.y;
            _hint.visible = true;
            var _local_3:int = (_arg_1.x - _SafeStr_5207.x);
            var _local_6:int = (_arg_1.y - _SafeStr_5207.y);
            ...
            var _local_5:Motion = new Queue(new Combo(new EaseOut(new MoveTo(_hint, _local_2, _SafeStr_5207.x, _SafeStr_5207.y), 1), new ResizeTo(_hint, _local_2, _local_8, _local_7)), new Callback(motionComplete));
            _SafeStr_3336.runMotion(_local_5);
        }
        ...
        private function getTargetRect(_arg_1:_SafeStr_3109):Rectangle
        {
...
// _SafeStr_5207 = "_-u1C" (String#11078, DoABC#4)
// _SafeStr_7002 = "_-J1T" (String#38791, DoABC#4)
// _SafeStr_7003 = "_-fb" (String#31855, DoABC#4)
// _SafeStr_7004 = "_-7m" (String#38797, DoABC#4)
// _SafeStr_7005 = "_-Bl" (String#23707, DoABC#4)
