...
//com.sulake.habbo.window.theme.ThemeManager
...
package com.sulake.habbo.window.theme
{
    ...
    public class ThemeManager implements IThemeManager 
    {
        ...
        private static const _SafeStr_9169:int = 100;

        private var _SafeStr_5135:Dictionary;
        ...
        public function ThemeManager(_arg_1:SkinContainer):void
        {
            ...
            _local_5.addEnumeration("pivot_point", PivotPoint.PIVOT_NAMES[0], _SafeStr_3334.PIVOT_POINT_RANGE);
            ...
            _local_5.addEnumeration("text_style", "regular", _SafeStr_3371.getStyleNameArrayRef());
            ...
            _local_5.addEnumeration("widget_type", "", _SafeStr_3227.WIDGET_TYPES);
            ...
            _SafeStr_5135 = new Dictionary();
            _SafeStr_5135["None"] = new Theme("None", false, 0, 0xFFFFFFFF, _local_5);
            var _local_4:int;
            while (_SafeStr_3722.skinRendererExists(1, _local_4))
            {
                _local_4++;
            };
            _SafeStr_5135["Icon"] = new Theme("Icon", false, 0, _local_4, _local_5);
            var _local_2:int;
            while (((_SafeStr_3722.skinRendererExists(30, _local_2)) && (_local_2 < 100)))
            {
                _local_2++;
            };
            _SafeStr_5135["Legacy border"] = new Theme("Legacy border", false, 0, _local_2, _local_5);
            _SafeStr_5135["Volter"] = new Theme("Volter", true, 0, 3, _local_5.clone());
            _local_3 = _local_5.clone();
            _local_3.addEnumeration("antialias_type", "advanced", ["normal", "advanced"]);
            _local_3.addEnumeration("text_style", "u_regular", _SafeStr_3371.getStyleNameArrayRef());
            _SafeStr_5135["Ubuntu"] = new Theme("Ubuntu", true, 3, 5, _local_3);
            _local_3 = _local_5.clone();
            _local_3.addEnumeration("antialias_type", "advanced", ["normal", "advanced"]);
            _local_5.addHex("etching_color", 3003121663);
            _local_3.addEnumeration("text_style", "il_regular", _SafeStr_3371.getStyleNameArrayRef());
            _SafeStr_5135["Illumina Light"] = new Theme("Illumina Light", true, 100, 100, _local_3);
            ...
            _SafeStr_5135["Illumina Dark"] = new Theme("Illumina Dark", true, 200, 100, _local_3);
        }
        ...
        public function getStyle(_arg_1:String, _arg_2:uint, _arg_3:String):uint
        {
            ...
            var _local_5:Theme = _SafeStr_5135[_arg_1];
            if (_local_5 == null)
            {
                return (0);
            };
            ...
            while (_local_4 < _local_5.styleCount)
            {
                ...
                if (_arg_3 == _SafeStr_3722.getIntentByTypeAndStyle(_arg_2, _local_6))
                {
                    return (_local_6);
                };
                _local_4++;
        ...
        {
            var _local_4:String = _SafeStr_3722.getIntentByTypeAndStyle(_arg_1, _arg_2);
            if (_arg_1 == 1)
            {
                return ({
                    "theme":"Icon",
            ...
            for each (var _local_3:Theme in _SafeStr_5135)
            {
        ...
        public function getIntents(_arg_1:uint, _arg_2:String, _arg_3:uint):Array
        {
            ...
            if (_arg_2 != "None")
            {
                _local_6 = _SafeStr_5135[_arg_2];
                _local_5 = 0;
                while (_local_5 < _local_6.styleCount)
                {
                    _local_7 = _SafeStr_3722.getIntentByTypeAndStyle(_arg_1, (_local_6.baseStyle + _local_5));
                    if (_local_7 != null)
                    {
        ...
        public function getPropertyDefaults(_arg_1:uint):_SafeStr_3283
        {
            var _local_2:* = null;
            for each (var _local_3:Theme in _SafeStr_5135)
            {
...
// _SafeStr_5135 = "_-Ot" (String#5186, DoABC#4)
// _SafeStr_9169 = "_-E1C" (String#32392, DoABC#4)
