...
//com.sulake.habbo.window.widgets.PetImageWidget
...
package com.sulake.habbo.window.widgets
{
    ...
    public class PetImageWidget implements _SafeStr_3385, _SafeStr_3140 
    {
        ...
        private static const _SafeStr_9171:String = "pet_image:direction";
        ...
        private static const DIRECTION_DEFAULT:PropertyStruct = new PropertyStruct("pet_image:direction", _SafeStr_6182[2], "String", false, _SafeStr_6182);
        ...
        public function PetImageWidget(_arg_1:_SafeStr_3199, _arg_2:HabboWindowManagerComponent)
        {
            _SafeStr_5427 = _arg_1;
            _windowManager = _arg_2;
            _SafeStr_5989 = new _SafeStr_24();
            _SafeStr_5428 = (_windowManager.buildFromXML((_windowManager.assets.getAssetByName("pet_image_xml").content as XML)) as _SafeStr_3133);
        ...
        public function imageReady(_arg_1:int, _arg_2:BitmapData):void
        {
            ...
            if (_local_3 != null)
            {
                if (cleanupAvatarString(_local_3) == _SafeStr_3819)
                {
                    refresh();
                };
            };
        ...
        private function refresh():void
        {
            ...
            var _local_4:* = null;
            _bitmap.bitmap = null;
            var _local_1:PetFigureData = new PetFigureData(_SafeStr_3819);
            if (_windowManager.roomEngine != null)
            {
                ...
                if (_local_2 != null)
                {
                    ...
                    _SafeStr_5989.remove(_local_5);
                    if (_local_5 > 0)
                    {
                        _SafeStr_5989.add(_local_5, _SafeStr_3819);
                    };
            ...
            {
                _local_4 = (("placeholder_pet" + ((_SafeStr_4045 == 32) ? "_small" : "")) + "_png");
...
// _SafeStr_3385 = "_-22Q" (String#20294, DoABC#4)
