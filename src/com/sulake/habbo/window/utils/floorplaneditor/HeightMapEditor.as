...
//com.sulake.habbo.window.utils.floorplaneditor.HeightMapEditor
...
package com.sulake.habbo.window.utils.floorplaneditor
{
    ...
    public class HeightMapEditor 
    {
        ...
        public static var floor_editor_tile_base:Class = _SafeStr_3477;
        ...
        private var _bitmapElement:_SafeStr_3264;
        ...
        public static function hslToRgb(_arg_1:Number, _arg_2:Number, _arg_3:Number):Array
        {
            ...
            {
                var hue2rgb = function (_arg_1:Number, _arg_2:Number, _arg_3:Number):Number
                {
                    if (_arg_3 < 0)
                    {
                        _arg_3 = (_arg_3 + 1);
        ...
        private function updateView():void
        {
            ...
            var _local_14:int;
            var _local_8:Array = [];
            var _local_10:* = 2147483647;
            var _local_9:* = 2147483647;
...
// _SafeStr_3477 = "floor_editor_tile_base_png$e12e7a51d1a3a76ebc871ce9f9e6e876-1821169117" (String#18523, DoABC#4)
