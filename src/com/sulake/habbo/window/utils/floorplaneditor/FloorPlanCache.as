...
//com.sulake.habbo.window.utils.floorplaneditor.FloorPlanCache
...
package com.sulake.habbo.window.utils.floorplaneditor
{
    ...
    public class FloorPlanCache 
    {
        ...
        public function onFloorHeightMap(_arg_1:_SafeStr_730):void
        {
            updateFloorPlanCache(_arg_1.getParser().text);
        }

        public function onOccupiedTiles(_arg_1:_SafeStr_223):void
        {
            var _local_2:* = null;
            if (_floorPlanCache)
            {
...
// _SafeStr_1091 = "_-119" (String#34724, DoABC#4)
