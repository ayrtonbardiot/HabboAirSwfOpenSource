...
//com.sulake.habbo.window.utils._SafeStr_3252

package com.sulake.habbo.window.utils
{
    import flash.utils.Dictionary;
    import com.sulake.core.window.utils._SafeStr_3383;
    import com.sulake.core.window.utils._SafeStr_3320;
    ...
    public class _SafeStr_3252 
    {
        ...
        public static function parse(_arg_1:XML, _arg_2:_SafeStr_21, _arg_3:SkinContainer):void
        {
            ...
            _SafeStr_3383.fillTables(_local_18, _local_20);
            var _local_17:Dictionary = new Dictionary();
            var _local_11:Dictionary = new Dictionary();
            _SafeStr_3320.fillTables(_local_17, _local_11);
            ...
            if (_arg_1 != null)
            {
                ...
                if (_local_7 > 0)
                {
                    ...
                    while (_local_24 < _local_7)
                    {
                        ...
                        _arg_3.addSkinRenderer(_local_18[_local_8], _local_15, _local_21, _local_4, _local_23, _local_26);
                        _local_24++;
                    };
