...
//com.sulake.habbo.catalog.viewer.widgets.ColourGridCatalogWidget
...
package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class ColourGridCatalogWidget extends CatalogWidget implements _SafeStr_3303 
    {
        ...
        private var _SafeStr_6729:BitmapData;
        private var _colourChosen:BitmapData;
        private var _SafeStr_5575:_SafeStr_3133;

        public function ColourGridCatalogWidget(_arg_1:_SafeStr_3133)
        {
            super(_arg_1);
        }
        ...
        private function onAvailableColours(_arg_1:CatalogWidgetColoursEvent):void
        {
            ...
            _SafeStr_6729 = (_local_3.content as BitmapData);
            ...
            populateColourGrid();
            select((_colourGrid.getGridItemAt(_arg_1.index) as _SafeStr_3133));
        }
        ...
        private function onAvailableMultiColours(_arg_1:CatalogWidgetMultiColoursEvent):void
        {
            ...
            _colourChosen = (_local_2.content as BitmapData);
            populateColourGrid();
            select((_colourGrid.getGridItemAt(0) as _SafeStr_3133));
        }

        private function select(_arg_1:_SafeStr_3133):void
        {
            var _local_2:* = null;
            _SafeStr_14.log(("[ColourGridCatalogWidget] Select: " + _arg_1));
        ...
        private function populateColourGrid():void
        {
            ...
            var _local_11:int;
            var _local_8:* = null;
            _SafeStr_14.log(("[ColourGridCatalogWidget] Display colors: " + [_colours.length, _colourGrid.numGridItems]));
            _colourGrid.destroyGridItems();
            _SafeStr_5575 = null;
            for each (var _local_13:Array in _colours)
            {
                ...
                {
                    _local_4 = (page.viewer.catalog.windowManager.buildFromXML(_colourChooserLayout) as _SafeStr_3133);
                    ...
                    _local_7 = (_local_4.findChildByTag("BG_BORDER") as _SafeStr_3264);
                    if (_local_7 != null)
                    {
                    ...
                    _local_12 = (_local_4.findChildByTag("COLOR_IMAGE") as _SafeStr_3264);
                    if (_local_12 != null)
                    {
                        _local_12.bitmap = new BitmapData(_SafeStr_6729.width, _SafeStr_6729.height, true, 0);
                        _local_9 = 0xFF;
                        _local_2 = 0xFF;
                        _local_1 = 0xFF;
                        _local_5 = null;
                    ...
                    _local_8 = (_local_4.findChildByTag("COLOR_CHOSEN") as _SafeStr_3264);
                    if (_local_8 != null)
                    {
        ...
        {
            select((_arg_1.target as _SafeStr_3133));
            var _local_2:int = _colourGrid.getGridItemIndex((_arg_1.target as _SafeStr_3109));
...
// _SafeStr_6729 = "_-81o" (String#8265, DoABC#4)
