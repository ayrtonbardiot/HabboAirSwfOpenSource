...
//com.sulake.habbo.catalog.viewer.widgets.MarketPlaceCatalogWidget
...
package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class MarketPlaceCatalogWidget extends CatalogWidget implements _SafeStr_3303, _SafeStr_3140, IMarketPlaceVisualization 
    {
        ...
        private var _SafeStr_6759:Array = [];
        private var _SafeStr_6761:MarketPlaceOfferData;
        private var _itemList:IItemListWindow;
        private var _SafeStr_6757:_SafeStr_3133;
        private var _SafeStr_6758:Timer;
        private var _offers:_SafeStr_24;
        private var _SafeStr_6760:int;

        public function MarketPlaceCatalogWidget(_arg_1:_SafeStr_3133)
        {
            super(_arg_1);
        }
        ...
        override public function dispose():void
        {
            ...
            if (_SafeStr_6757)
            {
                _SafeStr_6757.dispose();
                _SafeStr_6757 = null;
            };
            if (_SafeStr_6758)
            {
                _SafeStr_6758.removeEventListener("timer", onPopulationTimer);
                _SafeStr_6758 = null;
            };
        }
        ...
        override public function init():Boolean
        {
            ...
            _SafeStr_6757 = (_local_1.removeListItem(_local_1.getListItemByName("offer_item")) as _SafeStr_3133);
            return (true);
        }
        ...
        public function updateStats():void
        {
            ...
            var _local_2:_SafeStr_3209 = marketPlace.itemStats;
            if (!_local_2)
            {
                return;
            };
            var _local_5:_SafeStr_3133 = (_window.findChildByName("details_container") as _SafeStr_3133);
            if (((!(_local_5)) || (!(_local_5.visible))))
            {
                return;
            };
            var _local_4:_SafeStr_3109 = _local_5.findChildByName("offer_count");
            if (_local_4)
            {
            ...
            var _local_7:_SafeStr_3264 = (_local_5.findChildByName("chart_bitmap") as _SafeStr_3264);
            if (_local_7)
            {
            ...
            var _local_8:_SafeStr_3109 = _local_5.findChildByName("chart_title");
            if (_local_8)
            {
        ...
        private function selectSearchCategory(_arg_1:String):void
        {
            ...
            var _local_3:_SafeStr_3133 = (_window.findChildByName("search_container") as _SafeStr_3133);
            if (_local_3 == null)
            {
                return;
            };
            ...
            switch (_arg_1)
            {
                ...
                case "search_by_activity":
                    _local_5 = "marketplace_search_simple";
                    _SafeStr_6759 = [3, 4, 5, 6];
                    break;
                case "search_advanced":
                    _local_5 = "marketplace_search_advanced";
                    _SafeStr_6759 = [1, 2, 3, 4, 5, 6];
                    break;
                default:
                    return;
            };
            var _local_7:_SafeStr_3133 = (createWindow(_local_5) as _SafeStr_3133);
            _local_3.addChild(_local_7);
            var _local_6:_SafeStr_3269 = (_window.findChildByName("sort_dropmenu") as _SafeStr_3269);
            if (_local_6 != null)
            {
                _local_6.populate(getSortKeys(_SafeStr_6759));
        ...
        {
            var _local_6:* = null;
            var _local_4:_SafeStr_18 = marketPlace.localization;
            if (!_local_4)
            {
                return;
            };
            ...
            var _local_5:_SafeStr_3109 = window.findChildByName("status_text");
            if (_local_5 == null)
            {
                return;
            };
        ...
        private function updateList():void
        {
            ...
            var _local_1:_SafeStr_24 = marketPlace.latestOffers();
            if (!_local_1)
            {
                return;
            };
            ...
            if (!_SafeStr_6758)
            {
                _SafeStr_6758 = new Timer(25);
                _SafeStr_6758.addEventListener("timer", onPopulationTimer);
            };
            _SafeStr_6760 = 0;
            populateList();
            _SafeStr_6758.start();
        ...
        private function populateList():Boolean
        {
            ...
            while (_local_1 < 5)
            {
                if (_SafeStr_6760 >= _offers.length)
                {
                    return (true);
                };
                addListItem(_offers.getWithIndex(_SafeStr_6760));
                _SafeStr_6760++;
                _local_1++;
            };
            return (false);
        ...
        private function addListItem(_arg_1:MarketPlaceOfferData):void
        {
            ...
            var _local_2:* = null;
            var _local_8:* = null;
            if (((((!(_arg_1)) || (!(_itemList))) || (!(_SafeStr_6757))) || (!(marketPlace.localization))))
            {
                return;
            };
            var _local_14:_SafeStr_3133 = (_SafeStr_6757.clone() as _SafeStr_3133);
            if (((!(_local_14)) || (_local_14.disposed)))
            {
                return;
            };
            var _local_9:_SafeStr_3109 = _local_14.findChildByName("item_name");
            if (_local_9 != null)
            {
                _local_9.caption = (("${" + marketPlace.getNameLocalizationKey(_arg_1)) + "}");
            };
            var _local_15:_SafeStr_3109 = _local_14.findChildByName("item_desc");
            if (_local_15 != null)
            {
                _local_15.caption = (("${" + marketPlace.getDescriptionLocalizationKey(_arg_1)) + "}");
            };
            var _local_16:_SafeStr_3109 = _local_14.findChildByName("item_price");
            if (_local_16 != null)
            {
            ...
            var _local_11:_SafeStr_3109 = _local_14.findChildByName("offer_count");
            if (_local_11)
            {
            ...
            if (_arg_1.image != null)
            {
                _local_5 = (_local_14.findChildByName("item_image") as _SafeStr_3264);
                if (_local_5 != null)
                {
            ...
            if (_arg_1.isUniqueLimitedItem)
            {
                ...
                _local_3 = _SafeStr_3199(_local_14.findChildByName("unique_item_overlay_widget"));
            ...
            {
                _local_7 = _SafeStr_3199(_local_14.findChildByName("rarity_item_overlay_widget"));
        ...
        private function onOfferListEvent(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109=null):void
        {
            var _local_5:int;
            var _local_3:* = null;
            var _local_4:* = null;
        ...
        private function showDetails(_arg_1:MarketPlaceOfferData):void
        {
            ...
            var _local_12:_SafeStr_3133 = (_window.findChildByName("details_container") as _SafeStr_3133);
            if (_local_12)
            {
            ...
            {
                _local_12 = (createWindow("marketplace_offer_details") as _SafeStr_3133);
                _window.addChild(_local_12);
                _local_12.procedure = detailsEventHandler;
            };
            var _local_8:_SafeStr_3109 = _local_12.findChildByName("item_name");
            if (_local_8)
            {
            ...
            if (_arg_1.image != null)
            {
                _local_7 = (_local_12.findChildByName("item_image") as _SafeStr_3264);
                if (_local_7 != null)
                {
                    _local_7.bitmap = null;
            ...
            var _local_14:_SafeStr_3264 = (_local_12.findChildByName("chart_bitmap") as _SafeStr_3264);
            if (_local_14)
            {
                _local_14.bitmap = null;
            };
            var _local_5:_SafeStr_3199 = _SafeStr_3199(_local_12.findChildByName("unique_item_overlay_widget"));
            if (_arg_1.isUniqueLimitedItem)
            {
            ...
            var _local_9:_SafeStr_3199 = _SafeStr_3199(_local_12.findChildByName("rarity_item_overlay_widget"));
            if (((_arg_1.stuffData) && (_arg_1.stuffData.rarityLevel >= 0)))
            {
        ...
        private function hideDetails():void
        {
            ...
            _SafeStr_6761 = null;
            var _local_1:_SafeStr_3109 = _window.findChildByName("details_container");
            if (_local_1)
            {
        ...
        private function doSearch():void
        {
            ...
            var _local_5:_SafeStr_3269 = (_window.findChildByName("sort_dropmenu") as _SafeStr_3269);
            if ((((_local_5) && (_local_5.selection >= 0)) && (_local_5.selection < _SafeStr_6759.length)))
            {
                _local_3 = _SafeStr_6759[_local_5.selection];
            };
            marketPlace.requestOffers(_local_4, _local_6, _local_2, _local_3);
        }

        private function onWidgetEvent(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109=null):void
        {
            var _local_7:* = null;
            var _local_6:* = null;
            var _local_5:* = null;
            ...
            var _local_4:_SafeStr_3109 = window.findChildByName("search_input");
        ...
        private function detailsEventHandler(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            if (((!(_arg_1)) || (!(_arg_2))))
            {
                return;
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                switch (_arg_2.name)
                {
                    case "back_button":
                        ...
                        return;
                    case "buy_button":
                        marketPlace.buyOffer(_SafeStr_6761.offerId);
                        return;
                };
                return;
            };
...
// _SafeStr_6757 = "_-6s" (String#7301, DoABC#4)
// _SafeStr_6758 = "_-WR" (String#6360, DoABC#4)
// _SafeStr_6759 = "_-z1s" (String#5918, DoABC#4)
// _SafeStr_6760 = "_-51N" (String#9576, DoABC#4)
// _SafeStr_6761 = "_-sT" (String#9726, DoABC#4)
