...
//com.sulake.habbo.catalog.offers.SupersonicProvider
...
package com.sulake.habbo.catalog.offers
{
    ...
    public class SupersonicProvider implements IOfferProvider 
    {
        ...
        private static const _SafeStr_8321:String = "supersonicAdsLoadCampaigns";
        private static const _SafeStr_8322:String = "supersonicAdsCamapaignEngage";
        ...
        public function load():void
        {
            if (((enabled) && (!(_loaded))))
            {
                ...
                {
                    _SafeStr_14.log(("External interface not working. Could not call supersonicAdsLoadCampaigns: " + e));
                };
            };
        }
        ...
        public function showVideo():void
        {
            if (((enabled) && (_offerCount > 0)))
            {
                ...
                {
                    _SafeStr_14.log(("External interface not working. Could not call supersonicAdsCamapaignEngage: " + e));
                };
            };
        }
