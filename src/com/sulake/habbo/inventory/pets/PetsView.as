...
//com.sulake.habbo.inventory.pets.PetsView
...
package com.sulake.habbo.inventory.pets
{
    ...
    public class PetsView implements IInventoryView, _SafeStr_3140 
    {
        ...
        public function addPet(_arg_1:_SafeStr_1573):void
        {
            ...
            var _local_2:PetsGridItem = new PetsGridItem(this, _arg_1, _windowManager, _SafeStr_3745, _SafeStr_4619.isUnseen(_arg_1.id));
            if (_local_2 != null)
            {
        ...
        {
            _SafeStr_4619.placePetToRoom(_arg_1, _arg_2);
        }
        ...
        public function updateState():void
        {
            ...
            var _local_1:_SafeStr_24 = _SafeStr_4619.pets;
        ...
        public function getPetImage(_arg_1:_SafeStr_1573, _arg_2:int, _arg_3:Boolean, _arg_4:PetsGridItem=null, _arg_5:int=64, _arg_6:String=null):BitmapData
        {
            var _local_9:int;
            var _local_10:_SafeStr_1552 = _arg_1.figureData;
            ...
            var _local_12:_SafeStr_3248 = _roomEngine.getPetImage(_local_10.typeId, _local_10.paletteId, _local_8, new Vector3d((_arg_2 * 45)), _arg_5, this, _arg_3, _local_11, _local_13, _arg_6);
            if (_local_12 != null)
            {
        ...
        private function updateGrid():void
        {
            ...
            var _local_2:Array = ((_SafeStr_4619.pets) ? _SafeStr_4619.pets.getKeys() : []);
            _SafeStr_5384.lock();
            ...
            for each (_local_4 in _local_2)
            {
                ...
                {
                    addPet(_SafeStr_4619.pets.getValue(_local_4));
                };
        ...
        private function startPlacingHandler(_arg_1:WindowMouseEvent):void
        {
            ...
            var _local_2:_SafeStr_1573 = _SafeStr_5575.pet;
            if (_local_2 == null)
            {
                return;
            };
        ...
        {
            if (_SafeStr_4619.controller.currentCategoryId != "pets")
            {
                return;
            };
        ...
        private function updatePreview(_arg_1:PetsGridItem=null):void
        {
            ...
            var _local_10:_SafeStr_3264 = (_SafeStr_3882.findChildByName("preview_image") as _SafeStr_3264);
            if (_local_10 != null)
            {
            ...
            _local_15.dispose();
            var _local_6:ITextWindow = (_SafeStr_3882.findChildByName("preview_text") as ITextWindow);
            if (_local_6 != null)
            {
                _local_6.caption = _local_8;
            };
            _local_6 = (_SafeStr_3882.findChildByName("preview_description") as ITextWindow);
            if (_local_6 != null)
            {
            ...
            {
                _local_12 = _SafeStr_4619.roomSession.arePetsAllowed;
                _local_13 = _SafeStr_4619.roomSession.isRoomOwner;
            };
            var _local_2:String = "";
            if (!_local_13)
            {
            ...
            var _local_9:_SafeStr_3122 = (_SafeStr_3882.findChildByName("place_button") as _SafeStr_3122);
            if (_local_9 != null)
            {
        ...
        {
            var _local_1:* = null;
            _SafeStr_3882 = _SafeStr_4619.controller.view.getView("pets");
