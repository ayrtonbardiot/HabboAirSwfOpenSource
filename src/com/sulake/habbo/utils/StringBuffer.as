...
//com.sulake.habbo.utils.StringBuffer
...
package com.sulake.habbo.utils
{
    ...
    public class StringBuffer 
    {
        ...
        public function StringBuffer(_arg_1:uint=0, _arg_2:String=null):void
        {
        ...
        public function appendChars(... _args):StringBuffer
        {
            var _local_3:ByteArray = this.buffer;
            for each (var _local_2:* in _args)
            {
        ...
        public function appendInts(... _args):StringBuffer
        {
            var _local_3:ByteArray = this.buffer;
            for each (var _local_2:* in _args)
            {
        ...
        {
            buffer.writeUTFBytes(_arg_1);
            return (this);
        }

        public function appendStrings(... _args):StringBuffer
        {
            var _local_3:ByteArray = this.buffer;
            for each (var _local_2:* in _args)
            {
        ...
        {
            var _local_4:* = null;
            _local_4 = _arg_1.buffer;
            var _local_5:uint = _local_4.length;
            var _local_6:uint = (_arg_2 + _arg_3);
        ...
        public function count(_arg_1:String):uint
        {
            ...
            _local_7 = (_local_3.position - _local_7);
        ...
        public function countChar(_arg_1:int):uint
        {
            ...
            {
                _local_3 = (_local_3 + (_local_2[_local_5] == _arg_1));
                ++_local_5;
            };
            return (_local_3);
        }
        ...
        public function insertChars(_arg_1:uint, ... _args):StringBuffer
        {
            var _local_4:ByteArray = this.buffer;
            if (_arg_1 > length)
            {
                appendCharArray(_args);
                return (this);
            };
            ...
            for each (var _local_3:* in _args)
            {
        ...
        public function insertInts(_arg_1:uint, ... _args):StringBuffer
        {
            var _local_4:ByteArray = this.buffer;
            if (_arg_1 > length)
            {
                appendIntArray(_args);
                return (this);
            };
            var _local_5:uint = _local_4.position;
            if (_arg_1 < _local_4.position)
        ...
        public function insertStrings(_arg_1:uint, ... _args):StringBuffer
        {
            var _local_4:ByteArray = this.buffer;
            if (_arg_1 > length)
            {
                appendStringArray(_args);
                return (this);
            };
            var _local_5:uint = _local_4.position;
            if (_arg_1 < _local_4.position)
        ...
        public function indexOf(_arg_1:String, _arg_2:uint=0):Number
        {
            ...
            while (_local_6--)
            {
                ...
                {
                    if (++_local_7 == _local_5.length) break;
                }
                else
                {
                    _local_7 = 0;
            ...
            _local_7 = (_local_4.position - _local_7);
        ...
        public function indexOfChar(_arg_1:int, _arg_2:uint=0):Number
        {
            ...
            while (_local_5--)
            {
                if (_local_4.readByte() == _arg_1) break;
            };
        ...
        public function lastIndexOf(_arg_1:String, _arg_2:uint=0xFFFFFFFF):Number
        {
            var _local_7:uint;
            var _local_8:uint;
            if (((!(_arg_1)) || (_arg_2 >= length)))
            ...
            while (_local_6--)
            {
                if (_local_4.readByte() == _local_5[_local_7])
                {
                    ...
                    {
                        _local_8 = (_local_4.position - _local_7);
                        _local_7 = 0;
                        _local_7;
                    };
                }
        ...
        public function lastIndexOfChar(_arg_1:int, _arg_2:uint=0xFFFFFFFF):Number
        {
            var _local_3:* = null;
            if (_arg_2 >= length)
            {
        ...
        public function replaceBytes(_arg_1:uint, _arg_2:uint, _arg_3:ByteArray, _arg_4:uint=0):StringBuffer
        {
            ...
            while (((_arg_1 < _arg_2) & (_local_7 < _local_6)))
            {
        ...
        public function size():uint
        {
            ...
            return (_local_4 - (1 * (!(_local_3 == 0))));
        }

        public function subbuf(_arg_1:uint=0, _arg_2:uint=0xFFFFFFFF):StringBuffer
        {
        ...
        public function subbuffer(_arg_1:uint, _arg_2:uint=0xFFFFFFFF):StringBuffer
        {
            var _local_3:StringBuffer = new StringBuffer();
        ...
        public function substr(_arg_1:uint=0, _arg_2:uint=0xFFFFFFFF):String
        {
            if (_arg_2)
            {
                return (toString(_arg_1, Math.min((_arg_1 + _arg_2), 0xFFFFFFFF)));
            };
            return ("");
        }

        public function substring(_arg_1:uint, _arg_2:uint=0xFFFFFFFF):String
        {
            if (_arg_2 > _arg_1)
            {
