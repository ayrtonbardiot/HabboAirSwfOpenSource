...
//com.sulake.habbo.utils.animation.Juggler
...
package com.sulake.habbo.utils.animation
{
    ...
    public class Juggler implements _SafeStr_66 
    {

        public static const REMOVE_FROM_JUGGLER:String = "REMOVE_FROM_JUGGLER";

        private var _SafeStr_9097:Vector.<_SafeStr_66>;
        private var mElapsedTime:Number;

        public function Juggler()
        {
            mElapsedTime = 0;
            _SafeStr_9097 = new Vector.<_SafeStr_66>(0);
        }

        public function add(_arg_1:_SafeStr_66):void
        {
            var _local_2:* = null;
            if (((_arg_1) && (_SafeStr_9097.indexOf(_arg_1) == -1)))
            {
                _SafeStr_9097[_SafeStr_9097.length] = _arg_1;
        ...
        public function contains(_arg_1:_SafeStr_66):Boolean
        {
            return (!(_SafeStr_9097.indexOf(_arg_1) == -1));
        }

        public function remove(_arg_1:_SafeStr_66):void
        {
            if (_arg_1 == null)
            {
                return;
            ...
            var _local_2:int = _SafeStr_9097.indexOf(_arg_1);
            if (_local_2 != -1)
            {
                _SafeStr_9097[_local_2] = null;
            };
        }
        ...
        public function removeTweens(_arg_1:Object):void
        {
            ...
            _local_3 = (_SafeStr_9097.length - 1);
            while (_local_3 >= 0)
            {
                _local_2 = (_SafeStr_9097[_local_3] as Tween);
                if (((_local_2) && (_local_2.target == _arg_1)))
                {
                    _local_2.removeEventListener("REMOVE_FROM_JUGGLER", onRemove);
                    _SafeStr_9097[_local_3] = null;
                };
                _local_3--;
            };
        }
        ...
        public function purge():void
        {
            var _local_1:int;
            var _local_2:* = null;
            _local_1 = (_SafeStr_9097.length - 1);
            while (_local_1 >= 0)
            {
                _local_2 = (_SafeStr_9097[_local_1] as EventDispatcher);
                if (_local_2)
                {
                    _local_2.removeEventListener("REMOVE_FROM_JUGGLER", onRemove);
                };
                _SafeStr_9097[_local_1] = null;
                _local_1--;
            };
        }

        public function delayCall(_arg_1:Function, _arg_2:Number, ... _args):_SafeStr_66
        {
            if (_arg_1 == null)
            {
                return (null);
        ...
        public function repeatCall(_arg_1:Function, _arg_2:Number, _arg_3:int=0, ... _args):_SafeStr_66
        {
            if (_arg_1 == null)
            {
                return (null);
        ...
        public function tween(_arg_1:Object, _arg_2:Number, _arg_3:Object):_SafeStr_66
        {
            var _local_6:* = null;
            if (_arg_1 == null)
            {
        ...
        public function advanceTime(_arg_1:Number):void
        {
            var _local_2:int;
            var _local_5:* = null;
            var _local_4:int = _SafeStr_9097.length;
            var _local_3:int;
            ...
            {
                _local_5 = _SafeStr_9097[_local_2];
                if (_local_5)
                {
                    if (_local_3 != _local_2)
                    {
                        _SafeStr_9097[_local_3] = _local_5;
                        _SafeStr_9097[_local_2] = null;
                    };
            ...
            if (_local_3 != _local_2)
            {
                _local_4 = _SafeStr_9097.length;
                while (_local_2 < _local_4)
                {
                    _SafeStr_9097[_local_3++] = _SafeStr_9097[_local_2++];
                };
                _SafeStr_9097.length = _local_3;
            };
        }

        private function onRemove(_arg_1:Event):void
        {
            remove((_arg_1.target as _SafeStr_66));
        ...
        protected function get objects():Vector.<_SafeStr_66>
        {
            return (_SafeStr_9097);
        }
...
// _SafeStr_9097 = "_-ah" (String#9025, DoABC#3)
