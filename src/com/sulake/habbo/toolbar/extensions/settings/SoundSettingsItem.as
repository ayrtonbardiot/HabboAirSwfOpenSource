...
//com.sulake.habbo.toolbar.extensions.settings.SoundSettingsItem
...
package com.sulake.habbo.toolbar.extensions.settings
{
    ...
    public class SoundSettingsItem implements _SafeStr_13 
    {
        ...
        private var _SafeStr_6670:SoundSettingsView;

        public function SoundSettingsItem(_arg_1:SoundSettingsView, _arg_2:int, _arg_3:_SafeStr_3133):void
        {
            var _local_4:* = null;
            super();
            ...
            _window = _arg_3;
            _SafeStr_5574 = new MeMenuSoundSettingsSlider(this, (_window.findChildByName("volume_container") as _SafeStr_3133), _arg_1.toolbar.assets, 0, 1);
