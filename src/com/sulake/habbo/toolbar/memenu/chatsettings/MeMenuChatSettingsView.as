...
//com.sulake.habbo.toolbar.memenu.chatsettings.MeMenuChatSettingsView
...
package com.sulake.habbo.toolbar.memenu.chatsettings
{
    ...
    public class MeMenuChatSettingsView 
    {
        ...
        public function dispose():void
        {
            ...
            _SafeStr_4981.widget.toolbar.freeFlowChat.isDisabledInPreferences = ((!(_local_1 == null)) && (_local_1.isSelected));
            _window.dispose();
            _window = null;
            _SafeStr_4981 = null;
        }
        ...
        private function createWindow():void
        {
            var _local_3:int;
            var _local_1:* = null;
            var _local_2:XmlAsset = (_SafeStr_4981.widget.toolbar.assets.getAssetByName("me_menu_chat_settings_xml") as XmlAsset);
            ...
            _SafeStr_4981.window.visible = false;
            _local_3 = 0;
            _local_1 = null;
            ...
            _SafeStr_3158(_window.findChildByName("prefer_old_chat_checkbox")).isSelected = _SafeStr_4981.widget.toolbar.freeFlowChat.isDisabledInPreferences;
        }
        ...
        private function onButtonClicked(_arg_1:WindowMouseEvent):void
        {
            ...
            switch (_local_3)
            {
                ...
                case "prefer_old_chat_checkbox":
                    _SafeStr_4981.widget.toolbar.freeFlowChat.isDisabledInPreferences = _SafeStr_3158(_window.findChildByName("prefer_old_chat_checkbox")).isSelected;
                    if (!_SafeStr_4981.widget.toolbar.freeFlowChat.isDisabledInPreferences)
                    {
                        if (_SafeStr_4981.widget.toolbar.roomUI.chatContainer != null)
                        {
                            _SafeStr_4981.widget.toolbar.roomUI.chatContainer.setDisplayObject(_SafeStr_4981.widget.toolbar.freeFlowChat.displayObject);
                        };
                    }
                    else
                    {
                        _SafeStr_4981.widget.toolbar.freeFlowChat.clear();
                    };
                    return;
            };
        }
