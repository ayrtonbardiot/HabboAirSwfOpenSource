...
//com.sulake.habbo.toolbar.memenu.MeMenuNewIconLoader
...
package com.sulake.habbo.toolbar.memenu
{
    ...
    public class MeMenuNewIconLoader implements _SafeStr_1875 
    {
        ...
        private function onFigureUpdate(_arg_1:_SafeStr_195):void
        {
            if (disposed)
            {
                return;
        ...
        public function dispose():void
        {
            ...
            if (_SafeStr_6791 != null)
            {
                _toolbar.communicationManager.removeHabboConnectionMessageEvent(_SafeStr_6791);
                _SafeStr_6791 = null;
            };
            _toolbar = null;
        }
...
// _SafeStr_6791 = "_-o2" (String#8768, DoABC#4)
