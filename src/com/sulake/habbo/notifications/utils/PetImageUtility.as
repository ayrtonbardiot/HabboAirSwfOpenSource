...
//com.sulake.habbo.notifications.utils.PetImageUtility
...
package com.sulake.habbo.notifications.utils
{
    ...
    public class PetImageUtility 
    {
        ...
        public function getPetImage(_arg_1:int, _arg_2:int, _arg_3:String, _arg_4:int=3, _arg_5:Boolean=false, _arg_6:int=32, _arg_7:String=null):BitmapData
        {
            if (_roomEngine == null)
            {
                _SafeStr_14.log("Pet Image Utility; Pet image creation failed: Room engine is not defined");
                return (null);
            };
            ...
            var _local_10:uint;
            var _local_11:_SafeStr_3248 = _roomEngine.getPetImage(_arg_1, _arg_2, _local_9, new Vector3d((45 * _arg_4)), _arg_6, null, _arg_5, _local_10, null, _arg_7);
            if (_local_11 != null)
            {
