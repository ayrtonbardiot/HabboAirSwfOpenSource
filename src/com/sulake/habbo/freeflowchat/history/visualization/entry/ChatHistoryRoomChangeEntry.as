...
//com.sulake.habbo.freeflowchat.history.visualization.entry.ChatHistoryRoomChangeEntry
...
package com.sulake.habbo.freeflowchat.history.visualization.entry
{
    ...
    public class ChatHistoryRoomChangeEntry implements _SafeStr_3280 
    {
        ...
        public function ChatHistoryRoomChangeEntry(_arg_1:_SafeStr_1569, _arg_2:HabboFreeFlowChat)
        {
            var _local_4:TextField = new TextField();
            _local_4.defaultTextFormat = _SafeStr_3338.TEXT_FORMAT;
            ...
            _local_3.defaultTextFormat = _SafeStr_3338.TEXT_FORMAT_TIMESTAMP;
