...
//com.sulake.habbo.freeflowchat.viewer.visualization.ChatBubble
...
package com.sulake.habbo.freeflowchat.viewer.visualization
{
    ...
    public class ChatBubble extends Sprite 
    {
        ...
        public static const _SafeStr_8540:int = 15;
        ...
        public function ChatBubble(_arg_1:ChatItem, _arg_2:_SafeStr_3335, _arg_3:BitmapData, _arg_4:String, _arg_5:uint, _arg_6:HabboFreeFlowChat, _arg_7:int=-1, _arg_8:Boolean=false, _arg_9:int=-1)
        {
            var _local_21:int;
            var _local_24:int;
            var _local_25:* = null;
            ...
            _SafeStr_4532 = ((_arg_2.isAnonymous) ? null : new Bitmap(_arg_2.pointer));
            _SafeStr_4548 = _arg_8;
            var _local_22:* = 300;
            if (_arg_7 != -1)
            {
            ...
            _SafeStr_4533.cacheAsBitmap = true;
            _SafeStr_4533.defaultTextFormat = _arg_2.textFormat;
            _SafeStr_4533.styleSheet = _style.styleSheet;
            _SafeStr_4533.addEventListener("link", onTextLinkEvent);
            var _local_11:* = (_arg_1.chatType == 0);
            var _local_19:* = (_arg_1.chatType == 2);
            ...
            {
                _SafeStr_4533.htmlText = _local_16;
            }
            else
            {
                _local_24 = -1;
            ...
            var _local_15:int = Math.min(_local_22, ((_SafeStr_4533.textWidth + _arg_2.textFieldMargins.x) + _arg_2.textFieldMargins.width));
            var _local_10:int = ((_SafeStr_4533.textHeight + _arg_2.textFieldMargins.y) + _arg_2.textFieldMargins.height);
            ...
            if (!_style.isAnonymous)
            {
                ...
                _SafeStr_4532.y = (_local_10 - _arg_2.pointerOffsetToBubbleBottom);
            ...
            if (((!(_arg_3 == null)) && (!(_arg_2.faceOffset == null))))
            {
                ...
                _SafeStr_4536 = new Bitmap(_local_23);
                _SafeStr_4536.x = (_arg_2.faceOffset.x - (_local_23.width / 2));
                _SafeStr_4536.y = Math.max(1, (_arg_2.faceOffset.y - (_local_23.height / 2)));
                addChild(_SafeStr_4536);
            };
            _SafeStr_4533.width = Math.min(_local_12, (_SafeStr_4533.textWidth + _style.textFieldMargins.width));
            _SafeStr_4533.height = (_SafeStr_4533.textHeight + _style.textFieldMargins.height);
            _SafeStr_4533.x = _arg_2.textFieldMargins.x;
            _SafeStr_4533.y = _arg_2.textFieldMargins.y;
            ...
            if (((!(_style.isSystemStyle)) && (_SafeStr_4533.textHeight > 108)))
            {
                ...
                _SafeStr_4537.graphics.drawRect(0, 0, (_SafeStr_4533.textWidth + 5), (108 - _arg_2.textFieldMargins.height));
        ...
        public function dispose():void
        {
            ...
            if (_SafeStr_4537)
            {
                removeChild(_SafeStr_4537);
            };
            if (_SafeStr_4533)
            {
                _SafeStr_4533.removeEventListener("link", onTextLinkEvent);
            };
            removeChild(_SafeStr_4533);
            if (((!(_SafeStr_4536 == null)) && (!(_style.faceOffset == null))))
            {
                removeChild(_SafeStr_4536);
            };
            if (((_SafeStr_4532) && (_SafeStr_4532.parent)))
            {
                removeChild(_SafeStr_4532);
            };
...
// _SafeStr_8540 = "_-E1" (String#39756, DoABC#4)
