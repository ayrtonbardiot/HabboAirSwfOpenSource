...
//com.sulake.habbo.freeflowchat.viewer.visualization.style.ChatStyleLibrary
...
package com.sulake.habbo.freeflowchat.viewer.visualization.style
{
    ...
    public class ChatStyleLibrary implements _SafeStr_13, _SafeStr_3260 
    {
        ...
        public function ChatStyleLibrary(_arg_1:_SafeStr_21)
        {
            ...
            for each (var _local_11:XML in _local_8.child("style"))
            {
                ...
                {
                    _SafeStr_14.log(((("Error initializing chat style: " + _local_4) + ", error message: ") + e.message));
                };
            };
        }
        ...
        public function getStyle(_arg_1:int):_SafeStr_3366
        {
