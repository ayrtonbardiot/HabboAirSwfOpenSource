...
//com.sulake.habbo.ui.widget.furniture.contextmenu.MonsterPlantSeedContextMenuView
...
package com.sulake.habbo.ui.widget.furniture.contextmenu
{
    ...
    public class MonsterPlantSeedContextMenuView extends FurnitureContextInfoView 
    {
        ...
        public function MonsterPlantSeedContextMenuView(_arg_1:_SafeStr_3149)
        {
            super(_arg_1);
        }
        ...
        override protected function updateWindow():void
        {
            ...
            else
            {
                if (!_window)
                {
                    _local_1 = (XmlAsset(_SafeStr_4981.assets.getAssetByName("monsterplant_seed_menu")).content as XML);
                ...
                if (_arg_2.name == "button")
                {
                    switch (_arg_2.parent.name)
                    {
                        case "use":
                            ...
                            if (_local_4 != null)
                            {
                                _local_4.showPlantSeedConfirmationDialog(_SafeStr_3984);
                            };
                    };
                };
                _local_3 = true;
