...
//com.sulake.habbo.ui.widget.furniture.dimmer.DimmerViewAlphaSlider
...
package com.sulake.habbo.ui.widget.furniture.dimmer
{
    ...
    public class DimmerViewAlphaSlider 
    {
        ...
        public function set min(_arg_1:Number):void
        {
            ...
            setValue(_SafeStr_3882.selectedBrightness);
        }
        ...
        {
            return (int(((_arg_1 / _referenceWidth) * (_SafeStr_6404 - _SafeStr_6403))) + _SafeStr_6403);
        }
        ...
        private function buttonProcedure(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            _SafeStr_3882.selectedBrightness = getValue(_arg_2.x);
        }
