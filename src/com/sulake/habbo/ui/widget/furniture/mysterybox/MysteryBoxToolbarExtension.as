...
//com.sulake.habbo.ui.widget.furniture.mysterybox.MysteryBoxToolbarExtension
...
package com.sulake.habbo.ui.widget.furniture.mysterybox
{
    ...
    public class MysteryBoxToolbarExtension implements _SafeStr_13 
    {

        private static const _SafeStr_9025:String = "mystery_box_toolbar_extension_minimised";
        public static const KEY_COLORS:Dictionary = new Dictionary();

        private var _disposed:Boolean;
        private var _window:_SafeStr_3133;
        private var _SafeStr_3914:FurnitureContextMenuWidgetHandler;
        ...
        {
            var _local_1:XML = (_SafeStr_3914.widget.assets.getAssetByName("mystery_box_toolbar_extension").content as XML);
            _window = (_SafeStr_3914.container.windowManager.buildFromXML(_local_1) as _SafeStr_3133);
            _window.findChildByName("faq_link").visible = (!(_SafeStr_3914.container.config.getProperty("mysterybox.faq.url") == ""));
            _window.procedure = windowProcedure;
            _SafeStr_3914.container.toolbar.extensionView.attachExtension("mystery_box", _window);
            var _local_2:ISessionDataManager = _SafeStr_3914.container.sessionDataManager;
        ...
        private function windowProcedure(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            switch (_arg_1.target.name)
            {
                ...
                case "maximize_region":
                    ...
                    return;
                case "faq_link":
                    HabboWebTools.openWebPage(_SafeStr_3914.container.config.getProperty("mysterybox.faq.url"), "habboMain");
                    return;
            };
        }
        ...
        {
            return ((!(_SafeStr_3914 == null)) && (_SafeStr_3914.container.config.getBoolean("mystery_box_toolbar_extension_minimised")));
        }

        private function setMinimised(_arg_1:Boolean):void
        {
            if (((!(_SafeStr_3914 == null)) && (!(_window == null))))
            {
                if (_arg_1)
                {
                ...
                _SafeStr_3914.container.config.setProperty("mystery_box_toolbar_extension_minimised", _arg_1.toString());
            };
        }
        ...
        public function dispose():void
        {
            ...
            {
                _SafeStr_3914.container.toolbar.extensionView.detachExtension("mystery_box");
                _SafeStr_3914.container.sessionDataManager.events.removeEventListener("mbke_update", onKeysUpdated);
                _SafeStr_3914 = null;
            };
            _disposed = true;
        }
...
// _SafeStr_9025 = "_-MR" (String#39381, DoABC#4)
