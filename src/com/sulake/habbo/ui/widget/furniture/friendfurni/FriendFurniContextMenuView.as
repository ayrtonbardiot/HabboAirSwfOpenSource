...
//com.sulake.habbo.ui.widget.furniture.friendfurni.FriendFurniContextMenuView
...
package com.sulake.habbo.ui.widget.furniture.friendfurni
{
    ...
    public class FriendFurniContextMenuView extends FurnitureContextInfoView 
    {
        ...
        public function FriendFurniContextMenuView(_arg_1:_SafeStr_3149)
        {
            super(_arg_1);
        }
        ...
        override protected function updateWindow():void
        {
            ...
            else
            {
                ...
                {
                    _local_1 = (_SafeStr_4981.assets.getAssetByName("friendfurni_menu").content as XML);
                ...
                if (_arg_2.name == "button")
                {
                    switch (_arg_2.parent.name)
                    {
                        case "use":
                            ...
                            if (_local_4 != null)
                            {
                                _local_4.handler.container.connection.send(new _SafeStr_558(_SafeStr_3984.getId()));
                            };
                    };
                };
                _local_3 = true;
