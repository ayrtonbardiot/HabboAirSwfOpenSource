...
//com.sulake.habbo.ui.widget.contextmenu.ButtonMenuView
...
package com.sulake.habbo.ui.widget.contextmenu
{
    ...
    public class ButtonMenuView extends ContextInfoView 
    {
        ...
        public function ButtonMenuView(_arg_1:_SafeStr_3149)
        {
            super(_arg_1);
        }
        ...
        protected function showButtonGrid(_arg_1:String, _arg_2:Boolean=true):void
        {
            ...
            if (_local_5 > 0)
            {
                ...
                {
                    _local_8 = (_local_4[_local_6] as _SafeStr_3133);
                    _local_7 = (_local_8.findChildByTag("icon") as _SafeStr_3264);
                    if (_local_7)
                    {
        ...
        protected function showButton(_arg_1:String, _arg_2:Boolean=true, _arg_3:Boolean=true, _arg_4:Boolean=false, _arg_5:Boolean=false):void
        {
            ...
            var _local_6:_SafeStr_3133 = (_buttons.getListItemByName(_arg_1) as _SafeStr_3133);
            if (!_local_6)
            {
                return;
            };
            _local_6.visible = _arg_2;
            var _local_7:_SafeStr_3133 = (_local_6.getChildByName("button") as _SafeStr_3133);
        ...
        protected function buttonEventProc(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            if (disposed)
            {
                return;
            ...
            if (_arg_1.type == "WME_OVER")
            {
                ...
                else
                {
                    if (_arg_2.tags.indexOf("link") > -1)
                    {
                        ...
                        {
                            ITextWindow(_SafeStr_3133(_arg_2).getChildAt(0)).textColor = 9552639;
                        }
                        else
                        {
                            if (_arg_2.tags.indexOf("moderate") > -1)
                            {
                                ITextWindow(_SafeStr_3133(_arg_2).getChildAt(0)).textColor = 16756591;
                            };
                        };
                    };
                };
                ...
                {
                    ITextWindow(_SafeStr_3133(_arg_2).findChildByName("name")).textColor = 9552639;
                };
            }
            else
            {
                if (_arg_1.type == "WME_OUT")
                {
                    ...
                    else
                    {
                        if (_arg_2.tags.indexOf("link") > -1)
                        {
                            if (_arg_2.tags.indexOf("actions") > -1)
                            {
                                ITextWindow(_SafeStr_3133(_arg_2).getChildAt(0)).textColor = 0xFFFFFF;
                            }
                            else
                            {
                                if (_arg_2.tags.indexOf("moderate") > -1)
                                {
                                    ITextWindow(_SafeStr_3133(_arg_2).getChildAt(0)).textColor = 16744755;
                                };
                            };
                        };
                    };
                    if (_arg_2.name == "profile_link")
                    {
                        ITextWindow(_SafeStr_3133(_arg_2).findChildByName("name")).textColor = 0xFFFFFF;
                    };
                };
            };
        }
