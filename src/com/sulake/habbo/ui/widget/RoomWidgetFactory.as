...
//com.sulake.habbo.ui.widget.RoomWidgetFactory
        ...
        public function createWidget(_arg_1:String, _arg_2:IRoomWidgetHandler):IRoomWidget
        {
            ...
            switch (_arg_1)
            {
                case "RWE_CHAT_WIDGET":
                    return (new RoomChatWidget(_arg_2, _local_4, _local_3, _roomUI.localization, _roomUI, _SafeStr_3839++, _roomUI));
...
// _SafeStr_3839 = "_-V1i" (String#21729, DoABC#4)
