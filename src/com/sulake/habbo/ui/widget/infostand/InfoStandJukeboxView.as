...
//com.sulake.habbo.ui.widget.infostand.InfoStandJukeboxView
...
package com.sulake.habbo.ui.widget.infostand
{
    ...
    public class InfoStandJukeboxView extends InfoStandFurniView 
    {
        ...
        override protected function createWindow(_arg_1:String):void
        {
            ...
            var _local_5:* = null;
            var _local_10:* = null;
            var _local_4:XmlAsset = (_SafeStr_4981.assets.getAssetByName("jukebox_view") as XmlAsset);
        ...
        public function updateSongInfo(_arg_1:RoomWidgetSongUpdateEvent):void
        {
            ...
            if (_arg_1.songId == _SafeStr_4222)
            {
                _songName = _arg_1.songName;
                _SafeStr_5488 = _arg_1.songAuthor;
                updateNowPlaying((_SafeStr_4222 >= 0));
            };
        }
        ...
        {
            var _local_2:* = null;
            var _local_3:ITextWindow = (_SafeStr_5485.getListItemByName("now_playing_text") as ITextWindow);
            if (_local_3 != null)
            {
                if (_arg_1)
                {
                    _local_2 = _SafeStr_4981.localizations.getLocalization("infostand.jukebox.text.now.playing");
                }
                else
                {
                    _local_2 = _SafeStr_4981.localizations.getLocalization("infostand.jukebox.text.not.playing");
                };
            ...
            if (_arg_1)
            {
                ...
                nowPlayingAuthorName = _SafeStr_5488;
            }
            else
            {
                nowPlayingTrackName = "";
