...
//com.sulake.habbo.ui.widget.roomtools.RoomToolsInfoCtrl
...
package com.sulake.habbo.ui.widget.roomtools
{
    ...
    public class RoomToolsInfoCtrl extends RoomToolsCtrlBase 
    {
        ...
        public function showRoomInfo(_arg_1:Boolean, _arg_2:String, _arg_3:String, _arg_4:Array):void
        {
            if (!_window)
            {
                _window = (_SafeStr_4981.windowManager.buildFromXML((_assets.getAssetByName("room_tools_info_xml").content as XML)) as _SafeStr_3133);
        ...
        public function updatePosition():void
        {
            ...
            var _local_2:int = ((((_SafeStr_6103) ? -(_window.width) : 0) + _SafeStr_4981.getRoomToolbarRight()) + 12);
            var _local_1:int = ((_window.desktop.height - 55) - _window.height);
            var _local_3:int = _SafeStr_4981.getChatInputY();
        ...
        override public function setCollapsed(_arg_1:Boolean):void
        {
            ...
            var _local_3:int = ((((_SafeStr_6103) ? -(_window.width) : 0) + _SafeStr_4981.getRoomToolbarRight()) + 12);
            if (_SafeStr_6103)
            {
            ...
            _SafeStr_3336.runMotion(_local_2);
        }
        ...
        public function setToolbarCollapsed(_arg_1:Boolean):void
        {
            ...
            setCollapsed(_arg_1);
            var _local_2:Motion = new EaseOut(new MoveTo(_window, 100, (_SafeStr_4981.getRoomToolbarRight() + 12), _window.y), 1);
            _SafeStr_3336.runMotion(_local_2);
        }

        private function motionComplete(_arg_1:Motion):void
        {
            if (((_SafeStr_6103) && (_window)))
            {
        ...
        private function onWindowEvent(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            if (_arg_2.name == "tag1_region")
            {
                ...
                _local_3 = ((_SafeStr_6104[0] == null) ? "" : _SafeStr_6104[0]);
            };
            if (_arg_2.name == "tag2_region")
            {
                _local_4 = (_window.findChildByName("tag2") as ITextWindow);
                _local_3 = ((_SafeStr_6104[1] == null) ? "" : _SafeStr_6104[1]);
            };
            if (_local_4 != null)
            {
                switch (_arg_1.type)
...
// _SafeStr_6104 = "_-hW" (String#8649, DoABC#4)
