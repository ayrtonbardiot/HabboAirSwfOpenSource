...
//com.sulake.habbo.ui.handler.ChatWidgetHandler
...
package com.sulake.habbo.ui.handler
{
    ...
    public class ChatWidgetHandler implements IRoomWidgetHandler, _SafeStr_1875, _SafeStr_3140 
    {

        private var _SafeStr_4036:Boolean = false;
        private var _container:IRoomWidgetHandlerContainer = null;
        private var _avatarImageCache:_SafeStr_24 = null;
        private var _petImageCache:_SafeStr_24 = null;
        private var _avatarColorCache:_SafeStr_24 = null;
        private var _petImageIdToFigureString:_SafeStr_24 = null;
        private var _SafeStr_5005:Array = [];
        private var _connection:IConnection = null;
        private var _SafeStr_5816:Number = 0;
        private var _SafeStr_5817:Point = null;
        private var _SafeStr_5818:Vector3d = new Vector3d();
        private var _SafeStr_4981:RoomChatWidget;

        public function ChatWidgetHandler()
        {
            _avatarImageCache = new _SafeStr_24();
            _petImageCache = new _SafeStr_24();
            _avatarColorCache = new _SafeStr_24();
            _petImageIdToFigureString = new _SafeStr_24();
        }
        ...
        public function dispose():void
        {
            ...
            for each (var _local_2:BitmapData in _SafeStr_5005)
            {
                if (_local_2 != null)
                {
                    _local_2.dispose();
        ...
        {
            _SafeStr_4981.addChatMessage(_arg_1.message, _arg_1.name, _arg_1.locX, getUserImage(_arg_1.figure), _arg_1.color, _arg_1.notify);
        }
        ...
        private function updateWidgetPosition():void
        {
            ...
            if (_local_6 != null)
            {
                ...
                if (_SafeStr_5816 > 0)
                {
                    _local_3 = (_local_6.scale / _SafeStr_5816);
                };
                if (_SafeStr_5817 == null)
                {
                    _SafeStr_5818.x = 0;
                    _SafeStr_5818.y = 0;
                    _SafeStr_5818.z = 0;
                    _SafeStr_5817 = _local_6.getScreenPoint(_SafeStr_5818);
                    _SafeStr_5816 = (_local_6.scale - 10);
                };
                _local_7 = "";
                _local_8 = null;
                _SafeStr_5818.x = 0;
                _SafeStr_5818.y = 0;
                _SafeStr_5818.z = 0;
                _local_1 = _local_6.getScreenPoint(_SafeStr_5818);
                if (_local_1 != null)
                {
                    ...
                    if (((!(_local_1.x == _SafeStr_5817.x)) || (!(_local_1.y == _SafeStr_5817.y))))
                    {
                        _local_5 = PointMath.sub(_local_1, PointMath.mul(_SafeStr_5817, _local_3));
...
// _SafeStr_5816 = "_-t1R" (String#10027, DoABC#4)
// _SafeStr_5817 = "_-F1b" (String#6800, DoABC#4)
// _SafeStr_5818 = "_-KH" (String#6951, DoABC#4)
