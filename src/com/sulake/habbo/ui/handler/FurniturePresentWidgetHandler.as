...
//com.sulake.habbo.ui.handler.FurniturePresentWidgetHandler
...
package com.sulake.habbo.ui.handler
{
    ...
    public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, _SafeStr_3140 
    {
        ...
        public function processWidgetMessage(_arg_1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (_arg_1.type)
            {
                ...
                case "RWPOM_OPEN_PRESENT":
                    ...
                    if (_local_8.objectId != _SafeStr_4157)
                    {
                        return (null);
                    };
                    if (_container != null)
                                    ...
                                    if (_local_3 != null)
                                    {
                                        switch (_local_3.className)
                                        {
                                            ...
                                            case "poster":
                                                ...
                                                {
                                                    _local_8 = _local_14.replace("poster", "");
