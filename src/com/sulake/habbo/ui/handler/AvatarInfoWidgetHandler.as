...
//com.sulake.habbo.ui.handler.AvatarInfoWidgetHandler
...
package com.sulake.habbo.ui.handler
{
    ...
    public class AvatarInfoWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        private var _SafeStr_6079:IMessageEvent;
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                if (((_SafeStr_6079) && (_container.connection)))
                {
                    _container.connection.removeMessageEvent(_SafeStr_6079);
                };
                container = null;
                _SafeStr_4981 = null;
                if (_SafeStr_6080 != null)
                {
                    _SafeStr_6080.dispose();
                    _SafeStr_6080 = null;
                };
                _SafeStr_6079 = null;
                _disposed = true;
        ...
        public function set container(_arg_1:IRoomWidgetHandlerContainer):void
        {
            ...
            {
                _container.connection.removeMessageEvent(_SafeStr_6080);
            };
            if ((((_container) && (_container.connection)) && (_SafeStr_6079)))
            {
                _container.connection.removeMessageEvent(_SafeStr_6079);
            };
            _container = _arg_1;
            ...
            if (((!(_SafeStr_6079)) && (_container.connection)))
            {
                _SafeStr_6079 = new _SafeStr_270(onCustomUserNotificationMessage);
                _container.connection.addMessageEvent(_SafeStr_6079);
            };
            if ((((_container) && (_container.toolbar)) && (_container.toolbar.events)))
            {
            ...
            if (((_container) && (_container.connection)))
            {
                _container.connection.addMessageEvent(_SafeStr_6080);
            };
        }
        ...
        private function onPetStatusUpdate(_arg_1:RoomSessionPetStatusUpdateEvent):void
        {
            ...
            if (((!(_container == null)) && (!(_container.events == null))))
            {
                ...
                if (_local_7 == null)
                {
                    _SafeStr_14.log((("Could not find pet with the id: " + _arg_1.petId) + " given by petStatusUpdate"));
                    return;
                };
        ...
        private function dispatchOwnAvatarInfo():void
        {
            ...
            var _local_1:_SafeStr_3241 = _container.roomSession.userDataManager.getUserData(_local_4);
            if (_local_1)
            {
        ...
        public function processWidgetMessage(_arg_1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (message.type)
            {
                ...
                case "RWUAM_REQUEST_PET_UPDATE":
                    _SafeStr_4981.handlePetInfo = false;
                    break;
                ...
                case "RWUAM_COMPOST_PLANT":
                    var localization:_SafeStr_18 = _SafeStr_4981.catalog.localization;
                    _SafeStr_4981.windowManager.confirm(localization.getLocalization("monsterplant.confirm.title.compost"), localization.getLocalization("monsterplant.confirm.desc.compost"), 0, (function ():*
                    {
                        var onCompostConfirmed:Function = function (_arg_1:_SafeStr_3198, _arg_2:_SafeStr_3116):void
                        {
                            _arg_1.dispose();
        ...
        public function processEvent(_arg_1:Event):void
        {
            ...
            switch (_arg_1.type)
            {
                case "rsudue_user_data_updated":
                    ...
                    for each (var _local_3:_SafeStr_3241 in RoomSessionUserDataUpdateEvent(_arg_1).addedUsers)
                    {
                        if (friendList.getFriendNames().indexOf(_local_3.name) > -1)
                        {
                            _SafeStr_4981.showUserName(_local_3, _local_3.roomObjectId);
                        };
                    };
                    return;
                case "RSDE_DANCE":
                    _local_2 = (_arg_1 as RoomSessionDanceEvent);
                    if ((((((_local_2) && (_SafeStr_4981)) && (container)) && (container.roomSession)) && (container.roomSession.userDataManager)))
                    {
                        ...
                        {
                            _SafeStr_4981.isDancing = (!(_local_2.danceStyle == 0));
                        };
                    };
                    return;
        ...
        {
            _SafeStr_14.log(("Show breed menu. finally: " + _arg_1));
            ...
            var _local_6:_SafeStr_3241 = _container.roomSession.userDataManager.getUserDataByType(_arg_1, 2);
            if (_local_6 == null)
            {
                return;
            };
        ...
        private function onNestBreedingSuccessEvent(_arg_1:RoomSessionNestBreedingSuccessEvent):void
        {
            if (((!(_container == null)) && (!(_container.events == null))))
            {
                _SafeStr_4981.showNestBreedingSuccess(_arg_1.petId, _arg_1.rarityCategory);
            };
        }
        ...
        private function handleUseProductMenuRequestInventoryItem(_arg_1:int, _arg_2:int):void
        {
            ...
            var _local_3:int = _container.sessionDataManager.userId;
            var _local_5:_SafeStr_3130 = _container.sessionDataManager.getFloorItemData(_arg_2);
            if (!_local_5)
            {
                return;
            };
        ...
        private function handleUseProductMenuRequestRoomObject(_arg_1:int):void
        {
            ...
            var _local_5:_SafeStr_3130 = getFurniData(_local_7);
            var _local_4:Array = _local_5.customParams.split(" ");
        ...
        private function activateUseProductMenuForPets(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int, _arg_6:int=-1):void
        {
            ...
            _SafeStr_4981.showUseProductMenuForItems(_local_13);
        }
        ...
        private function activateBreedMenuForPets(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int):void
        {
            ...
            _SafeStr_4981.showBreedPetMenuForItems(_local_11);
        }

        private function findPetWithWebId(_arg_1:int):_SafeStr_3241
        {
            var _local_4:int;
            var _local_2:* = null;
            var _local_6:* = null;
        ...
        public function onCustomUserNotificationMessage(_arg_1:_SafeStr_270):void
        {
...
// _SafeStr_6079 = "_-HG" (String#7033, DoABC#4)
