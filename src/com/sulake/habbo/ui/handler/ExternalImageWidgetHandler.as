...
//com.sulake.habbo.ui.handler.ExternalImageWidgetHandler
...
package com.sulake.habbo.ui.handler
{
    ...
    public class ExternalImageWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        private var _SafeStr_4981:ExternalImageWidget;
        ...
        public function processEvent(_arg_1:Event):void
        {
            ...
            if ((_arg_1 is RoomEngineUseProductEvent))
            {
                ...
                {
                    _SafeStr_4981.showWithFurniID(_local_2.objectId);
                };
            };
            ...
            switch (_arg_1.type)
            {
                case "RETWE_OPEN_WIDGET":
                    if (_local_3 != null)
                    {
                        _SafeStr_4981.showWithRoomObject(_local_3);
                    };
                    return;
