...
//com.sulake.habbo.ui.handler.InfoStandWidgetHandler
...
package com.sulake.habbo.ui.handler
{
    ...
    public class InfoStandWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        private var _SafeStr_6045:_SafeStr_24 = new _SafeStr_24();
        private var _SafeStr_3976:_SafeStr_3169;
        private var _SafeStr_4981:InfoStandWidget;
        private var _SafeStr_6043:IMessageEvent;
        private var _SafeStr_6044:IMessageEvent;

        public function InfoStandWidgetHandler(_arg_1:_SafeStr_3169)
        {
            _SafeStr_3976 = _arg_1;
            if (_SafeStr_3976 != null)
            {
                _SafeStr_3976.events.addEventListener("NPE_SONG_CHANGED", onNowPlayingChanged);
        ...
        public function set container(_arg_1:IRoomWidgetHandlerContainer):void
        {
            if (_container != null)
            {
                ...
                {
                    if (_SafeStr_6043 != null)
                    {
                        _container.connection.removeMessageEvent(_SafeStr_6043);
                        _SafeStr_6043.dispose();
                        _SafeStr_6043 = null;
                    };
                    if (_SafeStr_6044 != null)
                    {
                        _container.connection.removeMessageEvent(_SafeStr_6044);
                        _SafeStr_6044.dispose();
                        _SafeStr_6044 = null;
                    };
                };
            };
            ...
            {
                _SafeStr_6043 = new _SafeStr_785(onGroupDetails);
                _container.connection.addMessageEvent(_SafeStr_6043);
                _SafeStr_6044 = new _SafeStr_418(onRelationshipStatusEvent);
                _container.connection.addMessageEvent(_SafeStr_6044);
            };
        }
        ...
        private function onGroupDetails(_arg_1:_SafeStr_785):void
        {
            ...
            if (_SafeStr_4981.furniData.groupId == _local_2.groupId)
            {
                _SafeStr_4981.furniView.groupBadgeId = _local_2.badgeCode;
                _SafeStr_4981.furniView.groupName = _local_2.groupName;
            };
        }
        ...
        public function dispose():void
        {
            var _local_1:int;
            var _local_2:* = null;
            if (_SafeStr_6045 != null)
            {
                _local_1 = (_SafeStr_6045.length - 1);
                while (_local_1 >= 0)
                {
                    _local_2 = _SafeStr_6045.getWithIndex(_local_1);
                    if (_local_2)
                    {
                        _local_2.dispose();
                    };
                ...
                _SafeStr_6045.dispose();
                _SafeStr_6045 = null;
            };
            if (_SafeStr_3976 != null)
            {
                _SafeStr_3976.events.removeEventListener("NPE_SONG_CHANGED", onNowPlayingChanged);
        ...
        public function processWidgetMessage(_arg_1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (_arg_1.type)
            {
                ...
                case "RWUAM_PASS_CARRY_ITEM":
                    _container.connection.send(new _SafeStr_700(_local_20));
                    break;
                case "RWUAM_GIVE_CARRY_ITEM_TO_PET":
                    _container.connection.send(new _SafeStr_419(_local_20));
                    break;
                case "RWUAM_GIVE_WATER_TO_PET":
                    _container.connection.send(new _SafeStr_698(_local_20, 0));
                    break;
                case "RWUAM_GIVE_LIGHT_TO_PET":
                    _container.connection.send(new _SafeStr_698(_local_20, 1));
                    break;
                case "RWUAM_TREAT_PET":
                    _container.connection.send(new _SafeStr_801(_local_20));
                    break;
                case "RWUAM_DROP_CARRY_ITEM":
                    _container.connection.send(new _SafeStr_321());
                    break;
                case "RWFUAM_ROTATE":
                ...
                case "RWGOI_MESSAGE_GET_BADGE_IMAGE":
                    ...
                    {
                        _SafeStr_4981.refreshBadge(_local_15.badgeId);
                    };
                    break;
                case "RWUAM_REPORT":
                ...
                case "RWOPEM_OPEN_USER_PROFILE":
                    ...
                    _container.connection.send(new _SafeStr_313(_local_16.userId));
                    break;
                case "RWPOM_OPEN_PRESENT":
                    _local_9 = (_arg_1 as RoomWidgetPresentOpenMessage);
                    if (((!(_local_9 == null)) && (!(_SafeStr_4981 == null))))
                    {
                        _local_10 = _SafeStr_4981.furniData;
                        if (((!(_local_10 == null)) && (_local_10.id == _local_9.objectId)))
                        {
                            if (_SafeStr_4981.isFurniViewVisible())
                            {
                                _SafeStr_4981.close();
                            };
                        };
        ...
        {
            var furniId = _arg_1;
            var furniCategory = _arg_2;
            if (_container != null)
            {
                if (((_SafeStr_3270.isBuilderClubId(furniId)) && (_container.catalog.buildersClubEnabled)))
                {
                    if (_SafeStr_4981.furniData.availableForBuildersClub)
                    {
                        _container.roomEngine.modifyRoomObject(furniId, furniCategory, "OBJECT_PICKUP");
                    }
                    else
                    {
                        _container.windowManager.confirm("${generic.alert.title}", "${room.confirm.not_in_warehouse}", 0, function (_arg_1:_SafeStr_3198, _arg_2:_SafeStr_3116):void
                        {
                            _arg_1.dispose();
        ...
        private function handleGetObjectNameMessage(_arg_1:RoomWidgetRoomObjectMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (_arg_1.category)
            {
                ...
                case 20:
                    ...
                    {
                        _local_12 = _local_4.replace("poster", "");
        ...
        private function handleGetPetInfoMessage(_arg_1:int):void
        {
            ...
            if (_local_2)
            {
                _container.connection.send(new _SafeStr_300(_arg_1));
            };
            _container.roomSession.userDataManager.requestPetInfo(_arg_1);
        }

        private function handleGetBotInfoMessage(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:_SafeStr_3241):void
        {
        ...
        private function handleGetRentableBotInfoMessage(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:_SafeStr_3241):void
        {
        ...
        private function handleGetUserInfoMessage(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:_SafeStr_3241):void
        {
            var _local_7:* = null;
            var _local_5:* = null;
            var _local_6:* = null;
            ...
            if (_local_7 == "RWUIUE_PEER")
            {
                ...
                if (_local_13 != null)
                {
                    ...
                    _SafeStr_14.log(((((((("Set moderation levels to " + _local_5.name) + "Muted: ") + _local_5.canBeMuted) + ", Kicked: ") + _local_5.canBeKicked) + ", Banned: ") + _local_5.canBeBanned));
                };
            ...
            _local_5.groupId = _arg_4.groupID;
            _local_5.groupBadgeId = _container.sessionDataManager.getGroupBadgeId(_arg_4.groupID);
            ...
            _container.connection.send(new _SafeStr_691(_arg_4.webID));
        }

        private function determineCanBeMuted(_arg_1:RoomWidgetUserInfoUpdateEvent):Boolean
        {
            var userInfo = _arg_1;
            var settingsFunction:Function = function (_arg_1:RoomWidgetUserInfoUpdateEvent, _arg_2:_SafeStr_1625):Boolean
            {
        ...
        private function determineModerationLevel(_arg_1:RoomWidgetUserInfoUpdateEvent, _arg_2:Function):Boolean
        {
            ...
            var _local_3:_SafeStr_1625 = _container.roomSession.roomModerationSettings;
            if (_local_3 != null)
            {
        ...
        private function handleGetFurniInfoMessage(_arg_1:RoomWidgetRoomObjectMessage, _arg_2:int):void
        {
            ...
            var _local_10:IStuffData = _SafeStr_1588.getStuffDataWrapperForType(_local_16);
            ...
            {
                _local_8 = _local_11.replace("poster", "");
            ...
            var _local_13:_SafeStr_3248 = _container.roomEngine.getRoomObjectImage(_arg_2, _arg_1.id, _arg_1.category, new Vector3d(180), 64, null);
            ...
            if (_local_6 != 0)
            {
                ...
                container.connection.send(new _SafeStr_197(_local_6, false));
            };
            ...
            if (((!(_local_20.extraParam == null)) && (_local_20.extraParam.length > 0)))
            {
                ...
                {
                    _local_5 = _SafeStr_3976.getRoomItemPlaylist();
                    if (_local_5 != null)
                    {
                ...
                if (_local_17 != -1)
                {
                    _local_18 = _SafeStr_3976.getSongInfo(_local_17);
                    if (_local_18 != null)
                    {
        ...
        public function processEvent(_arg_1:Event):void
        {
            ...
            switch (_arg_1.type)
            {
                case "RSUBE_BADGES":
                    ...
                    if (((!(_local_2 == null)) && (!(_SafeStr_4981 == null))))
                    {
                        _SafeStr_4981.refreshBadges(_local_2.userId, _local_2.badges);
                    };
                    return;
            };
        }
        ...
        private function onFigureUpdate(_arg_1:RoomSessionUserFigureUpdateEvent):void
        {
            ...
            var _local_2:_SafeStr_3241 = _container.roomSession.userDataManager.getUserDataByIndex(_arg_1.userId);
            if (_local_2 == null)
            {
                return;
            };
            ...
            var _local_4:* = (_local_5 == _container.sessionDataManager.userId);
            _SafeStr_4981.updateUserData(_local_5, _arg_1.figure, _arg_1.achievementScore, _arg_1.customInfo, _local_4);
        }
        ...
        private function onPetInfo(_arg_1:RoomSessionPetInfoUpdateEvent):void
        {
            ...
            var _local_10:_SafeStr_3241 = _container.roomSession.userDataManager.getPetUserData(_local_5.petId);
            if (_local_10 == null)
            {
                return;
            };
            ...
            var _local_11:BitmapData = (_SafeStr_6045.getValue(_local_3) as BitmapData);
            if (_local_11 == null)
            {
                _local_11 = getPetImage(_local_2, _local_7);
                _SafeStr_6045.add(_local_3, _local_11);
            };
        ...
        private function onPetFigureUpdate(_arg_1:RoomSessionPetFigureUpdateEvent):void
        {
            ...
            var _local_4:BitmapData = (_SafeStr_6045.getValue(_local_2) as BitmapData);
            if (_local_4 == null)
            {
                _local_4 = getPetImage(_local_2);
                _SafeStr_6045.add(_local_2, _local_4);
            };
            if (((!(_container == null)) && (!(_container.events == null))))
            {
        ...
        private function onConfirmPetBreedingEvent(_arg_1:RoomSessionConfirmPetBreedingEvent):void
        {
            ...
            if (((!(_container == null)) && (!(_container.events == null))))
            {
                ...
                _local_6 = [];
                for each (var _local_2:_SafeStr_1596 in _arg_1.rarityCategories)
                {
        ...
        private function onFavouriteGroupUpdated(_arg_1:RoomSessionFavouriteGroupUpdateEvent):void
        {
            if (_SafeStr_4981)
            {
                _SafeStr_4981.favouriteGroupUpdated(_arg_1.roomIndex, _arg_1.habboGroupId, _arg_1.status, _arg_1.habboGroupName);
            };
        }
        ...
        private function getPetImage(_arg_1:String, _arg_2:String=null):BitmapData
        {
            ...
            var _local_5:uint;
            var _local_6:_SafeStr_3248 = _container.roomEngine.getPetImage(_local_3.typeId, _local_3.paletteId, _local_3.color, new Vector3d(90), 64, null, true, _local_5, _local_3.customParts, _arg_2);
            if (_local_6 != null)
            {
        ...
        private function onNowPlayingChanged(_arg_1:NowPlayingEvent):void
        {
            ...
            if (_SafeStr_3976 != null)
            {
                ...
                if (_local_3 != -1)
                {
                    _local_4 = _SafeStr_3976.getSongInfo(_local_3);
                    if (_local_4 != null)
                    {
        ...
        private function onRelationshipStatusEvent(_arg_1:_SafeStr_418):void
        {
            if (((_SafeStr_4981) && (_SafeStr_4981.mainWindow.visible)))
            {
                _SafeStr_4981.setRelationshipStatus(_arg_1.userId, _arg_1.relationshipStatusMap);
            };
        }
        ...
        public function setObjectData(_arg_1:_SafeStr_24):void
        {
            if (_container.sessionDataManager.hasSecurity(5))
            {
                _container.connection.send(new _SafeStr_624(_SafeStr_4981.furniData.id, _arg_1));
            };
        }
...
// _SafeStr_321 = "_-2Y" (String#29532, DoABC#4)
...
// _SafeStr_419 = "_-Em" (String#29865, DoABC#4)
// _SafeStr_4981 = "_-o1H" (String#37, DoABC#4)
// _SafeStr_6043 = "_-G1E" (String#7925, DoABC#4)
// _SafeStr_6044 = "_-22J" (String#8567, DoABC#4)
// _SafeStr_6045 = "_-m1m" (String#5580, DoABC#4)
// _SafeStr_624 = "_-I1v" (String#13654, DoABC#4)
// _SafeStr_691 = "_-b1s" (String#15927, DoABC#4)
// _SafeStr_698 = "_-e9" (String#18971, DoABC#4)
// _SafeStr_700 = "_-NQ" (String#30171, DoABC#4)
