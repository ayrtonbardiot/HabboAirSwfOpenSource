...
//com.sulake.habbo.ui.handler.MeMenuWidgetHandler
...
package com.sulake.habbo.ui.handler
{
    ...
    public class MeMenuWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        {
            _SafeStr_14.log("[MeMenuWidgetHandler]");
        }
        ...
        public function processWidgetMessage(_arg_1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (_arg_1.type)
            {
                ...
                case "RWGOI_MESSAGE_OPEN_INVENTORY":
                    ...
                    if (_inventory != null)
                    {
                        _SafeStr_14.log(("MeMenuWidgetHandler open inventory: " + _local_5.inventoryType));
                        switch (_local_5.inventoryType)
                        {
                            ...
                            case "inventory_clothes":
                                break;
                            default:
                                _SafeStr_14.log(("MeMenuWidgetHandler: unknown inventory type: " + _local_5.inventoryType));
                        };
                    };
                    break;
                case "RWCM_MESSAGE_UNSELECT_ALL_EFFECTS":
                case "RWGOI_MESSAGE_STOP_EFFECT":
                    _SafeStr_14.log("STOP ALL EFFECTS");
                    if (_inventory != null)
                    {
                ...
                case "RWGOI_MESSAGE_NAVIGATE_HOME":
                    _SafeStr_14.log("MeMenuWidgetHandler: GO HOME");
                    if (_container != null)
                    {
                ...
                case "RWCM_OPEN_AVATAR_EDITOR":
                    _SafeStr_14.log("MeMenuWidgetHandler: Open avatar editor...");
                    if (_container)
                    {
                ...
                case "RWSSM_STORE_CHAT":
                    ...
                    break;
                default:
                    _SafeStr_14.log(("Unhandled message in MeMenuWidgetHandler: " + _arg_1.type));
            };
            return (null);
        }
        ...
        private function onAvatarEffectsChanged(_arg_1:Event=null):void
        {
            ...
            _SafeStr_14.log("[MeMenuWidgetHandler] Received Avatar Effects Have Changed Event...\t");
            if (_inventory != null)
            {
