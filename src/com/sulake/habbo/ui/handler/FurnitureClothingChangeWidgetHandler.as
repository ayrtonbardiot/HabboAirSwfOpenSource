...
//com.sulake.habbo.ui.handler.FurnitureClothingChangeWidgetHandler

package com.sulake.habbo.ui.handler
{
    import com.sulake.habbo.ui.IRoomWidgetHandler;
    import com.sulake.habbo.avatar._SafeStr_3223;
    ...
    public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, _SafeStr_3223 
    {
            ...
            switch (_arg_1.type)
            {
                ...
                case "RWCCM_REQUEST_EDITOR":
                    ...
                    if (_local_4 != null)
                    {
                        ...
                        if (_local_9 != null)
                        {
                            _SafeStr_4157 = _local_7.objectId;
                            _local_5 = "M";
        ...
        public function saveFigure(_arg_1:String, _arg_2:String):void
        {
            ...
            _container.roomSession.sendUpdateClothingChangeFurniture(_SafeStr_4157, _arg_2, _arg_1);
            _container.avatarEditor.close(1);
        }
