...
//com.sulake.habbo.game.snowwar.leaderboard.WeeklyGroupLeaderboardTable
...
package com.sulake.habbo.game.snowwar.leaderboard
{
    ...
    public class WeeklyGroupLeaderboardTable extends TotalGroupLeaderboardTable 
    {
        ...
        {
            return (new Game2GetWeeklyGroupLeaderboardComposer(_arg_1, _offset, _arg_2, _arg_3, _SafeStr_6621, _SafeStr_6622));
        }
