...
//com.sulake.habbo.game.snowwar.utils.CollisionDetection
...
package com.sulake.habbo.game.snowwar.utils
{
    public class CollisionDetection 
    {
        ...
        public static function testForObjectToObjectCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
            if (_arg_2 == _arg_1)
            {
                return (false);
        ...
        private static function testPointToCircleCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
            return (_arg_1.location3D.isInDistance(_arg_2.location3D, _arg_2.boundingData[0]));
        }

        private static function testPointToBoxCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
        ...
        private static function testCircleToCircleCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
            return (_arg_1.location3D.isInDistance(_arg_2.location3D, (_arg_1.boundingData[0] + _arg_2.boundingData[0])));
        }

        private static function testPointToTripleCircleCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
            ...
            var _local_5:int = int((_arg_2.location3D.x + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorXComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[3]) / 0x0100))));
            var _local_6:int = int((_arg_2.location3D.y + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorYComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[3]) / 0x0100))));
            ...
            var _local_3:int = int((_arg_2.location3D.x + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorXComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[4]) / 0x0100))));
            var _local_4:int = int((_arg_2.location3D.y + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorYComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[4]) / 0x0100))));
        ...
        private static function testCircleToTripleCircleCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
            var _local_8:int = absoluteValue((_arg_2.location3D.x - _arg_1.location3D.x));
        ...
        private static function testTripleCircleToTripleCircleCollision(_arg_1:_SafeStr_3362, _arg_2:_SafeStr_3362):Boolean
        {
            ...
            var _local_5:int = int((_arg_1.location3D.x + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorXComponent(_arg_1.direction360.intValue()) * _arg_1.boundingData[3]) / 0x0100))));
            var _local_3:int = int((_arg_1.location3D.y + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorYComponent(_arg_1.direction360.intValue()) * _arg_1.boundingData[3]) / 0x0100))));
            var _local_12:int = int((_arg_2.location3D.x + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorXComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[3]) / 0x0100))));
            var _local_6:int = int((_arg_2.location3D.y + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorYComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[3]) / 0x0100))));
            ...
            var _local_4:int = int((_arg_2.location3D.x + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorXComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[4]) / 0x0100))));
            var _local_8:int = int((_arg_2.location3D.y + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorYComponent(_arg_2.direction360.intValue()) * _arg_2.boundingData[4]) / 0x0100))));
            ...
            var _local_9:int = int((_arg_1.location3D.x + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorXComponent(_arg_1.direction360.intValue()) * _arg_1.boundingData[4]) / 0x0100))));
            var _local_7:int = int((_arg_1.location3D.y + _SafeStr_3442.javaDiv(((Direction360.getBaseVectorYComponent(_arg_1.direction360.intValue()) * _arg_1.boundingData[4]) / 0x0100))));
