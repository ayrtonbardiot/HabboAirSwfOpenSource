...
//com.sulake.habbo.game.snowwar.utils.Direction360

package com.sulake.habbo.game.snowwar.utils
{
    import com.sulake.core.runtime._SafeStr_13;

    public class Direction360 implements _SafeStr_13 
    {

        private static const _SafeStr_8601:Number = 1;
        ...
        {
            return (Direction8.getDirection8(Direction8.validateDirection8Value((_SafeStr_3442.javaDiv((validateDirection360Value((_arg_1 - 22)) / 45)) + 1))));
        }
        ...
        public static function getAngleFromComponents(_arg_1:int, _arg_2:int):int
        {
            ...
            if (absoluteValue(_arg_1) <= absoluteValue(_arg_2))
            {
                ...
                _local_3 = int(_SafeStr_3442.javaDiv((_arg_1 / _arg_2)));
                if (_local_3 < 0)
                {
                    _local_3 = -(_local_3);
                };
            ...
            _local_3 = int(_SafeStr_3442.javaDiv((_arg_2 / _arg_1)));
            if (_local_3 < 0)
            {
                _local_3 = -(_local_3);
            };
        ...
        {
            return (_SafeStr_6903);
        }

        public function setIntValue(_arg_1:int):void
        {
            _SafeStr_6903 = validateDirection360Value(_arg_1);
        }

        public function rotateDirection(_arg_1:int):void
        {
            _SafeStr_6903 = (_SafeStr_6903 + _arg_1);
            _SafeStr_6903 = validateDirection360Value(_SafeStr_6903);
        }
        ...
        {
            return (direction360ValueToDirection8(_SafeStr_6903));
        }

        public function getBaseVectorXComponent():int
        {
            return (_SafeStr_6902[0][_SafeStr_6903]);
        }

        public function getBaseVectorYComponent():int
        {
            return (_SafeStr_6902[1][_SafeStr_6903]);
        }
...
// _SafeStr_6902 = "_-fI" (String#11437, DoABC#4)
// _SafeStr_6903 = "_-61u" (String#4916, DoABC#4)
// _SafeStr_8601 = "_-h1t" (String#35661, DoABC#4)
