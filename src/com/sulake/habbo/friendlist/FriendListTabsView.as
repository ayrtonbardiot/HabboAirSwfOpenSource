...
//com.sulake.habbo.friendlist.FriendListTabsView
...
package com.sulake.habbo.friendlist
{
    ...
    public class FriendListTabsView 
    {
        ...
        public function refresh(_arg_1:String):void
        {
            var _local_3:* = null;
            var _local_4:int;
            _SafeStr_14.log(("TABS: REFRESH: " + _arg_1));
            ...
            {
                _local_3 = (_content.getChildByName(("flt_" + _local_5.id)) as _SafeStr_3133);
            ...
            _SafeStr_14.log("TABS: REFRESH END");
        }
        ...
        private function refreshTabContent(_arg_1:FriendListTab, _arg_2:_SafeStr_3133):void
        {
            if (_arg_1.selected)
            {
                if (_arg_1.view == null)
                {
                    _arg_1.view = (this.getTabContent(_arg_1) as _SafeStr_3133);
                };
        ...
        private function refreshHeader(_arg_1:FriendListTab, _arg_2:_SafeStr_3133):int
        {
            var _local_3:_SafeStr_3133 = (_arg_2.getChildByName("header") as _SafeStr_3133);
            _local_3.width = _friendList.tabs.tabContentWidth;
            ...
            _SafeStr_14.log(((((("TAB " + _arg_1.id) + ", ") + _arg_1.name) + ", ") + _local_4));
        ...
        private function showBgImage(_arg_1:_SafeStr_3133, _arg_2:Boolean, _arg_3:String):void
        {
            _SafeStr_14.log(((("REFRESHING BG IMAGE: " + _arg_2) + ", ") + _arg_3));
            var _local_4:_SafeStr_3264 = (_arg_1.getChildByName(_arg_3) as _SafeStr_3264);
            if (!_arg_2)
            {
                if (_local_4 != null)
                {
        ...
        private function refreshArrowIcon(_arg_1:_SafeStr_3133, _arg_2:String, _arg_3:Boolean, _arg_4:int):void
        {
            var _local_5:* = null;
            var _local_6:* = null;
            ...
            if (_arg_3)
            {
                ...
                _local_6 = _SafeStr_3109(_arg_1.findChildByName(_arg_2));
                _local_6.x = (_local_5.textWidth + _arg_4);
            };
        }

        private function refreshTabText(_arg_1:FriendListTab, _arg_2:_SafeStr_3133):void
        {
        ...
        private function getTabContent(_arg_1:FriendListTab):_SafeStr_3109
        {
            var _local_2:_SafeStr_3133 = _SafeStr_3133(_friendList.getXmlWindow("tab_content"));
        ...
        private function refreshTabContentDims(_arg_1:_SafeStr_3133):void
        {
            var _local_3:_SafeStr_3133 = (_arg_1.getChildByName("footer") as _SafeStr_3133);
            var _local_6:_SafeStr_3133 = (_arg_1.getChildByName("list") as _SafeStr_3133);
            var _local_8:_SafeStr_3109 = (_local_6.getChildByName("scroller") as _SafeStr_3109);
            var _local_9:IItemListWindow = IItemListWindow(_local_6.getChildByName("list_content"));
            var _local_7:_SafeStr_3109 = _local_6.parent;
        ...
        private function refreshScrollBarVisibility(_arg_1:_SafeStr_3133):void
        {
            var _local_6:_SafeStr_3133 = (_arg_1.getChildByName("list") as _SafeStr_3133);
            var _local_7:_SafeStr_3109 = (_local_6.getChildByName("scroller") as _SafeStr_3109);
            var _local_9:IItemListWindow = IItemListWindow(_local_6.getChildByName("list_content"));
            var _local_3:* = (_local_9.scrollableRegion.height > _local_9.height);
            var _local_2:int = 22;
        ...
        private function getTabContentFooter(_arg_1:FriendListTab):_SafeStr_3109
        {
            var _local_2:_SafeStr_3133 = _SafeStr_3133(this._friendList.getXmlWindow(_arg_1.footerName));
