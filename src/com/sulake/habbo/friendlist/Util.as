...
//com.sulake.habbo.friendlist.Util
...
package com.sulake.habbo.friendlist
{
    ...
    public class Util 
    {
        ...
        public static function getRightmostPoint(_arg_1:_SafeStr_3133):int
        {
            var _local_2:int;
            var _local_4:* = null;
            var _local_3:int;
        ...
        public static function print(_arg_1:String, _arg_2:_SafeStr_3109):void
        {
            var _local_3:int;
            _SafeStr_14.log((((((((_arg_1 + _arg_2) + " (") + _arg_2.width) + ", ") + _arg_2.height) + "), ") + _arg_2.getParamFlag(16)));
            var _local_4:_SafeStr_3133 = (_arg_2 as _SafeStr_3133);
            if (_local_4 != null)
            {
                _local_3 = 0;
        ...
        public static function layoutChildrenInArea(_arg_1:_SafeStr_3133, _arg_2:int, _arg_3:int):void
        {
            var _local_6:int;
            var _local_7:* = null;
            var _local_4:int;
