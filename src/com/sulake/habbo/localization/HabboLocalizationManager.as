...
package com.sulake.habbo.localization
{
    ...
    public class HabboLocalizationManager extends CoreLocalizationManager implements _SafeStr_18 
    {

        private var _SafeStr_8638:Boolean;
        ...
        public function loadDefaultEmbedLocalizations(_arg_1:String, _arg_2:Boolean=true):Boolean
        {
            ...
            {
                _SafeStr_14.log((("Could not load default localizations " + _local_3) + " : Trying with default_localizations_en..."));
            ...
            _SafeStr_14.log(("Could not load " + _local_3));
            return (false);
        }
        ...
        public function getLocalizationWithParamMap(_arg_1:String, _arg_2:String="", _arg_3:_SafeStr_24=null):String
        {
            if (_arg_3 != null)
            {
        ...
        public function requestLocalizationInit():void
        {
            ...
            events.addEventListener("LOCALIZATION_EVENT_LOCALIZATION_FAILED", onLocalizationFailed);
        ...
        private function onLocalizationLoaded(_arg_1:Event):void
        {
            ...
            events.removeEventListener("LOCALIZATION_EVENT_LOCALIZATION_FAILED", onLocalizationFailed);
            localizationsReady();
        }
...
// _SafeStr_8638 = "_-Sj" (String#8457, DoABC#3)
// _SafeStr_8639 = "_-2E" (String#6689, DoABC#3)
