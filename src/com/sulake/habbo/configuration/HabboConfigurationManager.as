...
package com.sulake.habbo.configuration
{
    ...
    public class HabboConfigurationManager extends _SafeStr_20 implements _SafeStr_19, _SafeStr_22 
    {
        ...
        private var _SafeStr_8530:Boolean = false;
        private var _SafeStr_8531:Boolean = false;
        private var _SafeStr_8532:Dictionary;
        private var _SafeStr_3853:Boolean = false;
        private var _SafeStr_8533:Array = [];
        private var _SafeStr_8534:Boolean = false;
        ...
        public function HabboConfigurationManager(_arg_1:_SafeStr_31, _arg_2:uint=0, _arg_3:_SafeStr_21=null)
        {
            ...
            _SafeStr_8530 = ((_arg_2 & 0x10000000) > 0);
            _SafeStr_8531 = ((_arg_2 & 0x01000000) > 0);
            lock();
            resetAll();
        ...
        {
            return (super.dependencies.concat(new <ComponentDependency>[new ComponentDependency(new IIDHabboLocalizationManager(), function (_arg_1:_SafeStr_18):void
            {
        ...
        {
            if (_SafeStr_8391 != _arg_1)
            {
                _SafeStr_8391 = _arg_1;
        ...
        public function resetAll():void
        {
            ...
            if (((!(_SafeStr_3853)) && (_SafeStr_8530)))
            {
                _SafeStr_3853 = true;
                unlock();
            ...
            {
                if (((!(_SafeStr_3853)) && (_SafeStr_8531)))
                {
                    initConfigurationDownload();
                };
            };
        ...
        private function updateEnvironmentVariables():void
        {
            ...
            for each (var _local_2:String in _local_4)
            {
                ...
                _local_5 = ((_local_2 + ".") + _SafeStr_8391);
        ...
        {
            var _local_2:String = (_SafeStr_8532[_arg_1] as String);
            return (!(_local_2 == null));
        }

        override public function getProperty(_arg_1:String, _arg_2:Dictionary=null):String
        {
            var _local_3:String = (_SafeStr_8532[_arg_1] as String);
            ...
            {
                _local_3 = (((_SafeStr_8534) ? "https:" : "http:") + _local_3);
            };
        ...
        override public function setProperty(_arg_1:String, _arg_2:String, _arg_3:Boolean=false, _arg_4:Boolean=false):void
        {
            if (_arg_4)
            {
                if (_SafeStr_8532[_arg_1] == null)
                {
                    _SafeStr_14.log(((_arg_1 + "=") + _arg_2));
                };
            };
            if (((_SafeStr_8533.indexOf(_arg_1) < 0) || (_arg_3)))
            {
                _SafeStr_8532[_arg_1] = _arg_2;
            };
            if (_arg_3)
            {
                _SafeStr_8533.push(_arg_1);
            };
        }
        ...
        override public function interpolate(_arg_1:String):String
        {
            ...
            _local_6 = 0;
            for (;_local_6 < 3;(_local_5 = _local_7.exec(_local_4)), if (_local_5 != null)
            {
                if (!propertyExists(_local_5[1]))
                {
                    return (null);
                };
                _local_3 = (_local_3 + _local_4.substring(_local_2, _local_5.index));
                _local_3 = (_local_3 + getProperty(_local_5[1]));
                _local_2 = (_local_5.index + _local_5[0].length);
                continue;
            }, (_local_3 = (_local_3 + _local_4.substring(_local_2))), if (_local_3 == _local_4) break, (_local_4 = _local_3), _local_6++)
            {
                _local_2 = 0;
                _local_3 = "";
            };
        ...
        private function initEmbeddedConfigurations():void
        {
            ...
            _SafeStr_14.log(("[HabboConfigurationManager] Default Environment: " + _local_1));
            for (var _local_5:String in _SafeStr_8532)
            {
        ...
        private function onConfigurationError(_arg_1:Event=null):void
        {
            ...
            _SafeStr_14.log(_local_3.toString());
            HabboWebTools.logEventLog(("external_variables download error " + _local_2));
            _SafeStr_79.error((((("Could not load external variables. Failed to load URL " + getProperty("external.variables.txt")) + "HTTP status ") + _local_2) + ". Client startup failed!"), true, 20);
        }
        ...
        private function onInitConfiguration(_arg_1:Event=null):void
        {
            ...
            if (((_local_2 == null) || (_local_2.length == 0)))
            {
                ...
                _SafeStr_79.error((((("Could not load external variables, got empty data from URL " + getProperty("external.variables.txt")) + " data length = ") + _local_4) + ". Client startup failed!"), false, 20);
            };
            if (!_SafeStr_3853)
            {
        ...
        private function parseConfigurationAsset(_arg_1:String):void
        {
            ...
            {
                _SafeStr_14.log(("Could not parse configuration " + _arg_1));
            };
        }
        ...
        {
            var _local_2:* = null;
            var _local_1:Dictionary = (context as _SafeStr_35).arguments;
            for (var _local_3:String in _local_1)
            {
                _local_2 = _local_1[_local_3];
                _local_3 = _local_3.replace(/[_]/g, ".");
                setProperty(_local_3, _local_2);
                if (((_SafeStr_8391 == null) && (_local_3 == "environment.id")))
                {
                    _SafeStr_8391 = _local_2;
                };
            };
            (context as _SafeStr_35).clearArguments();
        }
        ...
        private function parseStageVariables():void
        {
            ...
            {
                _SafeStr_14.log("[HabboConfigurationManager] Context has not stage ");
                return;
            };
            ...
            _SafeStr_8534 = (_local_4.substr(0, 8) == "https://");
...
// _SafeStr_22 = "_-d1y" (String#9228, DoABC#3)
...
// _SafeStr_8530 = "_-wZ" (String#10486, DoABC#3)
// _SafeStr_8531 = "_-Pl" (String#8276, DoABC#3)
// _SafeStr_8532 = "_-81p" (String#7108, DoABC#3)
// _SafeStr_8533 = "_-Ao" (String#7296, DoABC#3)
// _SafeStr_8534 = "_-5o" (String#6928, DoABC#3)
