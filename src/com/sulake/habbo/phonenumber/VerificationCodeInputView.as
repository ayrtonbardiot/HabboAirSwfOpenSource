...
//com.sulake.habbo.phonenumber.VerificationCodeInputView
...
package com.sulake.habbo.phonenumber
{
    ...
    public class VerificationCodeInputView 
    {
        ...
        {
            _SafeStr_4147.windowManager.alert("${generic.alert.title}", (("${phone.number.verify.error." + _arg_1) + "}"), 0, null);
        ...
        private function createWindow():void
        {
            ...
            _window = _SafeStr_3263(_SafeStr_4147.windowManager.buildFromXML(XML(_SafeStr_4147.assets.getAssetByName("phonenumber_verify_xml").content)));
            _window.center();
            ...
            _window.findChildByName("verification_code_input").enable();
            if ((_SafeStr_4147.retryEnableTime - getTimer()) <= 0)
            {
                showRetry();
            }
            else
        ...
        private function onInputButtons(_arg_1:_SafeStr_3116, _arg_2:_SafeStr_3109):void
        {
            ...
            switch (_arg_2.name)
            {
                ...
                case "wait_link":
                    _SafeStr_4147.setVerifyViewMinimized(true);
                    return;
                case "did_not_receive_code_link":
                    _SafeStr_4147.requestPhoneNumberCollectionReset();
                    return;
                case "ok_button":
                    _SafeStr_4147.sendTryVerificationCode(_window.findChildByName("verification_code_input").caption);
                    _window.findChildByName("ok_button").disable();
        ...
        {
            var _local_3:String = _SafeStr_4147.localizationManager.getLocalization("phone.number.verify.wait.remaining", "");
            var _local_2:int = int(Math.max(0, ((_SafeStr_4147.retryEnableTime - getTimer()) / 1000)));
