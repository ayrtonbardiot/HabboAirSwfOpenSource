...
package com.probertson.utils
{
    ...
    public class GZIPFile 
    {
        ...
        {
            return (_SafeStr_7997);
        }

        public function getCompressedData():ByteArray
        {
            var _local_1:ByteArray = new ByteArray();
            _SafeStr_7996.position = 0;
            _SafeStr_7996.readBytes(_local_1, 0, _SafeStr_7996.length);
            return (_local_1);
        }
...
// _SafeStr_7996 = "_-vF" (String#10412, DoABC#3)
// _SafeStr_7997 = "_-028" (String#6503, DoABC#3)
