...
package _-Ja
{
    ...
    public class _SafeStr_1557 implements _SafeStr_13, _SafeStr_1556 
    {

        private var _SafeStr_5093:Array = [];
        private var _disposed:Boolean;

        public function _SafeStr_1557(_arg_1:IMessageDataWrapper)
        {
            var _local_3:int;
            super();
            ...
            {
                _SafeStr_5093.push(new _SafeStr_1549(_arg_1));
                _local_3++;
            };
        }
        ...
        public function dispose():void
        {
            ...
            {
                for each (var _local_1:_SafeStr_1549 in _SafeStr_5093)
                {
                    _local_1.dispose();
                };
            };
