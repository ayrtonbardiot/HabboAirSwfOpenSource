...
package adobe.serialization.json
{
    public class JSONTokenizer 
    {
        ...
        private var _SafeStr_7902:Object;
        ...
        public function unescapeString(_arg_1:String):String
        {
            ...
            var _local_7:int;
            var _local_5:* = null;
            if (((_SafeStr_7901) && (controlCharsRegExp.test(_arg_1))))
            {
        ...
        final private function isWhiteSpace(_arg_1:String):Boolean
        {
            ...
            if (((!(_SafeStr_7901)) && (_arg_1.charCodeAt(0) == 160)))
            {
                return (true);
            };
            return (false);
...
// _SafeStr_7902 = "_-g12" (String#9385, DoABC#3)
