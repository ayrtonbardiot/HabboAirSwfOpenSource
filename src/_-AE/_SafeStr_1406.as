...
package _-AE
{
    ...
    public class _SafeStr_1406 
    {
        ...
        private var _SafeStr_7150:Boolean;
        private var _SafeStr_6549:String;
        private var _SafeStr_3814:Vector.<_SafeStr_1611>;

        public function _SafeStr_1406(_arg_1:IMessageDataWrapper)
        {
            var _local_2:int;
            super();
            ...
            _SafeStr_7150 = _arg_1.readBoolean();
            _SafeStr_6549 = _arg_1.readString();
        }
...
// _SafeStr_6549 = "_-n1a" (String#9880, DoABC#3)
// _SafeStr_7149 = "_-v0" (String#10373, DoABC#3)
// _SafeStr_7150 = "_-bt" (String#9096, DoABC#3)
